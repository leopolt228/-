...
import { _ as randomIdempotencyKey, c as callGateway } from "./call-ChM1o8yU.js";
...
import { R as listMemoryEmbeddingProviders } from "./registry-BSBtFA2q.js";
...
import { i as convertHeicToJpeg, s as getImageMetadata } from "./image-ops-BFeNLIan.js";
import { l as saveMediaBuffer } from "./store-NmJjqmad.js";
import { n as canonicalizeCaseOnlyCatalogModelRef } from "./model-selection-Dx2ArePR.js";
...
import { r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-Bq3H5PGW.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-Crfz3-1P.js";
import { a as runWithImageModelFallback } from "./model-fallback-CVFSvXjG.js";
import { t as buildExplicitSessionIdSessionKey } from "./session-BGTcM179.js";
import { o as fetchWithTimeoutGuarded, p as resolveProviderHttpRequestConfig } from "./shared-CpiwWgfg.js";
import { c as buildMediaUnderstandingRegistry } from "./defaults.constants-iEQlxleo.js";
import { a as getCapabilityWebSearchCommandSecretTargets, c as getMemoryEmbeddingCommandSecretTargetIds, l as getModelsCommandSecretTargetIds, m as getTtsCommandSecretTargetIds, r as getCapabilityWebFetchCommandSecretTargets } from "./command-secret-targets-CztQ0pHm.js";
import { y as inspectLocalAudioSelection } from "./runner.entries-B5B9dOb9.js";
import { C as setTtsPersona, a as listSpeechVoices, c as resolveExplicitTtsOverrides, m as textToSpeech, r as getTtsProvider, w as setTtsProvider, x as setTtsEnabled } from "./runtime-api-IUluPrEw.js";
import { g as resolveTtsConfig, o as getTtsPersona, u as listTtsPersonas, v as resolveTtsPrefsPath } from "./tts-settings-Cunm4eSy.js";
import { o as listSpeechProviders, r as canonicalizeSpeechProviderId } from "./directives-DPx_aiSw.js";
import "./tts-CtDDp0V8.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-C28bxwdL.js";
import { i as listWebSearchProviders, n as isWebSearchProviderConfigured, o as runWebSearch } from "./runtime-DYwYEdrm.js";
...
import { n as listEmbeddingProviders } from "./embedding-provider-runtime-CAAeF26z.js";
import { i as resolveWebFetchDefinition, n as isWebFetchProviderConfigured, r as listWebFetchProviders } from "./runtime-BNEvoTyt.js";
...
import { c as transcribeAudioFile, i as describeVideoFile, o as prepareImageDescriptionInput, r as describePreparedImageWithModel, t as describeImageFile } from "./runtime-J20_r2er.js";
...
import { r as createEmbeddingProvider } from "./memory-core-bundled-runtime-BXqYfd4f.js";
import { t as collectOption } from "./helpers-CXUPqDHh.js";
...
//#endregion
//#region src/cli/capability-cli/media-output.ts
...
async function runImageDescribe(params) {
	...
	const outputs = await Promise.all(params.files.map(async (filePath) => {
		...
		if (!result.result.text) {
			if (isMissingMediaUnderstandingProvider(result.result)) throw new Error("No image understanding provider is configured or ready. Configure tools.media.image.models or agents.defaults.imageModel.primary, or pass --model <provider/model> after configuring that provider's auth/API key.");
...
async function runModelAuthStatus() {
	const captured = [];
	const { modelsStatusCommand } = await import("./list.status-command-CLap3Jal.js");
...
function registerModelCapabilityCommands(capability) {
	...
	modelAuth.command("login").description("Run provider auth login").requiredOption("--provider <id>", "Provider id").option("--method <id>", "Provider auth method id").action(async (opts) => {
		await runCommandWithRuntime(defaultRuntime, async () => {
			const { modelsAuthLoginCommand } = await import("./auth-CbOtlTlH.js");
