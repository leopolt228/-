import { a as resolveCanvasHostConfig, n as isCanvasHostEnabled } from "./config-a5Ixt-uf.js";
import { n as CANVAS_HOST_PATH } from "./a2ui-shared-CYxiODnT.js";
import { t as handleA2uiHttpRequest } from "./a2ui-HytU9Koy.js";
import { t as createCanvasHostHandler } from "./server-CMduNhEj.js";
...
function createCanvasHttpRouteHandler(params) {
	...
	return {
		async handleHttpRequest(req, res) {
			...
			if (url.pathname === "/__openclaw__/a2ui" || url.pathname.startsWith(`/__openclaw__/a2ui/`)) return handleA2uiHttpRequest(req, res, { liveReload: getHostConfig().liveReload });
