...
function getInvalidPersistedCronJobReason(candidate) {
	...
	if (payloadKind !== "systemEvent" && payloadKind !== "agentTurn" && payloadKind !== "command" && payloadKind !== "script") return "invalid-payload";
	...
	if (payloadKind === "script") {
		...
		if (typeof script !== "string" || script.trim().length === 0) return "invalid-payload";
	}
	return null;
}
//#endregion
export { getInvalidPersistedCronJobReason as t };
