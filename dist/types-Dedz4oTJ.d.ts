import { A as ToolResultMessage, C as TextContent, O as Tool, b as StreamFn$1, d as Message, f as Model, i as AssistantMessageEvent, l as ImageContent, r as AssistantMessage, v as SimpleStreamOptions } from "./types-CVnOkpxa.js";
...
interface DeferredToolCallContext {
...
interface AgentLoopConfig extends SimpleStreamOptions {
   ...
   */
  resolveDeferredTool?: (context: DeferredToolCallContext, signal?: AbortSignal) => Promise<AgentTool | undefined> | AgentTool | undefined;
  /**
...
type AgentEvent = {
  ...
  toolName: string;
  result: unknown;
  isError: boolean; /** False when resolution, argument preparation, validation, or policy blocked execution. */
  executionStarted?: boolean; /** Typed pre-execution failure provenance for safe downstream diagnostics. */
  errorKind?: "argument-validation";
  hideFromChannelProgress?: boolean;
};
//#endregion
export { PrepareNextTurnContext as _, AgentLoopConfig as a, ThinkingLevel as b, AgentState as c, AgentToolResult as d, AgentToolUpdateCallback as f, CustomMessage as g, BeforeToolCallResult as h, AgentEvent as i, AgentTool as l, BeforeToolCallContext as m, AfterToolCallResult as n, AgentLoopTurnUpdate as o, BashExecutionMessage as p, AgentContext as r, AgentMessage as s, AfterToolCallContext as t, AgentToolProgress as u, QueueMode as v, ToolExecutionMode as x, StreamFn as y };