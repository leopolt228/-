...
import { b as compileSafeRegex } from "./redact-DNq_HeDt.js";
...
import { i as parseModelCatalogRef, t as buildModelCatalogMergeKey } from "./model-catalog-refs-BcuK-xC3.js";
import { i as normalizePluginsConfigWithResolver } from "./config-normalization-shared-DBFbsKxi.js";
import { o as normalizePluginId, u as resolveEffectivePluginActivationState } from "./config-state-rO7K73Ka.js";
import { t as isPluginEnabledByDefaultForPlatform } from "./default-enablement-CEIbpabL.js";
import { u as normalizePluginIdScope } from "./current-plugin-metadata-snapshot-BQju0mzJ.js";
import { g as hashJson } from "./installed-plugin-index-DlWmC2dq.js";
import { m as createPluginRegistryIdNormalizer, r as normalizePluginsConfigWithRegistry } from "./plugin-registry-2gpKUE2T.js";
import { t as collectPluginConfigContractMatches } from "./config-contract-matches-wuBwMWH1.js";
import "./config-contracts-DnXd4jhp.js";
...
import { C as resolveMemoryDreamingPluginConfig, S as resolveMemoryDreamingConfig, c as DEFAULT_MEMORY_DREAMING_PLUGIN_ID, w as resolveMemoryDreamingPluginId } from "./dreaming-BmyNO7Dv.js";
import { t as planManifestModelCatalogRows } from "./manifest-planner-DSmSdykb.js";
import { n as hasExplicitChannelConfig } from "./channel-presence-policy-ClfxdhHd.js";
...
import { n as normalizeConfiguredSpeechProviderIdForStartup, t as collectConfiguredSpeechProviderIds } from "./gateway-startup-speech-providers-DTiClTx9.js";
import { i as normalizeWorkerProviderIds, r as manifestOwnsWorkerProvider, t as collectConfiguredWorkerProviderIds } from "./worker-provider-registry--meupQ0q.js";
...
function canStartConfiguredWorkerProviderPlugin(params) {
	if (!manifestOwnsWorkerProvider(params.manifest, params.configuredWorkerProviderIds)) return false;
	return canStartConfiguredProvider({
		...params,
