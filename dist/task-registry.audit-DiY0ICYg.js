...
function listTaskAuditFindings(options = {}) {
	...
	for (const task of tasks) {
		...
		if (task.status !== "lost" && task.status !== "queued" && task.status !== "running" && typeof task.cleanupAfter !== "number" && resolveTaskCleanupAfter(task) !== void 0) findings.push(createFinding({
			severity: "warn",
