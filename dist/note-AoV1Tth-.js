...
import { n as splitGraphemes, s as visibleWidth } from "./ansi-BEaQ2G9r.js";
...
function note$1(message, title) {
	...
	note(wrappedMessage, stylePromptTitle(title), { output: createNoteOutput(resolveNoteOutputColumns(wrappedMessage, columns)) });
}
