...
import { o as tracePluginLifecyclePhase, s as tracePluginLifecyclePhaseAsync } from "./discovery-Bhd5Zo0N.js";
...
async function runPluginUninstallCommand(id, opts = {}, runtime = defaultRuntime) {
	...
	const { loadInstalledPluginIndexInstallRecords, removePluginInstallRecordFromRecords, withoutPluginInstallRecords, withPluginInstallRecords } = await import("./installed-plugin-index-records-CBud6Uko.js");
	const { buildPluginSnapshotReport } = await import("./status-B-9UuJnN.js");
	const { applyPluginUninstallDirectoryRemoval, formatUninstallActionLabels, formatUninstallSlotResetPreview, planPluginUninstall, resolveUninstallChannelConfigKeys, UNINSTALL_ACTION_LABELS } = await import("./uninstall-BQ8NVGKC.js");
	const { commitPluginInstallRecordsWithConfig } = await import("./install-record-commit-X0abJfY-.js");
	...
	const { PromptInputClosedError, promptYesNo } = await import("./prompt-BK0uRMl5.js");
