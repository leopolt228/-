...
import { C as resolveExpiresAtMsFromDurationMs, j as resolveTimerTimeoutMs, n as MAX_TIMER_TIMEOUT_MS, o as asDateTimestampMs } from "./number-coercion-Crk_c9KW.js";
...
import { N as recordTalkObservabilityEvent, T as resolveRealtimeVoiceAgentConsultToolsAllow, _ as buildRealtimeVoiceAgentConsultPolicyInstructions, j as createTalkSessionController, m as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, w as resolveRealtimeVoiceAgentConsultTools } from "./session-log-runtime-GBoG4Ecc.js";
import { t as resolveRealtimeVoiceFastContextConsult } from "./realtime-voice-D9eMvxKo.js";
import { d as assertRealtimeVoiceAgentConsultModelSelectionUnlocked, f as consultRealtimeVoiceAgent, i as convertPcmToMulaw8k } from "./audio-energy-B9uVXLa_.js";
import { t as resolveConfiguredCapabilityProvider } from "./provider-selection-runtime-DGqZaqbE.js";
import { a as createWebhookInFlightLimiter, t as WEBHOOK_BODY_READ_DEFAULTS } from "./webhook-request-guards-BwB_e49u.js";
import "./webhook-ingress-0GWTUyGu.js";
import { t as normalizeWebhookPath } from "./webhook-targets-D0QbJdTx.js";
import "./api-C3LFT5s1.js";
import { a as resolveTwilioAuthToken, c as resolveVoiceCallNumberRouteKeyForCall, i as normalizeVoiceCallConfig, l as resolveVoiceCallSessionKey, n as resolveCallAgentId, o as resolveVoiceCallConfig, s as resolveVoiceCallEffectiveConfig, t as resolveVoiceResponseModel, u as validateProviderConfig } from "./response-model-BzcLmCPY.js";
import { _ as TerminalStates, d as loadActiveCallsFromStore, g as setVoiceCallStateRuntime, l as findCallMatchesInStore, p as persistCallRecord, t as resolveDefaultVoiceCallStoreDir, u as getCallHistoryFromStore } from "./store-path-BJnsfVCr.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-DlbGCIXe.js";
import { t as isProviderStatusTerminal } from "./call-status-Dp0hAJ00.js";
import { n as getHeader, t as normalizeProxyIp } from "./proxy-ip-bnHmy_VL.js";
...
const loadResponseGeneratorModule = createLazyRuntimeModule(() => import("./response-generator-BWUJImEK.js"));
...
const loadTelnyxProvider = createLazyRuntimeModule(() => import("./telnyx-BgPw6t_T.js"));
const loadTwilioProvider = createLazyRuntimeModule(() => import("./twilio-CbuijJwX.js"));
const loadPlivoProvider = createLazyRuntimeModule(() => import("./plivo-D-k6a_1Y.js"));
const loadMockProvider = createLazyRuntimeModule(() => import("./mock-CyYtrNkD.js"));
const loadRealtimeVoiceRuntime = createLazyRuntimeModule(() => import("./realtime-voice.runtime.js"));
const loadRealtimeHandler = createLazyRuntimeModule(() => import("./realtime-handler-DvOeAI2j.js"));
