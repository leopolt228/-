...
import { A as parseThreadSessionSuffix } from "./session-key-Drrs61Fd.js";
import { n as normalizeAccountId, t as DEFAULT_ACCOUNT_ID } from "./account-id-C7N4Rwku.js";
import { _ as readStringParam, i as createActionGate, p as readPositiveIntegerParam, t as ToolAuthorizationError } from "./common-C39GdgQ7.js";
import { n as sanitizeAssistantVisibleText } from "./assistant-visible-text-CUL_eqJo.js";
import { l as createScopedDmSecurityResolver, t as adaptScopedAccountAccessor } from "./channel-config-helpers-BFvX3ldW.js";
...
import { t as createScopedAccountReplyToModeResolver } from "./threading-helpers-CMXJIj4M.js";
import { i as createChatChannelPlugin, n as buildThreadAwareOutboundSessionRoute, t as buildChannelOutboundSessionRoute } from "./core-Bo6nGN10.js";
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability, r as createChannelApprovalCapability } from "./approval-delivery-helpers-DSkcX9d-.js";
...
import { r as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-CEtRGn3J.js";
...
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-jGB19KP8.js";
...
import { E as createAllowlistProviderOpenWarningCollector, N as projectAccountConfigWarningCollector, d as resolveScopeRequireMention, f as resolveScopeToolsPolicy } from "./channel-policy-DtbLL_f5.js";
...
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-3-NMS7QW.js";
...
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-BAn6Hz0P.js";
import { t as resolveMatrixStoredSessionMeta } from "./session-store-metadata-DH5mDEz6.js";
import { a as namedAccountPromotionKeys, o as resolveSingleAccountPromotionTarget, s as singleAccountKeysToMove } from "./setup-dm-policy-fDPoECZm.js";
import { n as matrixSetupAdapter, t as createMatrixSetupWizardProxy } from "./setup-core-DjROwU_q.js";
import { n as resolveMatrixInboundConversation, t as defaultTopLevelPlacement } from "./thread-binding-api-CwBMOXEC.js";
...
const resolveMatrixOriginTarget = createChannelNativeOriginTargetResolver({
	...
	shouldHandleRequest: ({ cfg, accountId, approvalKind, request }) => {
		if (approvalKind !== "exec" && approvalKind !== "plugin") return false;
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-CQFrm5mm.js")).matrixApprovalNativeRuntime
	})
});
...
function resolveMatrixOutboundSessionRoute(params) {
	...
	return buildThreadAwareOutboundSessionRoute({
		route: buildChannelOutboundSessionRoute({
			...
			channel: "matrix",
			accountId: effectiveAccountId,
			recipientSessionExact: target.kind === "room" ? dmSessionScope === "per-room" && target.id.startsWith("!") && target.id.includes(":") : dmSessionScope === "per-user" ? isMatrixQualifiedUserId(target.id) : roomScopedDmId !== void 0,
			peer,
			chatType,
			from,
			to
...
const loadMatrixSetupWizard = createLazyRuntimeNamedExport(() => import("./setup-surface-CCwOzZf8.js"), "matrixSetupWizard");
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-D9_MY-zJ.js"), "matrixChannelRuntime");
const loadMatrixDoctorModule = createLazyRuntimeModule(() => import("./doctor-fX8tTKfJ.js"));
const meta = {
	id: "matrix",
	label: "Matrix",
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-CaUN7XsH.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
