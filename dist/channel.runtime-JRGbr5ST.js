...
import "./accounts-CnsvxTDR.js";
import "./runtime-api-pas_siQj.js";
import { r as getMe, t as ZaloApiError } from "./api-CExJv-YC.js";
import { t as resolveZaloProxyFetch } from "./proxy-BsW-xro7.js";
import { t as sendMessageZalo } from "./send-7wBhHRFV.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-DvdaQJ2q.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-DMcGP4BD.js");
