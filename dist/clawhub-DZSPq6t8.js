...
import { i as resolveSafeInstallDir } from "./install-safe-path-BwgrzVcF.js";
import { C as resolveClawHubBaseUrl, O as searchClawHubSkills, S as reportClawHubSkillInstallTelemetry, _ as fetchClawHubSkillVerification, a as downloadClawHubSkillArchiveUrl, h as fetchClawHubSkillInstallResolution, i as downloadClawHubSkillArchive, m as fetchClawHubSkillDetail, n as downloadClawHubGitHubSkillArchive, v as isDefaultClawHubBaseUrl } from "./clawhub-B8a59qSy.js";
import { a as sha256Hex } from "./crypto-digest-CmUwt1S-.js";
import { c as tryReadJson, r as readJsonIfExists, u as writeJson } from "./json--wG6OtAJ.js";
import "./json-files-2JJFkKam.js";
import { n as ensureClawHubPackageTrustAcknowledged } from "./clawhub-install-trust-DyTzSv3F.js";
import { i as withExtractedArchiveRoot, t as installPackageDir } from "./install-package-dir-BiykTlIJ.js";
import { t as evaluateSkillInstallPolicy } from "./install-security-scan-D_fqlETr.js";
...
async function readInstalledSkillFileLock(skillDir) {
	for (const marker of CLAWHUB_SKILL_ARCHIVE_ROOT_MARKERS) {
		...
		try {
			return {
				path: marker,
				sha256: sha256Hex(await fs$1.readFile(candidate))
			};
		} catch {
			continue;
		}
...
//#endregion
export { readVerifiedClawHubSkillSourceUrl as a, resolveLocalSkillCardStatusSync as c, updateSkillsFromClawHub as d, installExtractedSkillRoot as f, readTrackedClawHubSkillSlugs as i, searchSkillsFromClawHub as l, validateRequestedSkillSlug as m, readClawHubSkillsLockfileStatusSync as n, resolveClawHubSkillStatusLinkSync as o, installSkillArchiveFromPath as p, readLocalSkillCardContentSync as r, resolveClawHubSkillVerificationTarget as s, installSkillFromClawHub as t, untrackClawHubSkill as u };
