...
import { v as runWithPreparedMemoryPromptSection } from "./memory-state-BkKwMbMM.js";
import { p as stripRuntimeContextCustomMessages } from "./internal-runtime-context-BW7WOTKc.js";
import { c as recordTaskRunProgressByRunId, i as failTaskRunByRunId, n as createQueuedTaskRun, t as completeTaskRunByRunId, u as startTaskRunByRunId } from "./detached-task-runtime-BoSSz2n3.js";
import { f as isGatewayDraining, r as enqueueCommandInLane } from "./command-queue-B2fMJE4M.js";
import { n as OPENCLAW_EMBEDDED_CONTEXT_ENGINE_HOST } from "./host-compat-BibWlia2.js";
import { t as log$1 } from "./logger-DTutvtjM.js";
import { A as findActiveSessionTask } from "./openclaw-tools-U0Zy3sfO.js";
import { c as updateTaskNotifyPolicyForOwner, i as findTaskByRunIdForOwner, n as cancelTaskByIdForOwner } from "./task-owner-access-_0SjN89L.js";
import { n as buildAfterTurnRuntimeContextFromUsage, t as buildAfterTurnRuntimeContext, v as resolveContextEngineCapabilities } from "./attempt.prompt-helpers-CxGA3lR4.js";
import { n as rewriteTranscriptEntriesInSessionManager, t as rewriteTranscriptEntriesInRuntimeTranscript } from "./transcript-rewrite-BPF01I6h.js";
import { r as runAgentHarnessAgentEndHook, t as awaitAgentHarnessAgentEndHook } from "./lifecycle-hook-helpers-L479pS81.js";
...
async function assembleHarnessContextEngine(params) {
	...
	return ensureAssembleResultShape(contextEngine.info.id === "legacy" ? await assemble() : await runWithPreparedMemoryPromptSection({
...
async function runCoreAgentEndSideEffects(params) {
	try {
		const { scheduleSkillExperienceReview } = await import("./experience-review-default-uv1R1awi.js");
	...
	try {
		const { runSkillResearchAutoCapture } = await import("./autocapture-Cjt3KmUz.js");
