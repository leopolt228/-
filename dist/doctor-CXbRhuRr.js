...
import { C as resolveMemoryDreamingPluginConfig, D as resolveMemoryRemDreamingConfig, E as resolveMemoryLightDreamingConfig, S as resolveMemoryDreamingConfig, T as resolveMemoryDreamingWorkspaces, x as resolveMemoryDeepDreamingConfig } from "./dreaming-BmyNO7Dv.js";
import { r as getActiveMemorySearchManager } from "./memory-runtime-Cx64GvXS.js";
import { a as loadShortTermPromotionDreamingStats, c as removeBackfillDiaryEntries, f as writeBackfillDiaryEntries, i as dedupeDreamDiaryEntries, l as removeGroundedShortTermCandidates, o as previewGroundedRemMarkdown, s as previewRemHarness, u as repairDreamingArtifacts } from "./memory-core-bundled-runtime-BXqYfd4f.js";
	...
	"doctor.memory.remHarness": async ({ params, respond, context }) => {
		...
		try {
			...
			respond(true, {
				...
				agentId,
				workspaceDir,
				error: `gateway rem-harness probe failed: ${formatErrorMessage(err)}`
			}, void 0);
		}
	}
};
