...
import { C as resolveConfiguredModelNameHint, _ as listConfiguredFoundryProfileIds, h as isFoundryMaiImageModel, o as PROVIDER_ID, p as formatFoundryApiLabel, u as buildFoundryAuthResult, w as resolveFoundryApi } from "./shared-CffaaJWi.js";
import { c as listSubscriptions, o as getLoggedInAccount, s as isAzCliInstalled } from "./cli-jUj_oSeK.js";
import { a as promptTenantId, c as testFoundryConnection, i as promptEndpointAndModelManually, n as loginWithTenantFallback, o as selectFoundryDeployment, r as promptApiKeyEndpointAndModel, s as selectFoundryResource, t as listResourceDeployments } from "./onboard-N2RRP91Q.js";
...
const entraIdAuthMethod = {
	...
	run: async (ctx) => {
		...
		if (selectedSub) if (await ctx.prompter.confirm({
			...
			const { selected: selectedDeployment, supported: supportedDeployments } = await selectFoundryDeployment(ctx, selectedResource, listResourceDeployments(selectedResource, selectedSub.id));
