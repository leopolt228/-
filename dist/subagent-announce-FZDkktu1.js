...
import { T as waitForEmbeddedAgentRunEnd, l as isEmbeddedAgentRunActive } from "./runs-DDczt14d.js";
import { c as stripLeadingSilentToken, l as stripSilentToken, n as SILENT_REPLY_TOKEN, o as isSilentReplyText, s as startsWithSilentToken } from "./tokens-DKI4eGAu.js";
...
import { c as readLatestSubagentOutputWithRetry, i as buildCompactAnnounceStatsLine, l as readSubagentOutput, m as isAnnounceSkip, n as applySubagentWaitOutcome, o as dedupeLatestChildCompletionRows, r as buildChildCompletionFindings, s as filterCurrentDirectChildCompletionRows, t as deleteSubagentSessionForCleanup, u as waitForSubagentRunOutcome } from "./subagent-session-cleanup-B3gE-rC8.js";
import { n as buildAnnounceIdempotencyKey, t as buildAnnounceIdFromChildRun } from "./announce-idempotency-DRIcQ039.js";
import { a as loadSessionEntryByKey, c as runAnnounceDeliveryWithRetry, i as loadRequesterSessionEntry, n as deliverSubagentAnnouncement, o as resolveSubagentAnnounceTimeoutMs, p as formatAgentInternalEventsForPrompt, s as resolveSubagentCompletionOrigin, t as resolveAnnounceOrigin } from "./subagent-announce-origin-DHldKZbu.js";
...
async function runSubagentAnnounceFlow(params) {
	...
	try {
		...
		if (shouldDeleteChildSession && (params.onBeforeDeleteChildSession?.() ?? true)) await deleteSubagentSessionForCleanup({
