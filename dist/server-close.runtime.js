...
import { n as disposeRegisteredAgentHarnesses } from "./registry-D03pg4Q5.js";
import { p as closePluginStateDatabase } from "./plugin-state-store-DtRrl2QK.js";
...
import { n as createChatAbortMarker } from "./server-chat-state-B5sGX0h3.js";
import { a as isChatAbortControllerEntryAbortable, c as removeChatAbortControllerEntry, r as abortTrackedChatRunById } from "./chat-abort-BKKIixKZ.js";
import { n as abortQueuedChatTurns } from "./chat-queued-turns-DWyXqGgL.js";
import { n as collectGatewayProcessMemoryUsageMb, o as measureGatewayRestartTrace, s as recordGatewayRestartTrace } from "./restart-trace-CzbQ5gIb.js";
import { r as drainActiveSessionsForShutdown } from "./session-reset-service-Z9TMRJwG.js";
...
async function disposeAllBundleLspRuntimesOnDemand() {
	const { disposeAllBundleLspRuntimes } = await import("./agent-bundle-lsp-runtime-CMYBv65J.js");
	await disposeAllBundleLspRuntimes();
}
async function stopGmailWatcherOnDemand() {
	const { stopGmailWatcher } = await import("./gmail-watcher-Dsqf7lvQ.js");
...
function createGatewayCloseHandler(params) {
	return async (opts) => {
		...
		try {
			...
			if (params.worktreeCleanup) clearInterval(params.worktreeCleanup);
