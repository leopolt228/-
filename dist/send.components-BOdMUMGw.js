...
import "./global-singleton-DZQj1BsZ.js";
import { s as resolveDiscordAccount } from "./accounts-sZJTKxVc.js";
import { Bt as ChannelType, E as serializePayload, nt as createChannelMessage, st as editChannelMessage } from "./discord-BO4_MvbK.js";
import { u as createDiscordClient } from "./send.permissions-BhFjVFcq.js";
import { n as getOptionalDiscordRuntime } from "./runtime-Dg4d9hPu.js";
import { a as buildDiscordComponentMessageFlags, c as resolveDiscordComponentAttachmentName, i as buildDiscordComponentMessage } from "./components-c2rsSkay.js";
import { T as parseAndResolveChannelRecipient, b as stripUndefinedFields, g as createDiscordMessageNonce, l as resolveChannelId, m as SUPPRESS_NOTIFICATIONS_FLAG, t as buildDiscordSendError, u as resolveDiscordChannel } from "./send.shared-p57jtR08.js";
import "./config-api-BC_ycUnF.js";
import "./channel-api-B7cIhw15.js";
import "./outbound-session-route-qNi7XsrS.js";
import { n as createDiscordSendResult } from "./send.receipt-jI3nGdpn.js";
import { t as sendMessageDiscord } from "./send.outbound-CJThfrn0.js";
//#region extensions/discord/src/components-registry-state.ts
const discordComponentRegistryState = {
	componentEntries: resolveGlobalMap(Symbol.for("openclaw.discord.componentEntries")),
	modalEntries: resolveGlobalMap(Symbol.for("openclaw.discord.modalEntries")),
	...
	reset() {
		...
		this.persistentComponentStore = void 0;
		this.persistentModalStore = void 0;
