import { t as CURRENT_MESSAGE_MARKER } from "./mentions-JuM7Ltm-.js";
...
*/
const recordPendingHistoryEntry = recordChannelHistoryEntry;
function recordChannelHistoryEntryIfEnabled(params) {
...
* This helper remains for core internals and older plugin compatibility.
*/
const recordPendingHistoryEntryIfEnabled = recordChannelHistoryEntryIfEnabled;
...
*/
const recordPendingHistoryEntryWithMedia = recordChannelHistoryEntryWithMedia;
function buildChannelPendingHistoryContext(params) {
...
*/
const buildPendingHistoryContextFromMap = buildChannelPendingHistoryContext;
function buildChannelInboundHistory(params) {
...
*/
const buildInboundHistoryFromMap = buildChannelInboundHistory;
...
function buildHistoryContextFromMap(params) {
	if (params.limit <= 0) return params.currentMessage;
	return buildHistoryContextFromEntries({
		entries: params.entry ? recordChannelHistoryEntry({
			historyMap: params.historyMap,
			historyKey: params.historyKey,
			entry: params.entry,
			limit: params.limit
...
*/
const clearHistoryEntries = clearChannelHistory;
...
* This helper remains for core internals and older plugin compatibility.
*/
const clearHistoryEntriesIfEnabled = clearChannelHistoryIfEnabled;
...
//#endregion
export { recordChannelHistoryEntryWithMedia as _, buildHistoryContext as a, recordPendingHistoryEntryWithMedia as b, buildInboundHistoryFromEntries as c, clearChannelHistoryIfEnabled as d, clearHistoryEntries as f, recordChannelHistoryEntryIfEnabled as g, normalizeHistoryMediaEntries as h, buildChannelPendingHistoryContext as i, buildInboundHistoryFromMap as l, evictOldHistoryKeys as m, HISTORY_CONTEXT_MARKER as n, buildHistoryContextFromEntries as o, clearHistoryEntriesIfEnabled as p, buildChannelInboundHistory as r, buildHistoryContextFromMap as s, DEFAULT_GROUP_HISTORY_LIMIT as t, buildPendingHistoryContextFromMap as u, recordPendingHistoryEntry as v, recordPendingHistoryEntryIfEnabled as y };
