...
import { a as getGatewayModelPricingCacheFingerprint, i as getCachedGatewayModelPricing } from "./model-pricing-config-OEwtqVMb.js";
import "./model-pricing-cache-HrFVCcQg.js";
	...
	try {
		...
		if (!modelsJsonCostCache) {
			...
			if (modelsJsonCostCacheByAgentDir.size >= MODELS_JSON_COST_CACHE_LIMIT) {
				...
				if (oldestAgentDir !== void 0) modelsJsonCostCacheByAgentDir.delete(oldestAgentDir);
			}
