...
import { d as toImageDataUrl, l as resolveInlineImageJsonResponseMaxBytes, n as generatedImageAssetFromBase64, r as generatedImageAssetFromDataUrl } from "./image-generation-pAFfF0km.js";
	...
	return {
		...
		async generateImage(req) {
			...
			try {
				...
				const images = extractOpenRouterImagesFromResponse(await readProviderJsonResponse(response, "openrouter.image-generation", { maxBytes: resolveInlineImageJsonResponseMaxBytes(count, resolveGeneratedImageMaxBytes(req)) }), { malformedResponseError: OPENROUTER_IMAGE_MALFORMED_RESPONSE });
