...
import { a as loadManagedProxyTlsOptionsSync, i as loadManagedProxyTlsOptions, o as resolveManagedProxyCaFileForUrl } from "./managed-proxy-undici-BCJBAJza.js";
import { a as forceResetGlobalDispatcher } from "./undici-global-dispatcher-CyLdv3rm.js";
import { i as isWebSocketUrl, n as isHttpUrl } from "./url-protocol-oWYinajA.js";
...
function getGatewayControlPlaneBypassAuthority(value) {
	...
	if (url === null || !isHttpUrl(url) && !isWebSocketUrl(url) || !isGatewayControlPlaneLoopbackHost(url.hostname)) return null;
