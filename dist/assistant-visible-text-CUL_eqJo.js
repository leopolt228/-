...
function findCodeRegions(text) {
	...
	for (const match of text.matchAll(/(^|\n)(```|~~~)[^\n]*\n[\s\S]*?(?:\n\2|$)/g)) {
		const start = (match.index ?? 0) + expectDefined(match[1], "code regions regex capture 1").length;
		regions.push({
			start,
...
//#endregion
export { stripAssistantInternalScaffolding as a, stripLegacyBracketToolCallBlocks as c, hasOrphanReasoningCloseBoundary as d, stripReasoningTagsFromText as f, isInsideCode as g, findCodeRegions as h, sanitizeAssistantVisibleTextWithProfile as i, stripMinimaxToolCallXml as l, stripFinalTags as m, sanitizeAssistantVisibleText as n, stripAssistantInternalTraceLines as o, findFinalTagMatches as p, sanitizeAssistantVisibleTextWithOptions as r, stripDowngradedToolCallText as s, sanitizeAssistantFinalAnswerText as t, stripToolCallXmlTags as u };
