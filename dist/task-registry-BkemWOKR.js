...
import { m as runWithGatewayIndependentRootWorkAdmission, o as isGatewayRestartDraining } from "./gateway-work-admission-CLw1UuhK.js";
...
import { f as parseTaskNotifyPolicy, p as parseDeliveryContextJson } from "./task-registry.store.sqlite-DG8Aw738.js";
import { n as buildAgentRunTerminalOutcome } from "./agent-run-terminal-outcome-C9geO1r1.js";
import { r as shouldRouteCompletionThroughRequesterSession } from "./completion-delivery-policy-CWIhZg-Q.js";
import { i as formatTaskStatusTitleText, o as sanitizeTaskStatusText } from "./task-status-BIpP_2FL.js";
import { i as resetTaskRegistryRuntimeForTests, n as getTaskRegistryObservers, r as getTaskRegistryStore } from "./task-registry.store-CYxTqY7i.js";
...
function restoreTaskFlowRegistryOnce() {
	...
	try {
		...
		log$1.warn("Failed to restore task-flow registry", {
			error: message,
...
function persistFlowRegistry() {
	try {
		...
		log$1.warn("Failed to persist task-flow registry snapshot", { error });
		return false;
	}
}
...
//#endregion
//#region src/tasks/native-subagent-task.ts
...
const deliveryRuntimeLoader = createLazyPromiseLoader(() => import("./task-registry-delivery-runtime-DfptLn0C.js"), { cacheRejections: true });
...
//#endregion
export { setFlowWaiting as $, isTerminalTaskStatus as A, deleteTaskFlowRecordById as B, maybeDeliverTaskTerminalUpdate as C, setTaskCleanupAfterById as D, resolveTaskForLookupToken as E, SUBAGENT_KILL_TASK_ERROR as F, getTaskFlowById as G, failFlow as H, BACKGROUND_EXEC_TASK_KIND as I, listTaskFlowsForOwnerKey as J, getTaskFlowRegistryRestoreFailure as K, isBackgroundExecTask as L, isTaskFlowCancellationPending as M, isChildlessNativeSubagentTask as N, setTaskRunDeliveryStatusByRunId as O, resolveChildlessNativeSubagentTaskDefinition as P, resumeFlow as Q, createManagedTaskFlow as R, markTaskTerminalById as S, reloadTaskRegistryFromStore as T, findLatestTaskFlowForOwnerKey as U, ensureTaskFlowRegistryReady as V, finishFlow as W, requestFlowCancel as X, reloadTaskFlowRegistryFromStore as Y, resolveTaskFlowForLookupToken as Z, listTasksForOwnerKey as _, ensureTaskRegistryReady as a, markTaskLostById as b, getTaskById as c, linkTaskToFlowById as d, updateFlowRecordByIdExpectedRevision as et, listFreshTasksForOwnerKey as f, listTasksForFlowId as g, listTasksForAgentId as h, deleteTaskRecordById as i, isProvisionalSubagentKillTask as j, updateTaskNotifyPolicyById as k, hasActiveTaskForChildSessionKey as l, listTaskRecordsUnsorted as m, cancelTaskById as n, finalizeTaskRunByRunId as o, listTaskRecords as p, listTaskFlowRecords as q, createTaskRecord as r, findTaskByRunId as s, assertTaskCancellationReadyById as t, isParentFlowLinkError as u, listTasksForRelatedSessionKey as v, recordTaskProgressByRunId as w, markTaskRunningByRunId as x, listTasksForSessionKey as y, createTaskFlowForTask as z };
