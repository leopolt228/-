...
import { y as resolveOAuthDir } from "./paths-CHQRdQZ3.js";
...
import { t as extensionUsesSkippedScannerPath } from "./scan-paths-DDS86KBZ.js";
import { o as resolveAuthProfileDatabaseFilePaths } from "./sqlite-CCIog9t1.js";
import { t as collectIncludePathsRecursive } from "./includes-scan-BgxgSE_-.js";
...
const loadSkillsModule = createLazyRuntimeModule(() => import("./workspace-xo2G9vx9.js"));
const loadConfigModule = createLazyRuntimeModule(() => import("./config/config.js"));
const loadAuditFsModule = createLazyRuntimeModule(() => import("./audit-fs-KfE5QKek.js"));
const loadAgentScopeModule = createLazyRuntimeModule(() => import("./agent-scope-RIXtZ2Lu.js"));
const loadAgentWorkspaceDirsModule = createLazyRuntimeModule(() => import("./workspace-dirs-iQ3svXMG.js"));
const loadSkillSourceModule = createLazyRuntimeModule(() => import("./source-C6H4DQLF.js"));
const loadSkillScannerModule = createLazyRuntimeModule(() => import("./scanner-CRlVG5tW.js"));
const loadExecDockerRaw = createLazyRuntimeNamedExport(() => import("./docker-Bhv17sa4.js"), "execDockerRaw");
const loadSandboxBrowserSecurityHashEpoch = createLazyRuntimeNamedExport(() => import("./constants-BTvyWqak.js"), "SANDBOX_BROWSER_SECURITY_HASH_EPOCH");
...
const MAX_SKILL_AUDIT_FILE_BYTES = 256e3;
async function readPluginManifestExtensions(pluginPath) {
	...
	if (statResult.stat.size > MAX_PLUGIN_MANIFEST_BYTES) throw new Error(`Plugin manifest at ${manifestPath} is too large (${statResult.stat.size} bytes, max ${MAX_PLUGIN_MANIFEST_BYTES})`);
...
async function getCodeSafetySummary(params) {
	...
	return params.summaryCache ? await getOrCreatePromise(params.summaryCache, cacheKey, scan) : await scan();
}
async function getSkillCodeSafetySummary(params) {
	...
	const skillFindings = [...skillScanner.scanSkillContent(skillContent, params.skillFilePath), ...skillScanner.scanSource(skillContent, params.skillFilePath)];
	return {
		...summary,
		scannedFiles: summary.scannedFiles + 1,
		critical: summary.critical + skillFindings.filter((finding) => finding.severity === "critical").length,
...
//#endregion
export { collectStateDeepFilesystemFindings as a, collectSandboxBrowserHashLabelFindings as i, collectInstalledSkillsCodeSafetyFindings as n, readConfigSnapshotForAudit as o, collectPluginsCodeSafetyFindings as r, listInstalledPluginDirs as s, collectIncludeFilePermFindings as t };
