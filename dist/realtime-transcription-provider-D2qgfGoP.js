...
import { t as createRealtimeTranscriptionWebSocketSession } from "./realtime-transcription-sH8AvwfS.js";
import { n as DEFAULT_DEEPGRAM_AUDIO_MODEL, t as DEFAULT_DEEPGRAM_AUDIO_BASE_URL } from "./audio-B9DnpcO1.js";
...
function normalizeDeepgramRealtimeBaseUrl(value) {
	...
	if (!resolved) return DEFAULT_DEEPGRAM_AUDIO_BASE_URL;
	let parsed;
	try {
	...
	if (protocol !== "http:" && protocol !== "https:" && protocol !== "ws:" && protocol !== "wss:") throw new Error(`Invalid Deepgram baseUrl: unsupported scheme "${protocol}" (expected http, https, ws, or wss)`);
	return resolved;
}
...
//#endregion
export { buildDeepgramRealtimeTranscriptionProvider as t };
