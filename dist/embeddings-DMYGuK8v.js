...
import { T as withRemoteHttpResponse, w as buildRemoteBaseUrlPolicy } from "./memory-core-host-engine-embeddings-BgaDotZ3.js";
import { n as resolveGithubCopilotDomain } from "./domain-Bw0bH59M.js";
import { t as resolveFirstGithubToken } from "./auth-rh8c3Ax_.js";
import { r as resolveCopilotApiToken } from "./token-Cvxr5n9Y.js";
...
const githubCopilotMemoryEmbeddingProviderAdapter = {
	...
	create: async (options) => {
		...
		const value = explicitValue ? explicitValue : (await resolveFirstGithubToken({
