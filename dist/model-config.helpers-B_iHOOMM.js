...
import { y as resolveConfiguredModelRef } from "./model-selection-shared-CPPxIJAX.js";
import { b as overlayRuntimeExternalOAuthProfiles } from "./persisted-BCOBzYGx.js";
...
import { h as resolveProviderEntryApiKeyProfileReference, l as hasRuntimeAvailableProviderAuth } from "./model-auth-919iJVmy.js";
...
function hasAuthForProvider(params) {
	if (resolveEnvApiKey(params.provider, void 0, {
		config: params.cfg,
...
if (process.env.VITEST || false) globalThis[Symbol.for("openclaw.modelConfigHelpersTestApi")] = { hasDirectProviderApiKeyAuthForTool };
