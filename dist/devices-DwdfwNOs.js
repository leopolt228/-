...
import { _t as validateDeviceTokenRotateParams, dt as validateDevicePairListParams, ft as validateDevicePairRejectParams, gt as validateDeviceTokenRevokeParams, mt as validateDevicePairRenameParams, pt as validateDevicePairRemoveParams, ut as validateDevicePairApproveParams } from "./src-Cy32TawB.js";
import { t as formatValidationErrors } from "./validation-errors-B9K6VbD7.js";
import { _ as rotateDeviceToken, a as getPairedDevice, f as rejectDevicePairing, g as revokeDeviceToken, i as formatDevicePairingForbiddenMessage, l as listDevicePairing, n as approveDevicePairing, o as getPendingDevicePairing, p as removePairedDevice, v as summarizeDeviceTokens, y as updatePairedDeviceMetadata } from "./device-pairing-DUA4LHep.js";
import { a as requestsNonOperatorDeviceRole, i as pairedDeviceHasNonOperatorRole, n as deniesCrossDeviceManagement, o as resolveDeviceManagementAuthz, r as deniesDeviceTokenRoleManagement, s as resolveDeviceSessionAuthz, t as emitDeviceManagementSecurityEvent } from "./device-management-security-B6hlVr-P.js";
...
const deviceHandlers = {
	...
	"device.pair.rename": async ({ params, respond, context, client }) => {
		if (!validateDevicePairRenameParams(params)) {
			respond(false, void 0, errorShape(ErrorCodes.INVALID_REQUEST, `invalid device.pair.rename params: ${formatValidationErrors(validateDevicePairRenameParams.errors)}`));
			return;
		}
