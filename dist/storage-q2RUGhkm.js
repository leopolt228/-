...
import { t as loadJsonFile } from "./json-store-CS0_WBTp.js";
import "./record-shared-D2Qyeqd0.js";
import { t as getMatrixRuntime } from "./runtime-Drg4hYqm.js";
import { n as resolveMatrixAccountStorageRoot } from "./storage-paths-Bs4KG8Wn.js";
import { g as readMatrixIdbSnapshotJson, l as migrateLegacyMatrixRecoveryKeyFileToStore, n as MATRIX_LEGACY_CRYPTO_MIGRATION_FILENAME, r as MATRIX_RECOVERY_KEY_FILENAME, s as migrateLegacyMatrixLegacyCryptoMigrationFileToStore, t as MATRIX_IDB_SNAPSHOT_FILENAME, v as scoreMatrixCryptoStateInStore, w as resolveMatrixSqliteStateEnv, y as writeMatrixIdbSnapshotJson } from "./crypto-state-store-eod25Kjg.js";
...
function resolvePreferredMatrixStorageRoot(params) {
	...
	if (!(canonicalMetadata.accessTokenHash === params.canonicalTokenHash && canonicalMetadata.deviceId?.trim() === params.deviceId.trim() && canonicalMetadata.currentTokenStateClaimed === true)) {
...
async function maybeMigrateLegacyStorage(params) {
	...
	const syncCache = hasAccountScopedLegacyStorageFile ? await import("./file-sync-store-Cpp8R3Tp.js") : null;
	...
	if (!hasAccountScopedLegacyStorage && !hasAccountScopedRecoveryKey && !hasAccountScopedIdbSnapshot && !hasAccountScopedLegacyCryptoMigration) return;
...
async function migrateLegacyIdbSnapshotToSqlite(params) {
	...
	const { readLegacyMatrixIdbSnapshotState } = await import("./idb-persistence-D4QSfS4T.js");
...
async function migrateLegacySyncCacheToSqlite(params) {
	const syncCache = await import("./file-sync-store-Cpp8R3Tp.js");
