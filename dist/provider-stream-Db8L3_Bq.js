...
import { l as readResponseTextSnippet } from "./http-body-g29H4gTR.js";
import { a as unwrapSecretSentinelsForProviderEgress, c as looksLikeSecretSentinel, i as unwrapModelHeaderSentinelsForProviderEgress, n as unwrapHeaderSentinelsForProviderEgress, u as resolveSecretSentinel } from "./provider-secret-egress-BC9ES6v4.js";
import { n as resolveProviderEndpoint } from "./provider-attribution-D75_xhiu.js";
import { _ as buildCopilotDynamicHeaders, i as getModelProviderRequestTransport, y as hasCopilotVisionInput } from "./provider-request-config-DrrUROfX.js";
import { O as resolveProviderStreamFn } from "./provider-runtime-BE5KxvKF.js";
import { s as getModelLlmRuntime } from "./stream-CKgZbNR4.js";
import "./ai-transport-host-CpSAJnEP.js";
import { n as parseRetryAfterSeconds, t as buildGuardedModelFetch } from "./provider-transport-fetch-CqHtV1lD.js";
import { o as getModelProviderLocalService } from "./provider-local-service-BuXibLi1.js";
import { t as event_stream_exports } from "./event-stream-MHM-_qcK.js";
import { t as MALFORMED_STREAMING_FRAGMENT_ERROR_MESSAGE } from "./assistant-error-format-Dw1scAnL.js";
import { r as buildStreamErrorAssistantMessage } from "./stream-message-shared-DKS8UMJ_.js";
import { F as resolveAnthropicPayloadPolicy, N as applyAnthropicPayloadPolicyToParams } from "./provider-stream-shared-BiURRLUJ.js";
import { t as parseJsonObjectPreservingUnsafeIntegers } from "./json-unsafe-integers-DpTiDHBw.js";
import { _ as finalizeTransportStream, b as sanitizeTransportPayloadText, f as coerceTransportToolCallArguments, g as failTransportStream, h as encodeAssistantTextSignatureV1, m as createWritableTransportEventStream, n as createAzureOpenAIResponsesTransportStreamFn, o as createOpenAICompletionsTransportStreamFn, p as createEmptyTransportUsage, r as createOpenAIResponsesTransportStreamFn, v as mergeTransportHeaders, x as transformTransportMessages, y as sanitizeNonEmptyTransportPayloadText } from "./openai-transport-stream-810ZIbd4.js";
import { calculateCost, clampThinkingLevel, createDeferredEventBuffer, getEnvApiKey, notifyLlmRequestActivity, parseStreamingJson } from "@openclaw/ai/internal/runtime";
import { describeToolResultMediaPlaceholder, extractToolResultBlockText, extractToolResultText, isImageWithMediaPayload } from "@openclaw/ai/internal/shared";
...
function convertContentBlocks(content) {
	...
	if (!content.some(isImageWithMediaPayload)) return sanitizeNonEmptyTransportPayloadText(text, mediaPlaceholder ?? "(no output)");
	const blocks = [];
