...
import { At as APIRole, Nt as Snowflake, T as APIMessage, i as DiscordReplyReference, n as DiscordSendComponents, r as DiscordSendEmbeds, st as APIChannel, t as DiscordAllowedMentions, z as APIGuildMember } from "./send.shared-B9tglP0k.js";
import { a as APIGuildScheduledEventRecurrenceRule, i as APIGuildScheduledEventEntityMetadata, n as APIVoiceState, o as GuildScheduledEventEntityType, r as APIGuildScheduledEvent, s as GuildScheduledEventPrivacyLevel } from "./voice-BqCzA7ym.js";
import { C as RequestClient, S as DiscordTimeoutTarget, a as DiscordEmojiUpload, b as DiscordThreadCreate, c as DiscordModerationTarget, f as DiscordReactionSummary, g as DiscordSearchQuery, i as DiscordChannelPermissionSet, l as DiscordPermissionsSummary, m as DiscordRoleChange, n as DiscordChannelEdit, o as DiscordMessageEdit, r as DiscordChannelMove, s as DiscordMessageQuery, t as DiscordChannelCreate, u as DiscordReactOpts, v as DiscordSendResult, x as DiscordThreadList, y as DiscordStickerUpload } from "./send.types-BrHT45LA.js";
...
type DiscordSendOpts = {
  ...
  allowedMentions?: DiscordAllowedMentions; /** Persist each concrete platform send before any later chunk can fail. */
