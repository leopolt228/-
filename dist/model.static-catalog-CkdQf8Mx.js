...
import { i as passesManifestOwnerBasePolicy, n as isActivatedManifestOwner, r as isBundledManifestOwner, t as hasExplicitManifestOwnerTrust } from "./manifest-owner-policy-DDNqTTIl.js";
import { r as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-BQju0mzJ.js";
import { n as planManifestModelCatalogSuppressions, t as planManifestModelCatalogRows } from "./manifest-planner-DSmSdykb.js";
import "./defaults-CdX9UGcX.js";
import { r as normalizeStaticProviderModelId } from "./model-ref-shared-BlCyhiC_.js";
import { a as listOpenClawPluginManifestMetadata } from "./provider-attribution-D75_xhiu.js";
import { u as isSecretRefHeaderValueMarker } from "./model-auth-markers-Bqpoo9x7.js";
...
import { a as runProviderStaticCatalog, n as normalizePluginDiscoveryResult, r as resolveRuntimePluginDiscoveryProviders } from "./provider-discovery-B-1rMaLa.js";
...
function resolveManifestModelCatalogProviderAliasMetadata(params) {
	...
	})?.plugins : void 0) ?? loadPluginManifestRegistry({
		config: params.cfg,
		workspaceDir: params.workspaceDir,
		env
	}).plugins;
...
function listBundledStaticCatalogPlugins(params) {
	const normalizedConfig = normalizePluginsConfig(params.cfg?.plugins);
	return listOpenClawPluginManifestMetadata(params.env).flatMap((record) => {
...
//#endregion
export { resolveBundledProviderStaticCatalogModel as a, buildInlineProviderModels as c, sanitizeModelHeaders as d, loadBundledProviderStaticCatalogContextModels as i, normalizeResolvedTransportApi as l, createBundledProviderStaticCatalogContextResolver as n, resolveBundledStaticCatalogModel as o, createBundledStaticCatalogModelResolver as r, resolveManifestModelCatalogProviderAliasMetadata as s, bundledStaticCatalogProviderUsesRuntimeAugment as t, resolveProviderModelInput as u };
