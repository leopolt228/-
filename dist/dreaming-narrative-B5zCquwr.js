...
import { n as extractErrorCode, r as formatErrorMessage, s as readErrorName } from "./errors-DdbcjW1Y.js";
...
import { t as cleanupSessionLifecycleArtifacts } from "./session-store-runtime-yTK-eEl-.js";
import "./async-lock-runtime-DvLtbzZt.js";
import "./global-singleton-DZQj1BsZ.js";
import "./memory-core-host-runtime-core-CWElAZzA.js";
import { i as updateDreamsFile, n as resolveDreamsPath, t as readDreamsFile } from "./dreaming-dreams-file-CWTIwDEJ.js";
...
const detachedNarrativeLimit = pLimit(3);
function runDetachedDreamNarrative(params) {
	queueMicrotask(() => {
		detachedNarrativeLimit(() => generateAndAppendDreamNarrative(params)).catch(() => {});
	});
}
//#endregion
export { removeBackfillDiaryEntries as a, readRecentDreamDiaryEntries as i, dedupeDreamDiaryEntries as n, runDetachedDreamNarrative as o, generateAndAppendDreamNarrative as r, writeBackfillDiaryEntries as s, appendFallbackNarrativeEntry as t };
