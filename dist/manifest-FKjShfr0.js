...
import { n as ENV_SECRET_REF_ID_RE } from "./types.secrets-BgE_Zq2x.js";
import "./boundary-file-read-BgBHxIxZ.js";
import { r as normalizeModelCatalogProviderId } from "./model-catalog-refs-BcuK-xC3.js";
import { t as normalizeModelCatalog } from "./model-catalog-normalize-Ji73MOA0.js";
...
import { t as normalizeManifestCommandAliases } from "./manifest-command-aliases-DqwrBXg7.js";
...
function loadPluginManifest(rootDir, rejectHardlinks = true, rootRealPath) {
	...
	const modelCatalog = normalizeModelCatalog(raw.modelCatalog, { ownedProviders: /* @__PURE__ */ new Set([...providers, ...cliBackends]) });
...
//#endregion
export { loadPluginManifest as a, resolvePackageExtensionEntries as c, isCoreReservedPluginId as i, PLUGIN_MANIFEST_FILENAME as n, normalizeManifestActivation as o, getPackageManifestMetadata as r, normalizeManifestChannelCommandDefaults as s, DEFAULT_PLUGIN_ENTRY_CANDIDATES as t };
