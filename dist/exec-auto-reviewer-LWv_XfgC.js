...
import { Rn as string, Tn as object, yt as _enum } from "./schemas-CBJjibl3.js";
import { t as sanitizeTerminalText } from "./safe-text-OpUydskC.js";
import { n as coerceToolModelConfig } from "./model-config.helpers-B_iHOOMM.js";
...
function extractCompletionFailure(result) {
	...
	if (stopReason === "error") return normalizeRationale("errorMessage" in result && typeof result.errorMessage === "string" ? result.errorMessage : void 0, "model returned an error");
...
//#endregion
export { defaultExecAutoReviewer as n, createModelExecAutoReviewer as t };
