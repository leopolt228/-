...
import { h as resolveFutureConfigActionBlock } from "./config-env-vars-9fUuyise.js";
import { o as isSystemdUserServiceAvailable } from "./systemd-iYtBw5_g.js";
import { t as createGatewayCredentialPlan } from "./credential-planner-D0Q5gMV5.js";
import { n as isGatewaySecretRefUnavailableError, t as GatewaySecretRefUnavailableError } from "./credentials-avJwgw8n.js";
import { t as resolveGatewayAuthToken } from "./auth-token-resolution-xSZjHuix.js";
import { l as readConfigFileSnapshot, s as readBestEffortConfig } from "./io-CEgS2K9F.js";
import { d as isWSL } from "./undici-runtime-CvoyIVwn.js";
...
import { t as appendGatewayLifecycleAuditLog } from "./restart-logs-BENYnzNc.js";
import { t as createGatewayLifecycleMutationReporter } from "./service-mutation-PgzR3-XQ.js";
import { r as checkTokenDrift } from "./service-audit-7zro2961.js";
import { o as startGatewayService, r as inspectGatewayServiceStartRepair, t as describeGatewayServiceRestart } from "./service-DSig-f_R.js";
import { o as renderSystemdUnavailableHints } from "./runtime-hints-CjbqWfI_.js";
import { _ as emitDaemonScheduledRestart, g as emitDaemonAlreadyRunning, i as filterContainerGenericHints, m as createDaemonActionContext, p as buildDaemonServiceSnapshot } from "./shared-B2j_B0O6.js";
...
//#endregion
//#region src/cli/daemon-cli/lifecycle-config-preflight.ts
	...
	try {
		...
		if (startResult.outcome === "already-running") {
			if (startResult.issues.length > 0) {
				const warning = `${params.serviceNoun} service already running, but its installed service definition needs repair: ${startResult.issues.map((issue) => issue.message).join("; ")}; run \`openclaw gateway restart\` to apply.`;
