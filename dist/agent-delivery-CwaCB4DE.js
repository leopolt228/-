...
import { o as normalizeRouteBindingChannelId } from "./bindings-D7XnMxhP.js";
...
async function resolveAgentDeliveryPlanWithSessionRoute(params) {
	...
	const resolvedAccountId = plan.resolvedAccountId ?? (params.sessionRouteMode === "allow-fallback" ? resolveChannelDefaultAccountId({
		plugin,
		cfg: params.cfg
	}) : void 0);
