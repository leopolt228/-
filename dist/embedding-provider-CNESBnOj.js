...
import { o as createProviderHttpError, p as readProviderJsonObjectResponse } from "./provider-http-errors-DrOMjuGn.js";
...
import { T as withRemoteHttpResponse, o as debugEmbeddingsLog, w as buildRemoteBaseUrlPolicy } from "./memory-core-host-engine-embeddings-BgaDotZ3.js";
...
const GEMINI_EMBEDDING_2_MODELS = /* @__PURE__ */ new Set(["gemini-embedding-2-preview"]);
...
async function resolveGeminiEmbeddingClient(options) {
	...
	const headers = {
		...Object.assign({}, providerConfig?.headers, remote?.headers),
...
//#endregion
export { buildGeminiEmbeddingRequest as n, createGeminiEmbeddingProvider as r, DEFAULT_GEMINI_EMBEDDING_MODEL as t };
