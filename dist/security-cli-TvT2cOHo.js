...
import { n as formatIcaclsResetCommand, t as createIcaclsResetCommand } from "./permissions-sY2quqHz.js";
...
import { f as getSecurityAuditCommandSecretTargetIds } from "./command-secret-targets-CztQ0pHm.js";
import { t as formatHelpExamples } from "./help-format-CAcwboTs.js";
import { t as runSecurityAudit } from "./audit-DmtK7SJK.js";
...
async function collectChannelSecurityConfigFixMutation(params) {
	...
	const collectPlugins = async () => {
		...
		try {
			...
			const { listBundledChannelPlugins } = await import("./bundled-022k_Ll_.js");
