...
import { a as getPositiveIntFlagValue, c as hasFlag, i as getFlagValue, j as isValueToken, r as getCommandPositionalsWithRootOptions, s as getVerboseFlag } from "./argv-D4LdWdQQ.js";
import { t as resolveCliArgvInvocation } from "./argv-invocation-DyflwSWk.js";
import { r as defaultRuntime } from "./runtime-ZHfN2VLf.js";
import { x as tryParseLogLevel } from "./logger-Dy4xN1lg.js";
import { i as cliCommandCatalog, r as matchesCommandPath, t as resolveCliCommandPathPolicy } from "./command-path-policy-DM1tak9F.js";
...
const configCliLoader = createLazyImportLoader(() => import("./config-cli-DKeeiuZJ.js"));
const agentsListCommandLoader = createLazyImportLoader(() => import("./agents.commands.list-BIH9HkIZ.js"));
const modelsListCommandLoader = createLazyImportLoader(() => import("./list.list-command-D3ELtECY.js"));
const modelsStatusCommandLoader = createLazyImportLoader(() => import("./list.status-command-CLap3Jal.js"));
const tasksJsonCommandLoader = createLazyImportLoader(() => import("./tasks-json-ClyCbUak.js"));
...
const routedCommandDefinitions = {
	...
	status: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			if (args.json) {
				const { statusJsonCommand } = await import("./status-json-r27ZuMO0.js");
			...
			const { statusCommand } = await import("./status-HeaFvU0-.js");
	...
	"gateway-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { runDaemonStatus } = await import("./status-CdOwJhX_.js");
	...
	sessions: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { sessionsCommand } = await import("./sessions-43vzt7wL.js");
	...
	"channels-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsListCommand } = await import("./list-CwCtgpxF.js");
	...
	"channels-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsStatusCommand } = await import("./status-BUhD7-Ti.js");
