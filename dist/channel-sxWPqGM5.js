...
import { v as DmPolicySchema, x as GroupPolicySchema } from "./zod-schema.agent-runtime-CeKzEtj8.js";
...
import { D as isValidAgentHarnessSessionStoreEntry } from "./store-DDuGv_UJ.js";
import { i as createActionGate, t as ToolAuthorizationError } from "./common-C39GdgQ7.js";
...
import { b as resolveLegacyInteractiveTextFallback, d as normalizeLegacyInteractiveReply, f as normalizeMessagePresentation, l as legacyInteractiveReplyToPresentation } from "./payload-Br8oiJ5V.js";
import { i as createHybridChannelConfigAdapter, t as adaptScopedAccountAccessor } from "./channel-config-helpers-BFvX3ldW.js";
import { n as describeAccountSnapshot } from "./account-helpers-BAtt8fRD.js";
import "./string-coerce-runtime-DBMkn-gE.js";
import "./number-runtime-C6TGSEc_.js";
import "./text-chunking-CcRmx-1w.js";
import { f as resolveSessionStoreBackupPaths, i as listSessionEntries, m as resolveStorePath, n as deleteSessionEntry, o as loadTranscriptEventsSync } from "./session-store-runtime-yTK-eEl-.js";
...
import { D as patchTopLevelChannelConfigSection, J as setSetupChannelEnabled, P as promptSingleChannelSecretInput, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-BswN5Wen.js";
...
import { F as projectConfigAccountIdWarningCollector, T as createAllowlistProviderGroupPolicyWarningCollector } from "./channel-policy-DtbLL_f5.js";
import { n as createChannelDirectoryAdapter } from "./directory-runtime-D-aYlyzl.js";
import "./state-paths-C3W_AJaz.js";
import { a as resolveDefaultFeishuAccountId, i as listFeishuAccountIds, l as resolveFeishuRuntimeAccount, n as inspectFeishuCredentials, p as isRecord$1, r as listEnabledFeishuAccounts, s as resolveFeishuAccount } from "./accounts-CuzXFu13.js";
import { i as resolveReceiveIdType, n as looksLikeFeishuId, r as normalizeFeishuTarget } from "./targets-BLFgry8p.js";
import { A as resolveFeishuChatType, D as resolveFeishuGroupToolPolicy, _ as canEnumerateAllFeishuPeers, a as readNativeFeishuCardJson, b as resolveFeishuChatReadPreliminaryAuthorization, g as canEnumerateAllFeishuGroups, h as authorizeFeishuChatMemberRead, k as normalizeFeishuChatType, m as assertFeishuChatReadAllowed, n as createFeishuSendReceipt, u as chunkFeishuMarkdown, v as isFeishuGroupReadAllowed, w as resolveFeishuGroupConfig, y as isFeishuGroupReadEnabled } from "./send-result-4_MfqLAs.js";
import { a as parseFeishuTargetId, i as parseFeishuDirectConversationId, n as buildFeishuModelOverrideParentCandidates, o as resolveConfiguredFeishuGroupSessionScope, r as parseFeishuConversationId, t as buildFeishuConversationId } from "./conversation-id-n3DsWiZc.js";
import { a as listAuthorizedFeishuDirectoryGroups, c as listFeishuDirectoryPeers, i as isFeishuCardWithinEnvelope, n as buildFeishuPresentationCard, o as listAuthorizedFeishuDirectoryPeers, s as listFeishuDirectoryGroups, t as assertFeishuCardWithinEnvelope } from "./presentation-card-wpw4FsxQ.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-BDIi591A.js";
import { t as messageActionTargetAliases } from "./security-audit-CrT9nISP.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-CUvIRWGC.js";
import { t as collectFeishuSecurityAuditFindings } from "./security-audit-shared-CiBhPqHF.js";
import { t as resolveFeishuSessionConversation } from "./session-conversation-Bug0GfrF.js";
...
const FeishuChannelConfigSchema = buildChannelConfigSchema(buildMultiAccountChannelSchema(object({
	enabled: boolean().optional(),
...
const loadAppRegistrationModule = createLazyRuntimeModule(() => import("./app-registration-0GSVBALq.js"));
	...
	status: {
		...
		resolveStatusLines: async ({ cfg, accountId, configured }) => {
			...
			if (configured && account.configured) try {
				const { probeFeishu } = await import("./probe-f26Aftdo.js");
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-WAkIyJTX.js"), "feishuChannelRuntime");
...
async function createFeishuActionClient(account) {
	const { createFeishuClient } = await import("./client-f5dBR-4_.js");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-BZPPPb6B.js");
