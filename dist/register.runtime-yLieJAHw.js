...
import { a as resolveClaudeFable5ModelIdentity, d as supportsClaudeNativeMaxEffort, f as supportsClaudeNativeXhighEffort, l as resolveClaudeSonnet5ModelIdentity, o as resolveClaudeModelIdentity, s as resolveClaudeMythos5ModelIdentity, u as supportsClaudeAdaptiveThinking } from "./src-BnQDOjpw.js";
...
import { n as validateAnthropicSetupToken, t as buildTokenProfileId } from "./provider-auth-token-DyHOhkct.js";
import { t as createProviderApiKeyAuthMethod } from "./provider-api-key-auth-CLvbHQd1.js";
import "./cli-runtime-EOKn8Yr-.js";
import { a as buildProviderReplayFamilyHooks, f as cloneFirstTemplateModel, s as modelCostsEqual } from "./provider-model-shared-Dzz3IkWT.js";
import { n as readClaudeCliCredentialsForSetup, r as readClaudeCliCredentialsForSetupNonInteractive } from "./cli-auth-seam-DxI6jJpU.js";
import { a as CLAUDE_CLI_DEFAULT_ALLOWLIST_REFS, i as CLAUDE_CLI_CANONICAL_DEFAULT_MODEL_REF, n as CLAUDE_CLI_BACKEND_ID } from "./cli-constants-Dd4reMVq.js";
import { n as CLAUDE_CLI_OFF_THINKING_PROFILE } from "./cli-shared-CoqvygH3.js";
import { t as buildAnthropicCliBackend } from "./cli-backend-Bc41wm31.js";
import { t as buildClaudeCliCatalogEntries } from "./cli-catalog-D5Ll0DUX.js";
import { t as buildAnthropicCliMigrationResult } from "./cli-migration-CjF-NL5g.js";
import { n as normalizeAnthropicProviderConfigForProvider, t as applyAnthropicConfigDefaults } from "./config-defaults-BCnOf1oD.js";
import { t as anthropicMediaUnderstandingProvider } from "./media-understanding-provider-B5ztT62z.js";
import { n as resolveClaudeCliSyntheticAuth } from "./provider-discovery-DxWTjybP.js";
import { n as createClaudeSessionNodeInvokePolicies } from "./session-catalog-node-commands-BiR2X19T.js";
import { t as registerClaudeSessionDiscovery } from "./session-catalog-registration-DQNk52rB.js";
import { s as wrapAnthropicProviderStream } from "./stream-wrappers-DgVQJcnx.js";
import { n as resolveAnthropicUsageAuth, t as fetchAnthropicUsage } from "./usage-gTC_AMyw.js";
...
function buildAnthropicForwardCompatModel(ctx) {
	...
	return {
		...
		cost: isAnthropicMandatoryClaude5Model(trimmedModelId) ? {
			...
			cacheRead: 1,
			cacheWrite: 12.5
		} : isAnthropicSonnet5Model(trimmedModelId) && provider === PROVIDER_ID ? resolveAnthropicSonnet5Cost() : {
			input: 0,
			output: 0,
			cacheRead: 0,
			cacheWrite: 0
...
function resolveAnthropicFixedContextWindow(provider, modelId) {
	return isAnthropicMandatoryClaude5Model(modelId) || isAnthropicSonnet5Model(modelId) || isAnthropicGa1MModel(modelId) && (normalizeLowercaseStringOrEmpty(provider) !== "claude-cli" || normalizeLowercaseStringOrEmpty(modelId).endsWith("[1m]")) ? ANTHROPIC_1M_CONTEXT_TOKENS : void 0;
}
function isAnthropic128kOutputModel(modelId) {
	return isAnthropicMandatoryClaude5Model(modelId) || isAnthropicSonnet5Model(modelId) || isAnthropicGa1MModel(modelId);
}
...
function applyAnthropicFixedContextWindow(params) {
	...
	const exactContextWindow = isAnthropicMandatoryClaude5Model(params.contractModelId) || isAnthropicSonnet5Model(params.contractModelId);
...
function normalizeAnthropicResolvedModel(ctx) {
	...
	const contractModel = (isAnthropicMandatoryClaude5Model(contractModelId) || isAnthropicSonnet5Model(contractModelId)) && !ctx.model.reasoning ? {
		...ctx.model,
		reasoning: true
	} : ctx.model;
	...
	const pricingModel = normalizeLowercaseStringOrEmpty(ctx.provider) === PROVIDER_ID ? applyAnthropicSonnet5Cost({
		modelId: contractModelId,
