...
import { n as require_ecdsa_sig_formatter, t as require_jws } from "./jws-yRRSvXJf.js";
 ...
 /**
		...
		*/
		static async #getProxyAgent() {
			this.#proxyAgent ||= (await import("./dist-BAQVGNtY.js").then((m) => /* @__PURE__ */ __toESM(m.default))).HttpsProxyAgent;
			return this.#proxyAgent;
		}
		static async #getFetch() {
			const hasWindow = typeof window !== "undefined" && !!window;
			this.#fetch ||= hasWindow ? window.fetch : (await import("./src-Bh2BYri-.js")).default;
			return this.#fetch;
		}
		/**
		* Merges headers.
...
var require_getCredentials = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const readFile = fs$5.readFile ? (0, util_1$1.promisify)(fs$5.readFile) : async () => {
...
var require_filesubjecttokensupplier = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	const readFile = (0, util_1.promisify)(fs$4.readFile ?? (() => {}));
	const realpath = (0, util_1.promisify)(fs$4.realpath ?? (() => {}));
	const lstat = (0, util_1.promisify)(fs$4.lstat ?? (() => {}));
	/**
