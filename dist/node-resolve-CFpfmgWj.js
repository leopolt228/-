...
function compactNormalizedNodeKey(value) {
...
function resolveMatchScore(node, query, queryNormalized, allowCompactDisplayName) {
	...
	if (allowCompactDisplayName && nameNormalized && compactNormalizedNodeKey(nameNormalized) === compactNormalizedNodeKey(queryNormalized)) return 1900;
...
function resolveScoredMatches(nodes, query, allowCompactDisplayName) {
