...
import { a as toAcpRuntimeError } from "./errors-C7_LR8fF.js";
...
import { i as resolveBundledPluginInstallCommandHint } from "./bundled-sources-VLkHE07m.js";
import { n as resolveAcpCommandBindingContext } from "./context-BurwjXD5.js";
import { C as stopWithText, n as ACP_DOCTOR_USAGE, p as formatAcpCapabilitiesText, r as ACP_INSTALL_USAGE, s as ACP_SESSIONS_USAGE } from "./shared-CyF5p6RF.js";
import { n as resolveBoundAcpThreadSessionKey } from "./targets-BZVywLDa.js";
...
async function handleAcpSessionsAction(params, restTokens) {
	...
	const rows = (params.command.senderIsOwner ? await listAcpSessionEntries({ cfg: params.cfg }) : currentEntry?.entry && currentEntry.acp ? [currentEntry] : []).toSorted((a, b) => (b.entry?.updatedAt ?? 0) - (a.entry?.updatedAt ?? 0)).slice(0, 20).map(({ storeSessionKey, entry, acp }) => {
		if (!entry || !acp) return "";
