...
import { _ as readLoggingConfig, c as redactSensitiveText, n as getDefaultRedactPatterns } from "./redact-DNq_HeDt.js";
import { t as sanitizeForLog } from "./ansi-BEaQ2G9r.js";
import { r as formatErrorMessage } from "./errors-DdbcjW1Y.js";
import { i as emitFailoverEvent } from "./diagnostic-events-Dt41CZkD.js";
...
import { p as resolvePluginControlPlaneFingerprint, r as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-BQju0mzJ.js";
...
import { S as resolveModelRefFromString, i as buildModelAliasIndex, n as buildConfiguredAllowlistKeys, y as resolveConfiguredModelRef } from "./model-selection-shared-CPPxIJAX.js";
import { n as getPluginRegistryState, t as getActivePluginRegistryWorkspaceDirFromState } from "./runtime-state-Bd0YsvqM.js";
...
import { t as isPluginProvidersLoadInFlight } from "./providers.runtime-rdUuPAIP.js";
...
import { r as isActiveUnusableWindow } from "./usage-state-BNklJz_j.js";
import { t as TRANSCRIPT_NOT_CONTINUABLE_ERROR_CODE } from "./errors-wmH7Ncz4.js";
import { s as parseApiErrorInfo } from "./assistant-error-format-Dw1scAnL.js";
import "./model-selection-resolve-DBp2V5If.js";
import { t as isCliProvider } from "./model-selection-cli-DOykA-i1.js";
import { r as externalCliDiscoveryForProviders } from "./external-cli-discovery-To6-j7MZ.js";
import { t as redactIdentifier } from "./redact-identifier-BjaGGxG8.js";
import { o as getApiErrorPayloadFingerprint } from "./sanitize-user-facing-text-sWgeyF-a.js";
import { b as isLikelyContextOverflowError, o as classifyProviderRuntimeFailureKind } from "./errors-DMOgb-Rt.js";
import { _ as isMissingAgentHarnessError, a as describeFailoverError, c as isFailoverError, g as MissingAgentHarnessError, i as coerceToFailoverError, l as isNonProviderRuntimeCoordinationError, m as resolveModelFallbackError, n as buildFailoverRemediationHint, o as findCliMaxTurnsError, r as buildProviderReauthCommand, t as FailoverError } from "./failover-error-B8xHNn2y.js";
import { n as isCliRuntimeAlias } from "./model-runtime-aliases-XZ8Sb-m9.js";
import { o as isAgentRunDirectAbortReason, s as isAgentRunRestartAbortReason } from "./run-termination-BQ_P-sPi.js";
import "./embedded-agent-helpers-DDAtCAER.js";
import { d as isCommandLaneTaskTimeoutError } from "./command-queue-B2fMJE4M.js";
import { n as isCronTerminalAbortReasonText } from "./execution-errors-zetyeuvZ.js";
import { i as resolveSessionSuspensionReason, o as runWithDeferredSessionSuspension, s as suspendSession } from "./session-suspension-DNYLXcr7.js";
...
function isTranscriptNotContinuableError(err) {
	...
	return err.code === TRANSCRIPT_NOT_CONTINUABLE_ERROR_CODE;
}
...
function isTerminalAbortFromError(err) {
	...
	for (const candidate of causeCandidates) if (isAgentRunRestartAbortReason(candidate)) return true;
	if (!isOpenClawAbortableWrapper(err)) return false;
...
async function runFallbackCandidate(params) {
	try {
		...
		if (isAgentRunDirectAbortReason(err) || isAgentRunRestartAbortReason(err)) throw err;
...
async function resolveModelFallbackCandidateHarnessAuthPrecheck(params) {
	...
	if (agentRuntime === "openclaw") return result(false);
	...
	if (getRegisteredAgentHarness(agentRuntime)) return result(true);
...
function shouldDiscardDeferredSessionSuspension(params) {
	return isTerminalAbort(params.abortSignal) || isCallerAbortSignal(params.abortSignal) || isAgentRunDirectAbortReason(params.error) || isAgentRunRestartAbortReason(params.error) || isTerminalAbortFromError(params.error) || isCommandLaneTaskTimeoutError(params.error) || isNonProviderRuntimeCoordinationError(params.error) || isTranscriptNotContinuableError(params.error) || isLikelyContextOverflowError(formatErrorMessage(params.error));
}
if (process.env.VITEST || false) globalThis[Symbol.for("openclaw.modelFallbackTestApi")] = {
...
//#endregion
export { runWithImageModelFallback as a, buildTextObservationFields as c, shouldUseTransientCooldownProbeSlot as d, abortable as f, resolveModelCandidateChain as i, shouldSuppressRawErrorConsoleSuffix as l, resolveImageFallbackCandidates as n, runWithModelFallback as o, resolveImageFallbackDefaultProvider as r, buildApiErrorObservationFields as s, isFallbackSummaryError as t, LiveSessionModelSwitchError as u };
