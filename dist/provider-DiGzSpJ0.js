import { d as supportsClaudeNativeMaxEffort } from "./src-BnQDOjpw.js";
...
import { E as resolveFoundryTargetProfileId, T as resolveFoundryModelCapabilities, c as applyFoundryProfileBinding, d as buildFoundryProviderBaseUrl, f as extractFoundryEndpoint, g as isFoundryProviderApi, l as applyFoundryProviderConfig, m as isFoundryClaudeMythosPreview, o as PROVIDER_ID, v as mergeFoundryCanonicalModelParams, y as normalizeFoundryEndpoint } from "./shared-CffaaJWi.js";
import { t as prepareFoundryRuntimeAuth } from "./runtime-CmNep5sC.js";
import { n as entraIdAuthMethod, t as apiKeyAuthMethod } from "./auth-wqknvMPg.js";
//#region extensions/microsoft-foundry/provider.ts
const wrapOpenAIResponsesStreamFn = buildProviderStreamFamilyHooks("openai-responses-defaults").wrapStreamFn;
