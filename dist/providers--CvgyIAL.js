...
import { r as getCurrentPluginMetadataSnapshot, s as createPluginIdScopeSet } from "./current-plugin-metadata-snapshot-BQju0mzJ.js";
...
import { n as withBundledPluginVitestCompat } from "./bundled-compat-B3hvbtGQ.js";
...
function resolveOwningPluginIdsForCliBackend(params) {
	...
	const deduped = sortUniqueStrings((params.manifestRegistry ?? metadataSnapshot?.manifestRegistry ?? loadPluginMetadataSnapshot({
		config: params.config ?? {},
		workspaceDir: params.workspaceDir,
		env: params.env ?? process.env
...
//#endregion
export { resolveDiscoveredProviderPluginIds as a, resolveOwningPluginIdsForModelRef as c, resolveOwningPluginIdsForProviderRef as d, resolveProviderRefOwnership as f, resolveDiscoverableProviderOwnerPluginIds as i, resolveOwningPluginIdsForModelRefs as l, withBundledProviderVitestCompat as m, resolveBundledProviderCompatPluginIds as n, resolveEnabledProviderPluginIds as o, resolveUsageHookProviderPluginContracts as p, resolveCatalogHookProviderPluginIds as r, resolveExternalAuthProfileProviderPluginIds as s, resolveActivatableProviderOwnerPluginIds as t, resolveOwningPluginIdsForProvider as u };
