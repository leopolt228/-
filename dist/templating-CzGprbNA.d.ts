import { E as ReplyToMode, _ as DmScope } from "./types.base-DucQBSmL.js";
import { i as ReplyThreadingPolicy } from "./types-BBQnzy9U.js";
import { r as InputProvenance } from "./user-turn-transcript.types-CKMcFFg2.js";
import { l as MediaUnderstandingDecision, u as MediaUnderstandingOutput } from "./types-C8XeqxqU2.js";
...
type MsgContext = {
  ...
  MediaPaths?: string[];
  MediaUrls?: string[];
  MediaTypes?: string[]; /** Original message modality before transcription or other media normalization. */
  ...
  Sticker?: StickerContextMetadata; /** True when current-turn sticker media is present in MediaPaths. */
...
//#endregion
export { InboundEventKind as _, SupplementalContextFacts as a, CommandTurnKind as c, isExplicitCommandTurn as d, isNativeCommandTurn as f, PluginHookChannelSenderContext as g, PluginHookChannelContext as h, MsgContext as i, createCommandTurnContext as l, PluginHookChannelChatContext as m, InboundSourceModality as n, applyTemplate as o, isTextSlashCommandTurn as p, MentionSource as r, CommandTurnContext as s, FinalizedMsgContext as t, isAuthorizedTextSlashCommandTurn as u };