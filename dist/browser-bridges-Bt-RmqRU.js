...
import { o as asDateTimestampMs, y as parseStrictNonNegativeInteger } from "./number-coercion-Crk_c9KW.js";
...
import { o as PATH_ALIAS_POLICIES } from "./secure-temp-dir-D6Ou0J-U.js";
import { r as resolveRootPath } from "./root-path-D-mKQHrm.js";
...
import { c as isPlainCommandExitFailure, s as spawnCommand } from "./exec-Cb0CNQNz.js";
...
import { S as SANDBOX_COMMAND_MAX_BUFFER_BYTES } from "./constants-DE6YR1VD.js";
import { i as resolveSandboxConfigForAgent } from "./config-ZQnZeh2f.js";
import { t as buildDockerExecArgs } from "./bash-tools.shared-BoXDo33n.js";
...
import { n as runtimeSandboxSecretOwnerId, t as assertRuntimeSandboxSecretOwnerAvailable } from "./runtime-sandbox-secret-owner-Die5dFXH.js";
import { t as sanitizeEnvVars } from "./sanitize-env-vars-I5Vtt7ek.js";
import { D as isExistingWorkspaceSkillMountSource, O as resolveMaterializedSandboxSkillsWorkspaceDir, a as execDocker, i as ensureSandboxContainer, n as dockerContainerState, o as execDockerRaw, x as resolveSandboxAgentId } from "./docker-HvYVm0Rf.js";
import { t as parseSshTarget } from "./ssh-tunnel-C-thKf2B.js";
...
function assertSshSandboxSecretOwnerAvailable(params) {
	...
	const agentIndex = normalizedAgentId ? params.config.agents?.list?.findIndex((entry) => normalizeAgentId(entry?.id) === normalizedAgentId) : void 0;
	const unresolved = [];
	for (const key of SSH_SECRET_KEYS) {
		...
		if (!ref) continue;
		unresolved.push({
			path: usesAgentValue && agentIndex !== void 0 && agentIndex >= 0 ? `agents.list.${agentIndex}.sandbox.ssh.${key}` : `agents.defaults.sandbox.ssh.${key}`,
...
//#endregion
export { buildPinnedRenamePlan as A, parseSandboxStatMtimeMs as C, resolveWritableRenameTargetsForBridge as D, resolveWritableRenameTargets as E, dockerSandboxBackendManager as M, runDockerSandboxShellCommand as N, buildPinnedMkdirpPlan as O, createRemoteShellSandboxFsBridge as S, createWritableRenameTargetResolver as T, disposeSshSandboxSession as _, getSandboxBackendFactory as a, uploadDirectoryToSshTarget as b, registerSandboxBackend as c, buildRemoteCommand as d, buildRemoteWorkdirValidationCommand as f, createSshSandboxSessionFromSettings as g, createSshSandboxSessionFromConfigText as h, startBrowserBridgeServer as i, buildPinnedWritePlan as j, buildPinnedRemovePlan as k, requireSandboxBackendFactory as l, buildValidatedExecRemoteCommand as m, stopCachedBrowserBridge as n, getSandboxBackendManager as o, buildSshSandboxArgv as p, stopCachedBrowserBridgesForContainer as r, getSandboxBackendWorkdirResolver as s, BROWSER_BRIDGES as t, buildExecRemoteCommand as u, runSshSandboxCommand as v, parseSandboxStatSize as w, assertSshSandboxSecretOwnerAvailable as x, shellEscape as y };
