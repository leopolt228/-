...
import { i as readRegularFileSync, r as readRegularFile } from "./regular-file-D9KgyI-A.js";
import "./regular-file-B0eXpnA9.js";
import { i as DEFAULT_IDENTITY_FILENAME } from "./workspace-GYctLxSN.js";
...
function loadIdentityFromFile(identityPath) {
	try {
		const { buffer } = readRegularFileSync({
			filePath: fs.realpathSync(identityPath),
...
//#endregion
export { mergeIdentityMarkdownContent as a, loadAgentIdentityFromWorkspace as i, identityHasValues as n, normalizeIdentityForFile as o, loadAgentIdentityFromFile as r, sanitizeAgentIdentityLine as s, createAgentIdentityConfig as t };
