...
import { g as resolveIsNixMode, m as resolveGatewayPort } from "./paths-CHQRdQZ3.js";
import { a as isSystemdUnitActive, m as uninstallLegacySystemdUnits, w as readManagedServiceEnvKeysFromEnvironment } from "./systemd-iYtBw5_g.js";
...
import { n as inspectGatewayHeapLimit, t as formatGatewayHeapLimitReport } from "./gateway-heap-CaeyR8CS.js";
import { a as resolveSystemNodeInfo, r as renderSystemNodeWarning } from "./runtime-paths-HrqyQmEH.js";
...
import { i as readWindowsProcessArgsSync } from "./windows-port-pids-CPr8M1HP.js";
import { a as readEmbeddedGatewayToken, i as needsNodeRuntimeMigration, n as auditGatewayServiceConfig, t as SERVICE_AUDIT_CODES } from "./service-audit-7zro2961.js";
import { a as resolveGatewayService } from "./service-DSig-f_R.js";
import { a as readWindowsStartupFallbackRuntimeForUpdate } from "./schtasks-DfZtOELz.js";
import { i as renderGatewayServiceCleanupHints, n as findExtraGatewayServices } from "./inspect-P2j2IdTG.js";
import { t as note } from "./note-AoV1Tth-.js";
import { i as UPDATE_PARENT_ALLOWS_GATEWAY_SERVICE_REPAIR_ENV, r as UPDATE_PARENT_ALLOWS_GATEWAY_ACTIVATION_ENV } from "./update-phase-HdecdncY.js";
...
import { t as isDoctorUpdateRepairMode } from "./doctor-repair-mode-6rt_PviA.js";
...
const runLaunchctlQuietly = (args) => runExec("launchctl", args, { logOutput: false }).catch(() => void 0);
...
function detectGatewayRuntime(programArguments) {
	...
	if (first) {
		...
		if (base === "bun" || base === "bun.exe") return DEFAULT_GATEWAY_DAEMON_RUNTIME;
