...
import { f as filterBootstrapFilesForSession, g as loadWorkspaceBootstrapFiles, m as isWorkspaceSetupCompleted, n as DEFAULT_BOOTSTRAP_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME } from "./workspace-GYctLxSN.js";
import { t as readFileWindowFully } from "./file-read-DtMn74uz.js";
import { f as buildBootstrapContextFiles, g as resolveBootstrapTotalMaxChars, m as resolveBootstrapMaxChars } from "./embedded-agent-helpers-DDAtCAER.js";
import { r as getOrLoadBootstrapFiles } from "./bootstrap-cache-jBNycri6.js";
import { n as shouldIncludeHeartbeatGuidanceForSystemPrompt } from "./heartbeat-system-prompt-CUmVlM-V.js";
...
async function hasCompletedBootstrapTurn(sessionFile) {
	if (parseSqliteSessionFileMarker(sessionFile)) return false;
	try {
