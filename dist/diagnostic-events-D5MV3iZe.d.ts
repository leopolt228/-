...
import { t as EmbeddedAgentExecutionPhase } from "./execution-phase-D2qCZ-pC.js";
...
type DiagnosticModelCallBaseEvent = DiagnosticBaseEvent & {
  ...
  model: string;
  api?: string;
  transport?: string; /** Defaults to request for emitters created before turn-level CLI diagnostics. */
