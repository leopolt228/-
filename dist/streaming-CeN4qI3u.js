...
function resolveChannelStreamingProgressNarration(entry, defaultValue = true) {
	return asBoolean(asObjectRecord(getChannelStreamingConfigObject(entry)?.progress)?.narration) ?? defaultValue;
}
...
//#endregion
export { resolveTranscriptBackedChannelFinalText as A, resolveChannelProgressDraftRender as C, resolveChannelStreamingProgressCommentary as D, resolveChannelStreamingPreviewToolProgress as E, resolveChannelStreamingPreviewChunk as F, formatToolAggregate as I, resolveChannelStreamingBlockCoalesce as M, resolveChannelStreamingBlockEnabled as N, resolveChannelStreamingProgressNarration as O, resolveChannelStreamingChunkMode as P, resolveChannelProgressDraftMaxLines as S, resolveChannelStreamingPreviewCommandText as T, resolveChannelPreviewStreamMode as _, createChannelProgressDraftGate as a, resolveChannelProgressDraftLineOptions as b, formatChannelProgressDraftText as c, isChannelProgressDraftWorkToolName as d, isCommandToolName as f, normalizeChannelProgressDraftLineIdentity as g, normalizeAgentPlanSteps as h, buildChannelProgressDraftLineForEntry as i, selectLongerFinalText as j, resolveChannelStreamingSuppressDefaultToolProgressMessages as k, formatPlanChecklistLines as l, mergeChannelProgressDraftLine as m, DEFAULT_PROGRESS_DRAFT_LABELS as n, formatChannelProgressDraftLine as o, isPotentialTruncatedFinal as p, buildChannelProgressDraftLine as r, formatChannelProgressDraftLineForEntry as s, DEFAULT_PROGRESS_DRAFT_INITIAL_DELAY_MS as t, getChannelStreamingConfigObject as u, resolveChannelProgressDraftConfig as v, resolveChannelStreamingNativeTransport as w, resolveChannelProgressDraftMaxLineChars as x, resolveChannelProgressDraftLabel as y };
