...
import { m as resolveGatewayPort, t as CONFIG_PATH } from "./paths-CHQRdQZ3.js";
...
import { r as isNonFatalSystemdInstallProbeError } from "./systemd-iYtBw5_g.js";
import { d as isValidEnvSecretRefId, l as isSecretRef } from "./types.secrets-BgE_Zq2x.js";
import { n as gatewayInstallErrorHint, t as buildGatewayInstallPlan } from "./daemon-install-helpers-C3ONqsD6.js";
...
import { o as resolvePluginContributionOwners } from "./plugin-registry-2gpKUE2T.js";
...
import { a as findTailscaleBinary } from "./tailscale-Cp_PZy81.js";
import { Q as ConfigMutationConflictError, b as createConfigIO, d as readConfigFileSnapshotForWrite, r as getRuntimeConfig } from "./io-CEgS2K9F.js";
import "./config-BOMcY2yX.js";
import { t as randomToken } from "./random-token-B1woZa_H.js";
import { a as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-DSig-f_R.js";
import { o as formatPortRangeHint } from "./error-format-CG7mpTEd.js";
...
import { t as formatWindowsGatewayFirewallGuidance } from "./windows-gateway-firewall-diagnostics-BCnkZqh7.js";
...
import { t as describeCodexNativeWebSearch } from "./codex-native-web-search.shared-B05R7NdW.js";
import { r as withProgress } from "./progress-DY8jzvl0.js";
import { t as note } from "./note-AoV1Tth-.js";
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-BvBARucQ.js";
...
import { f as probeGatewayReachable, g as waitForGatewayReachable, h as validateGatewayPasswordInput, i as ensureWorkspaceAndSessions, l as normalizeGatewayTokenInput, n as applyWizardMetadata, o as guardCancel, p as summarizeExistingConfig, t as DEFAULT_WORKSPACE } from "./onboard-helpers-p2UlKv8D.js";
import { a as outro, c as select, i as intro, l as text, n as CONFIGURE_WIZARD_SECTIONS, o as parseConfigureWizardSections, r as confirm, s as password, t as CONFIGURE_SECTION_OPTIONS } from "./configure.shared-BaORZxEM.js";
import { n as promptAuthChoiceGrouped } from "./auth-choice-prompt-CSNY9M1E.js";
import { i as applyAuthChoice } from "./auth-choice-BBn4BJ8I.js";
...
import { t as mergeWizardConfigOntoLatest } from "./setup.shared-Ce40z7aq.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-CD9fZofX.js";
import { t as loadStaticManifestCatalogRowsForList } from "./list.manifest-catalog-DxWv4POS.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-BFXolISz.js";
import { t as applyPrimaryModel } from "./provider-model-primary-DroEB3g9.js";
import { t as promptCustomApiConfig } from "./onboard-custom-B1EvBYyW.js";
import { a as validateDottedDecimalIPv4Input, i as maybeAddTailnetOriginToControlUiAllowedOrigins, n as TAILSCALE_EXPOSURE_OPTIONS, r as TAILSCALE_MISSING_BIN_NOTE_LINES, t as TAILSCALE_DOCS_LINES } from "./gateway-config-prompts.shared-D3kRU0gr.js";
import { r as formatHealthCheckFailure } from "./health-format-BOxwbAXX.js";
import { c as healthCommand } from "./health-CaAr8BUY.js";
import { t as promptRemoteGatewayConfig } from "./onboard-remote-t2OJrU63.js";
import { t as setupSkills } from "./onboard-skills-16lDAqYx.js";
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-CWruhPTp.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-Bsl1yKMz.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-D3ZkmVA9.js");
