...
import { c as moveSingleAccountChannelSectionToDefaultAccount, l as patchScopedAccountConfig } from "./setup-helpers-mUFOk9iT.js";
...
*/
const loadProviderAuthInput = createLazyRuntimeModule(() => import("./provider-auth-ref-CuV3ID3h.js"));
function asRecord(value) {
	return value != null && typeof value === "object" && !Array.isArray(value) ? value : void 0;
}
function asAllowFromList(value) {
	return Array.isArray(value) ? value.filter((entry) => typeof entry === "string" || typeof entry === "number") : void 0;
}
...
function setChannelDmPolicyWithAllowFrom(params) {
	...
	const allowFrom = dmPolicy === "open" ? addWildcardAllowFrom(asAllowFromList(channelConfig?.allowFrom)) : void 0;
	return {
		...cfg,
		channels: {
			...cfg.channels,
