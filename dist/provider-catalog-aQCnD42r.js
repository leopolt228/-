...
const MODEL_IMAGE_INPUT_OVERRIDES = /* @__PURE__ */ new Map([["hy3-free", false], ["minimax-m3", true]]);
const MODEL_COSTS = {
...
function resolveMaxTokens(modelId) {
	const lower = modelId.toLowerCase();
	const limits = MODEL_LIMITS[lower];
	if (limits) return limits.maxTokens;
...
function buildOpencodeZenModel(modelId) {
	...
	return normalizeModelCompat({
		...
		compat: {
			...
			...GPT_56_MODEL_IDS.has(normalizedModelId) ? { supportedReasoningEfforts: GPT_56_REASONING_EFFORTS } : {},
