...
import { a as listExplicitConfiguredChannelIdsForConfig, r as listConfiguredAnnounceChannelIdsForConfig } from "./channel-presence-policy-ClfxdhHd.js";
...
import { t as resolveMissingOfficialExternalChannelPluginRepairHint } from "./official-external-plugin-repair-hints-DvYibrHg.js";
import { n as listReadOnlyChannelPluginsForConfig } from "./read-only-CTGMGkDz.js";
import { s as getConfiguredChannelsCommandSecretTargetIds } from "./command-secret-targets-CztQ0pHm.js";
import { r as withProgress } from "./progress-DY8jzvl0.js";
import { n as formatTimeAgo } from "./format-relative-Bjc3l98W.js";
import { n as hasConfiguredUnavailableCredentialStatus, r as hasResolvedCredentialValue } from "./account-snapshot-fields-B8TED5XR.js";
...
import { n as requireValidConfigSnapshot } from "./config-validation-DcM5CtVz.js";
import { a as buildChannelAccountLine, i as appendTokenSourceBits, n as appendEnabledConfiguredLinkedBits, r as appendModeBit, t as appendBaseUrlBit } from "./shared-KI2AbCBl.js";
import { r as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-WPmW9MjC.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-DXTi1s80.js";
...
async function formatConfigChannelsStatusLines(cfg, meta, opts) {
	...
	const missingHints = [];
	const missingChannelIds = [.../* @__PURE__ */ new Set([...listExplicitConfiguredChannelIdsForConfig(sourceConfig), ...listExplicitConfiguredChannelIdsForConfig(cfg)])];
