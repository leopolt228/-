...
import { n as resolveMatrixAuth, r as resolveMatrixAuthContext } from "./config-CrspAanc.js";
...
const loadMatrixCreateClientDeps = createLazyRuntimeModule(() => import("./create-client-VbJfwqc5.js").then((runtime) => ({ createMatrixClient: runtime.createMatrixClient })));
