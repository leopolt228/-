...
import { c as callGateway, g as isGatewayTransportError } from "./call-ChM1o8yU.js";
...
import { i as serializeSessionCleanupResult, n as resolveSessionCleanupAction, r as runSessionsCleanup } from "./sessions-Uqhj6EXw.js";
import { t as resolveSessionStoreTargetsOrExit } from "./session-store-targets-DgEzxgN7.js";
import { c as resolveSessionDisplayModel, i as formatSessionModelCell, n as formatSessionFlagsCell, o as toSessionDisplayRows, r as formatSessionKeyCell, t as formatSessionAgeCell } from "./sessions-table-BNioeusD.js";
...
async function maybeRunGatewayCleanup(opts) {
	if (opts.store || opts.dryRun) return { delegated: false };
	try {
		return {
			delegated: true,
		...
		if (isGatewayTransportError(error)) return { delegated: false };
		throw error;
	}
}
