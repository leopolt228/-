...
import { n as pickBestEffortPrimaryLanIPv4 } from "./network-discovery-display-Ba7fpGaR.js";
import { n as resolveDarwinProductVersion } from "./os-summary--1-t8Sb6.js";
...
function initSelfPresence() {
	...
	const modelIdentifier = (() => {
		if (os.platform() === "darwin") {
			const out = normalizeOptionalString(spawnSync("sysctl", ["-n", "hw.model"], {
				encoding: "utf-8",
				timeout: 5e3,
				killSignal: "SIGKILL"
			}).stdout) ?? "";
