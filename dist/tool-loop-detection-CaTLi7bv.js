import { c as normalizeOptionalString, o as normalizeNullableString } from "./string-coerce-DW4mBlAt.js";
...
function hashToolOutcome(toolName, params, result, error) {
	...
	if (isLoopVetoResult(details)) return { resultHash: void 0 };
	if (toolName === "exec") {
	...
	if (isVolatileSendResult(toolName, params)) return { resultHash: digestStable(stripVolatileSendIds(details)) };
