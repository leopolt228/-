...
import { i as readMissingScopeError } from "./gateway-error-details-CLDhuP4F.js";
...
async function probeGateway(opts) {
	...
	const deviceIdentity = await (async () => {
		try {
			...
			const { loadDeviceIdentityIfPresent } = await import("./device-identity-CnUJQ-2R.js");
...
//#endregion
export { clampProbeTimeoutMs as n, probeGateway as r, MAX_TIMER_DELAY_MS as t };
