...
import { h as resolveIncludeRoots, l as resolveConfigPath, m as resolveGatewayPort, x as resolveStateDir } from "./paths-CHQRdQZ3.js";
...
import { t as applyConfigEnvVars } from "./config-env-vars-9fUuyise.js";
...
import { c as resolveSafeTimeoutDelayMs, s as resolvePreauthHandshakeTimeoutMs } from "./timeouts-CThCRo6Z.js";
import { c as resolveConfigIncludes, o as readConfigIncludeFileWithGuards } from "./includes-BC9UdEVK.js";
import { i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES } from "./client-info-D4mGPeue.js";
import "./version-CwNT1gaY.js";
import { n as loadDeviceAuthToken, t as GatewayClient } from "./client-DpNJQtBd.js";
...
import { r as isGatewayConnectAssemblyError } from "./client-U9ekE9wL.js";
...
import { t as canSkipGatewayConfigLoad } from "./explicit-connection-policy-CqW0Yk6o.js";
import { a as isGatewayMethodClassified, s as resolveLeastPrivilegeOperatorScopesForMethod, t as CLI_DEFAULT_OPERATOR_SCOPES } from "./method-scopes-DN3UnWnt.js";
...
async function readGatewayDispatchConfigWithShellEnvFallback(options = {}) {
	...
	const { loadShellEnvFallback, resolveShellEnvFallbackTimeoutMs, shouldDeferShellEnvFallback, shouldEnableShellEnvFallback } = await import("./shell-env-C7hkMq_E.js");
...
const defaultGetRuntimeConfig = async () => (await import("./io-BBSFa0i7.js")).getRuntimeConfig();
...
function resolveGatewayCallTimeout(timeoutValue) {
	const resolvedHandshakeTimeoutMs = Boolean(process.env.OPENCLAW_HANDSHAKE_TIMEOUT_MS) || Boolean(process.env.VITEST && process.env.OPENCLAW_TEST_HANDSHAKE_TIMEOUT_MS) ? resolvePreauthHandshakeTimeoutMs() : void 0;
...
async function resolveGatewayCallContext(opts) {
	...
	const envUrlOverride = cliUrlOverride || opts.localPortOverride !== void 0 || opts.ignoreEnvUrlOverride === true ? void 0 : trimToUndefined(process.env.OPENCLAW_GATEWAY_URL);
