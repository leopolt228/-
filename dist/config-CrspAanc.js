...
import { k as resolveOptionalIntegerOption } from "./number-coercion-Crk_c9KW.js";
import { r as formatErrorMessage } from "./errors-DdbcjW1Y.js";
import { f as normalizeResolvedSecretInputString, s as coerceSecretRef } from "./types.secrets-BgE_Zq2x.js";
...
import { o as isPrivateNetworkOptInEnabled, u as ssrfPolicyFromDangerouslyAllowPrivateNetwork } from "./ssrf-policy-BcGHIF9t.js";
import "./ssrf-runtime-b7ye-Z-7.js";
import "./retry-runtime-DSaAoazp.js";
import "./secret-input-runtime-M5BWQSoK.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-3-NMS7QW.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-DmaJQ3mO.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-S8LQ1GOC.js";
import { i as resolveScopedMatrixEnvConfig, n as resolveGlobalMatrixEnvConfig } from "./env-auth-GBg-erEj.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-DZDSgSmi.js";
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-C_AgZBwW.js";
import { s as repairCurrentTokenStorageMetaDeviceId } from "./storage-q2RUGhkm.js";
//#region extensions/matrix/src/matrix/client/config.ts
const loadDefaultMatrixAuthClientDeps = createLazyRuntimeModule(() => Promise.all([import("./sdk-DRfOdZO_.js"), import("./logging-C1aKbN5X.js")]).then(([sdkModule, loggingModule]) => ({
...
const loadMatrixCredentialsReadDeps = createLazyRuntimeModule(() => import("./credentials-read-3Dv9buDN.js").then((credentialsReadModule) => ({
...
const loadMatrixSecretInputDeps = createLazyRuntimeModule(() => import("./config-secret-input.runtime.js").then((runtime) => ({ resolveConfiguredSecretInputString: runtime.resolveConfiguredSecretInputString })));
