...
import { C as resolveExpiresAtMsFromDurationMs, O as resolveNonNegativeIntegerOption, P as timestampMsToIsoString, k as resolveOptionalIntegerOption, o as asDateTimestampMs } from "./number-coercion-Crk_c9KW.js";
...
import { M as isBunRuntime } from "./argv-D4LdWdQQ.js";
...
import { r as clampInt } from "./utils-K2PjeLaV.js";
...
import { H as resetConfigOverrides, I as validateConfigObjectWithPlugins, U as setConfigOverride, V as getConfigOverrides, W as unsetConfigOverride, d as readConfigFileSnapshotForWrite, l as readConfigFileSnapshot } from "./io-CEgS2K9F.js";
...
import { d as resolveEffectiveResponseUsage, i as isSessionDefaultDirectiveValue, l as normalizeUsageDisplay } from "./thinking.shared-BWnbgBUO.js";
import { i as unsetConfigValueAtPath, n as parseConfigPath, r as setConfigValueAtPath, t as getConfigValueAtPath } from "./config-paths-DEsSO_sF.js";
...
import { a as transformConfigFileWithRetry } from "./config-BOMcY2yX.js";
import { n as isRestartEnabled, t as isCommandFlagEnabled } from "./commands.flags-CZ7fp5Xb.js";
import { d as scheduleGatewaySigusr1Restart, m as triggerOpenClawRestart } from "./restart-B84EHBne.js";
...
import { n as getActivePluginChannelRegistry } from "./runtime-BapEso0o.js";
import { i as resolveSessionFilePathOptions, n as resolveDefaultSessionStorePath, r as resolveSessionFilePath } from "./paths-BpMRJ7TJ.js";
import { O as loadTranscriptEvents, St as patchSessionEntry, et as updateSessionEntry, it as applySessionPatchProjection, yt as loadSessionEntry } from "./session-accessor-Mu3lv_Tl.js";
...
import { n as resolveChannelApprovalCapability, t as resolveChannelApprovalAdapter } from "./plugins-CJcRWm9n.js";
...
import { i as normalizeStoreSessionKey, o as resolveSessionStoreEntry } from "./store-entry-Z-CrJCro.js";
...
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-DNTxgxrx.js";
...
import { a as formatEmbeddedAgentQueueFailureSummary, h as queueEmbeddedAgentMessageWithOutcomeAsync, l as isEmbeddedAgentRunActive, v as resolveActiveEmbeddedRunSessionIdBySessionFile } from "./runs-DDczt14d.js";
...
import { r as readLatestAssistantTextFromSessionTranscript } from "./transcript-vdi-rYV7.js";
import { n as estimateTokensFromChars } from "./cjk-chars-0PtNN_-l.js";
import { x as readSessionMessages } from "./session-transcript-readers-DSb8L-vG.js";
...
import { r as deriveSessionTitle } from "./session-utils-CEU0rCPC.js";
import { n as formatUsd } from "./usage-format-eg_0FVCW.js";
import { o as resolveReplyToMode } from "./reply-threading-BP15SwF-.js";
import { g as resolveBootstrapTotalMaxChars, m as resolveBootstrapMaxChars } from "./embedded-agent-helpers-DDAtCAER.js";
import { a as revokeMessageActionTurnCapability, n as mintMessageActionTurnCapability, t as isTrustedMessageActionTurnIngress } from "./message-action-turn-capability-BcyILfBH.js";
import { c as getSession, s as getFinishedSession } from "./bash-process-registry-BrIqJ2bV.js";
import { a as formatDoctorNonInteractiveHint, f as writeRestartSentinel, n as clearRestartSentinel, t as buildRestartSuccessContinuation } from "./restart-sentinel-C6N0OP2Z.js";
import { t as resolveConversationCapabilityProfile } from "./conversation-capability-profile-Ca0Rl8YJ.js";
import { S as isRealConversationMessage, X as estimateMessageCharsCached, Y as createMessageCharEstimateCache, n as agentHarnessExposesOpenClawTools, o as selectAgentHarness } from "./selection-6xddiFwm.js";
import { l as parseSessionLabel } from "./openclaw-tools-U0Zy3sfO.js";
...
import { n as routeReply } from "./route-reply-C22ve4in.js";
import { t as clearSessionQueues } from "./cleanup-l49uocqk.js";
import "./queue-DE1Ps1CK.js";
import { _ as authorizeConfigWriteShared, b as resolveConfigWriteTargetFromPathShared, v as canBypassConfigWritePolicyShared, x as resolveExplicitConfigWriteTargetShared, y as formatConfigWriteDeniedMessageShared } from "./channel-config-helpers-BFvX3ldW.js";
import { l as supportsModelTools } from "./openai-transport-stream-810ZIbd4.js";
import { t as formatThreadBindingDurationLabel } from "./thread-bindings-messages-C6JmokKM.js";
import { C as setTtsPersona, S as setTtsMaxLength, i as isTtsProviderConfigured, m as textToSpeech, n as getResolvedSpeechProviderConfig, r as getTtsProvider, t as getLastTtsAttempt, u as setLastTtsAttempt, w as setTtsProvider, x as setTtsEnabled, y as setSummarizationEnabled } from "./runtime-api-IUluPrEw.js";
import { a as getTtsMaxLength, c as isSummarizationEnabled, g as resolveTtsConfig, l as isTtsEnabled, o as getTtsPersona, u as listTtsPersonas, v as resolveTtsPrefsPath } from "./tts-settings-Cunm4eSy.js";
...
import { n as redactConfigObject, r as redactConfigSnapshot, t as REDACTED_SENTINEL } from "./redact-snapshot-DpSfGa7F.js";
import { t as buildSystemPromptReport } from "./system-prompt-report-CapjNIt7.js";
import { n as classifyCompactionReason } from "./compact-reasons-CZXtIq5M.js";
import { o as sessionSnapshotChangesApplied } from "./session-snapshot-merge-BPS3tTmG.js";
import { o as markCommandSessionMetadataChanged, r as handleGoalCommand } from "./commands-goal-CaX8R908.js";
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-CMd6aPMt.js";
import "./commands-registry-D0-Z0N5x.js";
import { a as requireGatewayClientScope, i as requireCommandFlagEnabled, n as rejectNonOwnerCommand, r as rejectUnauthorizedCommand, t as buildDisabledCommandReply } from "./command-gates-BNLc0dZV.js";
...
import { n as formatAbortReplyText, r as stopSubagentsForRequester, t as abortSessionRunTargetWithOutcome } from "./abort-DzzisG6C.js";
...
import { i as readChannelAllowFromStore, o as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-BaZlMduS.js";
...
import { t as handleSystemAgentCommand } from "./commands-system-agent-DaHxprko.js";
import { n as resolveSkillWorkshopToolPolicyAvailability } from "./tool-policy-diagnostic-Cu8WS8cw.js";
import { r as isImplicitSameChatApprovalAuthorization } from "./approval-auth-helpers-BtEiGp-a.js";
...
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-DkgzNQVX.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-NEGDPxR4.js";
import { i as resolveSkillCommandInvocation, t as listSkillCommandsForAgents } from "./chat-commands-DGIUwBOP.js";
import { t as persistReplySessionEntry } from "./session-entry-persistence-JT1j-eUU.js";
import { n as resolveEffectiveToolInventory, t as resolveConfiguredModelCompat } from "./tools-effective-inventory-l7p1c1wA.js";
import { t as extractBtwQuestion } from "./btw-command-C6g5atyM.js";
import { r as handleModelsCommand } from "./commands-models-Bh4BJhd9.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-CAzh-jlU.js";
import { t as codexChannelLoginRuntime } from "./provider-auth-login-flow-runtime-Dg8yGzVB.js";
import { r as createExecTool } from "./bash-tools-D-sycFwf.js";
import { t as runBtwSideQuestion } from "./btw-82vhu4sS.js";
import { a as loadSessionCostSummary, n as loadCostUsageSummary } from "./session-cost-usage-BUCC0ilC.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-abMWv5te.js";
import { C as stopWithText$1, b as resolveAcpAction, d as COMMAND, x as resolveAcpHelpText } from "./shared-CyF5p6RF.js";
import { a as resolveHandledPrefix, c as resolveSubagentsAction, l as stopWithText$2, o as resolveRequesterSessionKey } from "./shared-QXRMmDUm.js";
import { t as buildToolsMessage } from "./status-B2xTpc_H.js";
import { n as resolveCommandSurfaceChannel, t as resolveChannelAccountId } from "./channel-context-CCYhAMy-.js";
...
import { n as setConfiguredMcpServer, o as parseConfigValue, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-BQjQsfx6.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-tv-JW3As.js";
import { n as buildStatusReply, t as buildStatusPluginsReply } from "./commands-status-uGlhRIFX.js";
import { n as refreshPluginRegistryAfterConfigMutation } from "./registry-refresh-B0V27wfG.js";
import { a as buildPluginDiagnosticsReport, c as formatPluginCompatibilityNotice, o as buildPluginInspectReport, t as buildAllPluginInspectReports } from "./status-Byf7l36b.js";
...
import { n as buildNpmInstallRecordFields, t as installBundledPluginSource } from "./bundled-install-EsOb40hN.js";
import { i as installPluginFromNpmPackArchive, n as installPluginFromPath, r as installPluginFromNpmSpec } from "./install-CCEI5eu6.js";
import { t as resolveBundledInstallPlanBeforeNpm } from "./plugin-install-plan-DbLkCjKz.js";
import { l as resolveFileNpmSpecToLocalPath, n as createPluginInstallLogger, s as parseNpmPackPrefixPath } from "./plugins-command-helpers-BOQCM7Yl.js";
...
const lifecycleHandlersLoader = createLazyImportLoader(() => import("./lifecycle-BBxSOH0c.js"));
const runtimeOptionHandlersLoader = createLazyImportLoader(() => import("./runtime-options-BYx6ubEM.js"));
const diagnosticHandlersLoader = createLazyImportLoader(() => import("./diagnostics-J_XkA_B_.js"));
...
const handleAllowlistCommand = async (params, allowTextCommands) => {
	...
	if (parsed.scope === "group" && parsed.target === "store") return {
		shouldContinue: false,
		reply: { text: "⚠️ Pairing-store allowlist edits apply to DMs only; omit --store for groups." }
	};
	...
	return {
		shouldContinue: false,
		reply: { text: `✅ ${parsed.scope === "group" ? "group" : "DM"} allowlist ${actionLabel} in pairing store.` }
	};
};
//#endregion
...
async function handleBashChatCommand(params) {
	...
	if (request.action === "stop") {
		...
		const { killProcessTree } = await import("./kill-tree-Dd2D7WYi.js");
		killProcessTree(pid);
...
const handleCompactCommand = async (params) => {
	...
	if (runtime.isEmbeddedAgentRunAbortableForCompaction(sessionId)) {
		...
		if (!await runtime.waitForEmbeddedAgentRunEnd(sessionId, 15e3)) return {
			shouldContinue: false,
			reply: {
	...
	const result = await runtime.compactEmbeddedAgentSession({
		...
		authProfileIdSource: targetSessionEntry.authProfileOverrideSource ?? (targetSessionEntry.authProfileOverride ? typeof targetSessionEntry.authProfileOverrideCompactionCount === "number" ? "auto" : "user" : void 0),
		contextTokenBudget,
		agentHarnessId: targetSessionEntry.modelSelectionLocked === true ? resolvePersistedSessionRuntimeId(targetSessionEntry) : targetSessionEntry.agentHarnessId,
	...
	const totalTokens = result.ok && result.compacted ? tokensAfterCompaction : runtime.resolveFreshSessionTotalTokens(targetSessionEntry);
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-DKco_DPC.js");
...
async function buildContextReply(params) {
	...
	if (sub === "map") {
		...
		const sessionId = targetSessionEntry?.sessionId?.trim();
		const messages = sessionId ? readSessionMessages(sessionId, params.storePath, targetSessionEntry?.sessionFile) : [];
...
function applyLearnPromptToContext(ctx, instruction) {
...
function applyLearnPrompt(params, instruction) {
	applyLearnPromptToContext(params.ctx, instruction);
	if (params.rootCtx && params.rootCtx !== params.ctx) applyLearnPromptToContext(params.rootCtx, instruction);
...
const handleLearnCommand = async (params, allowTextCommands) => {
	if (!allowTextCommands) return null;
	...
	if (unauthorized) return unauthorized;
	if (!workshopIsAvailable(params)) return unavailableReply();
...
const activeCodexLoginFlows = /* @__PURE__ */ new Map();
...
function redactMcpServersForDisplay(servers) {
	return redactConfigObject({ mcp: { servers: Object.fromEntries(Object.entries(servers).map(([name, server]) => [name, redactMcpServerArgsForDisplay(server)])) } }, buildConfigSchema().uiHints).mcp?.servers ?? {};
}
...
async function resolvePrivateMcpTargetsForCommand(params) {
	return await resolvePrivateCommandRouteTargets({
		commandParams: params,
...
async function deliverGroupMcpShowReplyPrivately(deps, params, name) {
	...
	for (const target of targets) if (await deps.deliverPrivateMcpReply({
		commandParams: params,
		targets: [target],
		reply: privateReply
	})) return {
...
function createMcpCommandHandler(deps = {}) {
	const resolvedDeps = {
	...
	return async (params, allowTextCommands) => {
		...
		if (mcpCommand.action === "show") {
			if (params.isGroup) return await deliverGroupMcpShowReplyPrivately(resolvedDeps, params, mcpCommand.name);
			return {
				shouldContinue: false,
...
const handleMcpCommand = createMcpCommandHandler();
//#endregion
...
const handleNameCommand = async (params, allowTextCommands) => {
	...
	const result = await applySessionPatchProjection({
		...
		project: ({ entries, existingEntry }) => {
			...
			for (const other of entries) if (other.sessionKey !== sessionKey && other.entry.label === validated.label) return {
				ok: false,
...
async function installPluginFromPluginsCommand(params) {
	...
	if (fs.existsSync(resolved)) {
		...
		const acknowledgement = (source === "path" ? findBundledPluginSource({ lookup: {
			kind: "localPath",
			value: resolved
		} }) : void 0) ? null : resolveNonClawHubChatInstallAcknowledgement({
			force: params.force,
	...
	if (npmPackPath !== null) {
		...
		return {
			ok: true,
			pluginId: result.pluginId,
			warnings: [acknowledgement.warning]
		};
	}
	...
	const npmSpec = params.raw.trim().toLowerCase().startsWith("npm:") ? params.raw.trim().slice(4) : params.raw;
	const bundledPlan = params.raw.trim().toLowerCase().startsWith("npm:") ? null : resolveBundledInstallPlanBeforeNpm({
		rawSpec: params.raw,
	...
	const arbitraryNpmAcknowledgement = !trustedNpmInstall && !officialIdPlan ? resolveNonClawHubChatInstallAcknowledgement({
		force: params.force,
		sourceClass: "npm",
		spec: params.raw
	}) : null;
	if (arbitraryNpmAcknowledgement && !arbitraryNpmAcknowledgement.ok) return arbitraryNpmAcknowledgement;
	...
	const expectedIntegrity = trustedNpmInstall?.expectedIntegrity ?? officialIdPlan?.expectedIntegrity;
...
const handleStopCommand = async (params, allowTextCommands) => {
	...
	return {
		shouldContinue: false,
		reply: { text: formatAbortReplyText(stopped, abortOutcome.active && !abortOutcome.aborted ? "finalizing" : void 0) }
	};
};
...
function resolveSteerSessionId(params) {
	...
	for (const candidateKey of candidateKeys) {
		const sessionFile = normalizeOptionalString(resolveStoredSessionEntry(params.commandParams, candidateKey)?.sessionFile);
...
const actionAgentsLoader = createLazyImportLoader(() => import("./action-agents-DP8VZXQQ.js"));
const actionFocusLoader = createLazyImportLoader(() => import("./action-focus-C5C3-t7d.js"));
const actionHelpLoader = createLazyImportLoader(() => import("./action-help-BP-95SFr.js"));
const actionInfoLoader = createLazyImportLoader(() => import("./action-info-CewxdSMo.js"));
const actionListLoader = createLazyImportLoader(() => import("./action-list-BEvx_IKD.js"));
const actionLogLoader = createLazyImportLoader(() => import("./action-log-C7O7szVW.js"));
const actionUnfocusLoader = createLazyImportLoader(() => import("./action-unfocus-DxtusNY4.js"));
...
const handleSubagentsCommand = async (params, allowTextCommands) => {
	...
	if (!requesterKey) return stopWithText$2("⚠️ Missing session key.");
	const ctx = {
		params,
		handledPrefix,
		requesterKey,
...
async function handleTtsChatAction(params, args) {
	...
	if (!params.sessionEntry || !params.sessionStore || !params.sessionKey) return stopWithText("🔇 No active chat session is available for a chat-scoped TTS override.");
	if (!requested || requested === "status") return stopWithText(`🔊 Chat TTS override: ${params.sessionEntry.ttsAuto ?? "default"}.`);
	let replyText;
	if (requested === "on") {
...
async function handleTtsLatestAction(params, accountId, prefsPath) {
	if (!params.sessionEntry || !params.sessionStore || !params.sessionKey) return stopWithText("🎤 No active chat session is available for `/tts latest`.");
	const latestText = (await readLatestAssistantTextFromSessionTranscript(params.sessionEntry.sessionFile))?.text.trim();
	if (!latestText || isSilentReplyPayloadText(latestText)) return stopWithText("🎤 No readable assistant reply was found in this chat yet.");
	const hash = hashTtsReadLatestText(latestText);
	if (params.sessionEntry.lastTtsReadLatestHash === hash) return stopWithText("🔊 Latest assistant reply was already sent as audio.");
	...
	if ("error" in audio) return stopWithText(`❌ Error generating audio: ${audio.error}`);
...
const handleTtsCommands = async (params, allowTextCommands) => {
	...
	if (action === "audio") {
		if (!args) return stopWithText("🎤 Generate audio from text.\n\nUsage: /tts audio <text>\nExample: /tts audio Hello, this is a test!");
		const audio = await buildTtsAudioReply({
			text: args,
			cfg: params.cfg,
			channel: params.command.channel,
	...
	if (action === "persona") {
		...
		if (!persona) return stopWithText(`❌ Unknown TTS persona: ${requested || args}.\nUse /tts persona to list configured personas.`);
		setTtsPersona(prefsPath, persona.id);
		return stopWithText(`✅ TTS persona set to ${persona.id}.`);
	}
	if (action === "limit") {
		if (!args) return stopWithText(`📏 TTS limit: ${getTtsMaxLength(prefsPath)} characters.\n\nText longer than this triggers summary (if enabled).\nRange: 100-4096 chars (Telegram max).\n\nTo change: /tts limit <number>\nExample: /tts limit 2000`);
		const next = /^\d+$/.test(args) ? Number(args) : NaN;
		if (!Number.isSafeInteger(next) || next < 100 || next > 4096) return stopWithText("❌ Limit must be between 100 and 4096 characters.");
	...
	if (action === "summary") {
		...
		return stopWithText(requested === "on" ? "✅ TTS auto-summary enabled." : "❌ TTS auto-summary disabled.");
	}
