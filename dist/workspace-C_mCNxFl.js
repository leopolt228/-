...
import { i as resolveOpenClawMetadata, n as resolveHookInvocationPolicy, t as parseFrontmatter } from "./frontmatter-BCE8gS7_.js";
import { o as resolveHookEntries } from "./config-DHK8km67.js";
...
function readRootFileUtf8(params) {
	return withOpenedRootFileSync(params, (opened) => {
		try {
			...
			if (err instanceof RangeError) log.warn(`Ignoring oversized hook metadata ${params.absolutePath}: file exceeds the ${params.maxBytes}-byte limit`);
			return null;
		}
	});
}
...
//#endregion
export { isKnownInternalHookEventKey as n, loadWorkspaceHookEntries as t };
