...
import { d as buildOpenAICodexCredentialExtra, h as resolveOpenAICodexImportProfileName, m as resolveOpenAICodexAuthIdentity, p as resolveOpenAICodexAccessTokenExpiry } from "./provider-auth-Bnib2g6h.js";
...
import { n as readHermesCodexAuthCandidates, t as buildReauthenticationItems } from "./auth-source-CbiPqde_.js";
import { i as HERMES_REASON_CONFIG_RUNTIME_UNAVAILABLE, l as HERMES_REASON_SECRET_NO_LONGER_PRESENT, n as HERMES_REASON_AUTH_PROFILE_EXISTS, o as HERMES_REASON_INCLUDE_SECRETS, r as HERMES_REASON_AUTH_PROFILE_WRITE_FAILED, s as HERMES_REASON_MISSING_SECRET_METADATA } from "./items-zt6lbzBv.js";
...
function readProviderAuthModelConfigs(result) {
	...
	return { [readString(result.defaultModel) ?? OPENAI_CODEX_DEFAULT_MODEL]: {} };
}
