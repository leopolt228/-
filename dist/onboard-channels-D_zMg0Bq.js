...
import { t as isChannelConfigured } from "./channel-configured-B7FeK4Zz.js";
import { r as listChatChannels } from "./chat-meta-SinBir5u.js";
import { n as formatChannelSelectionLine, t as formatChannelPrimerLine } from "./registry-DiZXNr5-.js";
import { n as t, r as wizardT } from "./i18n-CX_FBkXY.js";
import { i as resolveChannelDefaultAccountId } from "./helpers-BzNF0htn.js";
import { a as resolveBundledPluginSources, n as findBundledPluginSourceInMap } from "./bundled-sources-VLkHE07m.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-mUFOk9iT.js";
import { B as runSingleChannelSecretStep, F as resolveAccountIdForConfigure, N as promptResolvedAllowFrom, Q as splitSetupEntries } from "./setup-wizard-helpers-BswN5Wen.js";
import { t as promptChannelAccessConfig } from "./setup-group-access-Dz4Z8Sy-.js";
import { n as listActiveChannelSetupPlugins, r as listChannelSetupPlugins, t as getChannelSetupPlugin } from "./setup-registry-8jbB3yLd.js";
import { n as loadChannelSetupPluginRegistrySnapshotForChannel, t as ensureChannelSetupPluginInstalled } from "./plugin-install-C_8LGlUY.js";
import { r as listTrustedChannelPluginCatalogEntries, t as getTrustedChannelPluginCatalogEntry } from "./trusted-catalog-Bvj6Qk_A.js";
import { i as shouldShowChannelInSetup, r as resolveChannelSetupEntries } from "./discovery-Ciz8C1UR.js";
import { n as runWizardWithPromptNavigationScope } from "./navigation-prompter-CL-8dE9t.js";
...
async function setupChannels(cfg, runtime, prompter, options) {
	...
	const ensureChannelSetupPluginInstalledWithNavigation$1 = async (install) => await ensureChannelSetupPluginInstalledWithNavigation({
		install,
		prompter,
		options
	});
	const handleChannelChoice = async (channel) => {
		...
		if (catalogEntry) {
			const workspaceDir = resolveWorkspaceDir();
			const installOutcome = await ensureChannelSetupPluginInstalledWithNavigation$1({
				cfg: next,
				entry: catalogEntry,
				runtime,
				workspaceDir,
