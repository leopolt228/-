...
import { C as resolveExpiresAtMsFromDurationMs, b as parseStrictPositiveInteger, o as asDateTimestampMs, v as parseStrictInteger, y as parseStrictNonNegativeInteger } from "./number-coercion-Crk_c9KW.js";
import { o as isRecord } from "./record-coerce-DHZ4bFlT.js";
import { n as normalizeAccountId } from "./account-id-C7N4Rwku.js";
import { r as logVerbose } from "./globals-DBBT7Ru5.js";
import { D as formatLocationText, m as resolveSendableOutboundReplyParts } from "./reply-payload-CPcXnHho.js";
import { _ as resolveChannelPreviewStreamMode } from "./streaming-CeN4qI3u.js";
import { n as firstDefined } from "./allow-from-o-cfFFcK.js";
import "./string-coerce-runtime-DBMkn-gE.js";
import "./number-runtime-C6TGSEc_.js";
import "./runtime-env-BDC_axp1.js";
import { f as tokenizeHtmlTags, i as markdownToIR, n as renderMarkdownWithMarkers } from "./tables-DsGSc7Wv.js";
import { r as renderMarkdownIRChunksWithinLimit } from "./chunk-items-Bwws2oGs.js";
...
import { i as normalizeAllowFrom, o as resolveTelegramEffectiveDmPolicy, r as isSenderAllowed, t as expandTelegramAllowFromWithAccessGroups } from "./access-groups-Dzcwa6se.js";
import { n as getTelegramRuntime, t as getOptionalTelegramRuntime } from "./runtime-D4cq5Nic2.js";
...
function markdownToTelegramHtml(markdown, options = {}) {
	...
	const telegramHtml = renderSupportedTelegramHtml(renderTelegramHtml(markdownToIR(preserveTelegramListBoundarySpacing(markdown ?? ""), {
		assistantTranscriptRoleHeaders: true,
		linkify: true,
		enableSpoilers: true,
		headingStyle: "none",
...
function normalizeMessageNodes(msg, params) {
	...
	const visit = (message, inheritedThreadId, mode, promptContextProjectionMarker) => {
		const node = normalizeMessageNode(message, {
			threadId: parseTelegramMessageThreadId(message.message_thread_id) ?? inheritedThreadId,
...
//#endregion
export { hasBotMentionInText as $, buildTelegramThreadParams as A, resolveTelegramForumThreadId as B, TelegramPairingStoreReadError as C, buildTelegramInboundOriginTarget as D, buildTelegramGroupPeerId as E, resetTelegramForumFlagCacheForTest as F, resolveTelegramThreadSpec as G, resolveTelegramMessageForumFlagHint as H, resolveTelegramBotHasTopicsEnabled as I, buildSenderLabel as J, shouldUseTelegramDmThreadSession as K, resolveTelegramCommandAuthorization as L, describeReplyTarget as M, extractTelegramForumFlag as N, buildTelegramParentPeer as O, isTelegramCommandsAllowFromConfigured as P, hasBotMention as Q, resolveTelegramDirectPeerId as R, withTelegramPromptContextSource as S, buildTelegramGroupFrom as T, resolveTelegramReplyId as U, resolveTelegramGroupAllowFromContext as V, resolveTelegramStreamMode as W, extractTelegramLocation as X, buildSenderName as Y, getTelegramTextParts as Z, createTelegramPromptContextProjectionCursor as _, parseTelegramMessageThreadId as _t, wasSentByBot as a, resolveTelegramRichMessageText as at, resolveTelegramPromptContextDeliverySignature as b, buildTelegramConversationContext as c, markdownToTelegramHtml as ct, isTelegramMessageCacheSourceMessage as d, splitTelegramHtmlChunks as dt, isBinaryContent as et, isTelegramMessageFromCurrentBot as f, telegramHtmlToPlainTextFallback as ft, resolveTelegramMessageCacheScope as g, normalizeTelegramReplyToMessageId as gt, resolveTelegramMessageCachePersistentScopeKey as h, resolveTelegramPreviewStreamMode as ht, recordSentMessage as i, resolveTelegramRichMessagePlaceholder as it, buildTypingThreadParams as j, buildTelegramRoutingTarget as k, buildTelegramReplyChain as l, markdownToTelegramHtmlChunks as lt, resolveTelegramMessageCachePath as m, decodeTelegramHtmlEntities as mt, TELEGRAM_SENT_MESSAGE_CACHE_NAMESPACE as n, renderTelegramTextEntities as nt, TELEGRAM_MESSAGE_CACHE_PERSISTENT_MAX_MESSAGES as o, escapeTelegramHtml as ot, isTelegramSessionBoundaryCommandText as p, wrapFileReferencesInHtml as pt, withResolvedTelegramForumFlag as q, listTelegramLegacySentMessageCacheEntries as r, resolveTelegramPrimaryMedia as rt, TELEGRAM_MESSAGE_CACHE_PERSISTENT_NAMESPACE as s, markdownToTelegramChunks as st, TELEGRAM_SENT_MESSAGE_CACHE_MAX_ENTRIES as t, normalizeForwardedContext as tt, createTelegramMessageCache as u, renderTelegramHtmlText as ut, createTelegramPromptContextProjectionSequence as v, parseTelegramReplyToMessageId as vt, buildGroupLabel as w, resolveTelegramPromptContextSource as x, resolveCompleteTelegramPromptContextProjectionIds as y, parseTelegramThreadId as yt, resolveTelegramForumFlag as z };
