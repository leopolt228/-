import { E as resolveExpiresAtMsFromEpochSeconds, T as resolveExpiresAtMsFromDurationSeconds, x as positiveSecondsToSafeMilliseconds } from "./number-coercion-Crk_c9KW.js";
...
import { u as toFormUrlEncoded } from "./provider-auth-Bnib2g6h.js";
...
import { t as xaiUserAgent } from "./xai-user-agent-CXkJy3kT.js";
...
function xaiOAuthFetchSignal(signal) {
...
async function loginXaiDeviceCode(ctx) {
	...
	try {
		const discovery = await fetchXaiDeviceCodeDiscovery(ctx.signal ? { signal: ctx.signal } : void 0);
