import { i as OpenClawConfig, ti as AccessGroupConfig } from "./types.openclaw-DAPZkTyD.js";
import { _ as ChannelImplicitMentionsConfig } from "./types.slack-DFzHb8bG.js";
import { t as ChatChannelId } from "./ids-BUiVO67E.js";
import { r as InboundMentionFacts, t as InboundImplicitMentionKind } from "./mention-gating-CZBkroRQ.js";
...
//#endregion
export { ChannelIngressIdentifierKind as C, IngressReasonCode as D, ChannelIngressStateInput as E, ResolvedChannelImplicitMentions as O, ChannelIngressEventInput as S, ChannelIngressState as T, ResolveStableChannelMessageIngressParams as _, ChannelIngressEventPresetInput as a, AccessGroupMembershipFact as b, ChannelIngressIdentityField as c, ChannelIngressResolverMessageParams as d, ChannelIngressRouteAccess as f, ResolveChannelMessageIngressParams as g, CreateChannelIngressResolverParams as h, ChannelIngressConfigInput as i, resolveChannelImplicitMentions as k, ChannelIngressIdentitySubjectInput as l, ChannelMessageIngressCommandInput as m, ChannelIngressCommandAccess as n, ChannelIngressIdentityAlias as o, ChannelIngressRouteDescriptor as p, ChannelIngressCommandPresetInput as r, ChannelIngressIdentityDescriptor as s, ChannelIngressAccessGroupMembershipResolver as t, ChannelIngressResolver as u, ResolvedChannelMessageIngress as v, ChannelIngressPolicyInput as w, ChannelIngressDecision as x, StableChannelIngressIdentityParams as y };