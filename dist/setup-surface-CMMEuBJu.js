...
import { J as setSetupChannelEnabled, Q as splitSetupEntries, f as createStandardChannelSetupStatus, g as createTopLevelChannelGroupPolicySetter, m as createTopLevelChannelDmPolicy, p as createTopLevelChannelAllowFromSetter, v as mergeAllowFromEntries } from "./setup-wizard-helpers-BswN5Wen.js";
import "./setup-BBJhG_GE.js";
import "./setup-tools-gU37uFTm.js";
import { g as hasConfiguredMSTeamsCredentials, v as resolveMSTeamsCredentials, y as saveDelegatedTokens } from "./graph-users-BOnBF_Ww.js";
import { f as resolveMSTeamsUserAllowlist, s as parseMSTeamsTeamEntry, u as resolveMSTeamsChannelAllowlist } from "./resolve-allowlist-BVqcCJzs.js";
import { r as formatUnknownError } from "./errors-B64kMCA6.js";
	...
	finalize: async (params) => {
		...
		if (finalCreds?.type === "secret") {
			if (await params.prompter.confirm({
				...
				let oauthModule;
				try {
					oauthModule = await import("./oauth-DDmtGbxp.js");
				} catch (err) {
