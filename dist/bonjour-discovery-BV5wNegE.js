...
import { t as isTailnetIPv4 } from "./tailnet-GjWC2Uzc.js";
...
function parseAvahiBrowse(stdout) {
	...
	for (const raw of stdout.split("\n")) {
		...
		if (trimmed.startsWith("txt =")) {
			const txt = parseTxtTokens(Array.from(trimmed.matchAll(/"([^"]*)"/g), (match) => expectDefined(match.at(1), "Bonjour TXT token")));
...
//#endregion
export { resolveGatewayDiscoveryEndpoint as n, discoverGatewayBeacons as t };
