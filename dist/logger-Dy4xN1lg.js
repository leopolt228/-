...
import { _ as readLoggingConfig, c as redactSensitiveText, i as redactSecrets, v as shouldSkipMutatingLoggingConfigRead } from "./redact-DNq_HeDt.js";
import { t as expandHomePrefix } from "./home-dir-DxrrpDft.js";
import { n as appendRegularFileSync } from "./regular-file-D9KgyI-A.js";
import "./regular-file-B0eXpnA9.js";
import { t as loggingState } from "./state-CZ7QadD1.js";
import { D as isValidDiagnosticSpanId, E as getActiveDiagnosticTraceContext, O as isValidDiagnosticTraceFlags, k as isValidDiagnosticTraceId, n as emitDiagnosticEvent, r as emitDiagnosticEventWithTrustedTraceContext } from "./diagnostic-events-Dt41CZkD.js";
...
const defaultHostnameResolver = () => os.hostname();
...
const testApi = {
	...
	setHostnameResolverForTests: (resolver) => {
...
//#endregion
export { resolveEnvLogLevelOverride as _, getResolvedLoggerSettings as a, normalizeLogLevel as b, setLoggerConfigLoaderForTests as c, toPinoLikeLogger as d, formatTimestamp as f, formatLocalDate as g, canUseNodeFs as h, getLogger as i, setLoggerOverride as l, LOG_SUFFIX as m, DEFAULT_LOG_FILE as n, isFileLogLevelEnabled as o, LOG_PREFIX as p, getChildLogger as r, resetLogger as s, DEFAULT_LOG_DIR as t, testApi as u, ALLOWED_LOG_LEVELS as v, tryParseLogLevel as x, levelToMinLevel as y };
