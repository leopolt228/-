...
import { a as validateSafeBinArgv, c as DEFAULT_SAFE_BINS, l as SAFE_BIN_PROFILES, n as isTrustedSafeBinPath } from "./exec-safe-bin-trust-BWRYCL4x.js";
import { c as resolveExecutableTrustPath, d as resolveExecutionTargetTrustPath, g as resolveExecWrapperTrustPlan, h as resolvePolicyTargetTrustPath, l as resolveExecutionTargetCandidatePath, m as resolvePolicyTargetResolution, p as resolvePolicyTargetCandidatePath, s as resolveCommandResolutionFromArgv, t as matchAllowlist, u as resolveExecutionTargetResolution } from "./exec-command-resolution-m9V5wfx_.js";
import { C as resolveDispatchWrapperTrustPlan, S as isDispatchWrapperExecutable, _ as isPowerShellInlineFileCommandFlag, b as resolvePowerShellInlineCommandMatch, c as isShellWrapperExecutable, f as POSIX_INLINE_COMMAND_FLAGS, g as isDirectShellPositionalCarrierCommand, h as hasPosixLoginStartupBeforeInlineCommand, j as normalizeExecutableToken, m as hasPosixInteractiveStartupBeforeInlineCommand, n as POWERSHELL_WRAPPERS, r as extractBindableShellWrapperInlineCommand, t as POSIX_SHELL_WRAPPERS, w as unwrapDispatchWrappersForResolution, y as resolveInlineCommandMatch } from "./shell-wrapper-resolution-DlXABXcG.js";
import "./exec-wrapper-resolution-CSf7MIn-.js";
import { a as detectInlineEvalArgv, l as isInterpreterLikeAllowlistPattern } from "./risks-BpC_U-rz.js";
import { t as explainShellCommand } from "./extract-okzlOi00.js";
import { a as isWindowsPlatform, i as analyzeWindowsShellCommand } from "./exec-approvals-analysis-eausQ51Q.js";
...
function shellWrapperPreludeReasons(params) {
	return uniqueStrings(params.risks.filter((risk) => UNANALYZABLE_RISKS.has(risk.kind) && riskBeforeStepExecutable(risk, params.step)).map((risk) => risk.kind));
}
