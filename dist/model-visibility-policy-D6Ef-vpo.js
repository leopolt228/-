...
import { a as createModelVisibilityPolicyWithFallbacks } from "./model-selection-shared-CPPxIJAX.js";
...
function createModelVisibilityPolicy(params) {
	return createModelVisibilityPolicyWithFallbacks({
		...
		additionalConfiguredModelRefs: params.agentId ? Object.keys(resolveAgentConfig(params.cfg, params.agentId)?.models ?? {}) : [],
