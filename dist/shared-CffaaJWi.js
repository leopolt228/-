...
import { a as resolveClaudeFable5ModelIdentity, f as supportsClaudeNativeXhighEffort, u as supportsClaudeAdaptiveThinking } from "./src-BnQDOjpw.js";
...
if (process.env.VITEST === "true") {
	...
	const api = Reflect.get(globalThis, key) ?? {};
...
function extractFoundryEndpoint(baseUrl) {
	...
	try {
		...
		return normalizeFoundryEndpoint(trimmed) || void 0;
	} catch {
		return;
	}
}
...
//#endregion
export { resolveConfiguredModelNameHint as C, usesFoundryResponsesByDefault as D, resolveFoundryTargetProfileId as E, requiresFoundryMaxCompletionTokens as S, resolveFoundryModelCapabilities as T, listConfiguredFoundryProfileIds as _, FOUNDRY_ANTHROPIC_SCOPE as a, requiresFoundryEntraIdClaudeAuth as b, applyFoundryProfileBinding as c, buildFoundryProviderBaseUrl as d, extractFoundryEndpoint as f, isFoundryProviderApi as g, isFoundryMaiImageModel as h, DEFAULT_GPT5_API as i, applyFoundryProviderConfig as l, isFoundryClaudeMythosPreview as m, COGNITIVE_SERVICES_RESOURCE as n, PROVIDER_ID as o, formatFoundryApiLabel as p, DEFAULT_API as r, TOKEN_REFRESH_MARGIN_MS as s, ANTHROPIC_MESSAGES_API as t, buildFoundryAuthResult as u, mergeFoundryCanonicalModelParams as v, resolveFoundryApi as w, requiresFoundryMandatoryAdaptiveClaudeThinking as x, normalizeFoundryEndpoint as y };
