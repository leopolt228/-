...
import { a as toAcpRuntimeError, n as AcpRuntimeError } from "./errors-C7_LR8fF.js";
import { t as formatAcpRuntimeErrorText } from "./error-text-BWGsAuwp.js";
import { o as isSessionIdentityPending, u as resolveSessionIdentityFromMeta } from "./session-identity-D29-Iouw.js";
import { i as resolveAcpThreadSessionDetailLines } from "./session-identifiers-BmbqiGBi.js";
...
import { i as shouldCleanTtsDirectiveText, t as resolveConfiguredTtsMode } from "./tts-config-Cl3uWggE.js";
import { f as markReplyPayloadAsTtsSupplement, l as isReplyPayloadStatusNotice } from "./reply-payload-BtIUrr9c.js";
import "./errors-ZuRgsQUc.js";
import { n as classifySessionStateActor } from "./session-state-events-BG_mebdA.js";
import { _ as markDiagnosticSessionProgress } from "./diagnostic-CiatiVjT.js";
import { s as hasOutboundReplyContent } from "./reply-payload-CPcXnHho.js";
...
import { n as resolveAcpAgentPolicyError, r as resolveAcpDispatchPolicyError } from "./policy-BbO3TBTB.js";
...
import { c as readDispatcherFailedCounts, n as captureReplyDispatchDeliveryOutcome, s as waitForReplyDispatcherIdle } from "./reply-dispatcher-DKBtxrbe.js";
import { n as resolveRoutedDeliveryThreadId } from "./routed-delivery-thread-C6d69LZZ.js";
import { r as hasInboundMediaForUnderstanding } from "./inbound-media-5a6CUBEc.js";
import { t as stripExtractedFileImageMetadata } from "./extracted-file-images-CdmNdoIK.js";
import { i as appendRecentHistoryImageContext, n as resolveAgentTurnAttachments, r as resolveInlineAgentImageAttachments, t as loadAgentTurnMediaRuntime } from "./agent-turn-attachments-DaaBjcac.js";
import { r as resolveFirstContextText } from "./context-text-DMuk8Wh5.js";
import { n as resolveAcpProjectionSettings, r as resolveAcpStreamingConfig, t as isAcpTagVisible } from "./acp-stream-settings-CnipUEhR.js";
import { t as resolveAcpToolTerminalOutcome } from "./tool-status-BF6CFZHZ.js";
import { r as createBlockReplyPipeline } from "./block-reply-pipeline-D50odxF5.js";
import { t as resolveStatusTtsSnapshot } from "./status-config-4PRwqJTI.js";
...
const channelPluginRuntimeLoader = createLazyImportLoader(() => import("./plugins-B002eaXp.js"));
const messageActionRuntimeLoader = createLazyImportLoader(() => import("./message-action-runner-BoR8NJJD.js"));
...
function createAcpDispatchDeliveryCoordinator(params) {
	...
	const deliver = async (kind, payload, meta) => {
		...
		const rawBlockPayloadText = kind === "block" ? normalizeOptionalString(payload.text) : void 0;
		...
		const transcriptOutcome = rawBlockText || rawFinalText ? captureReplyDispatchDeliveryOutcome(ttsPayload) : void 0;
...
async function tryDispatchAcpReply(params) {
	...
	try {
		...
		if (isRestrictiveRuntimeToolsAllow(params.toolsAllow)) {
			auditTerminalOutcome = "blocked";
			throw new AcpRuntimeError("ACP_DISPATCH_DISABLED", "ACP dispatch cannot enforce runtime toolsAllow for this session; use an embedded runtime for restricted tool policy.");
		}
