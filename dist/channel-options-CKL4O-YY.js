...
import { t as readCliStartupMetadata } from "./startup-metadata-CXoW9qJJ.js";
...
const testing = { resetPrecomputedChannelOptionsForTests() {
	precomputedChannelOptions = void 0;
} };
if (process.env.VITEST || false) globalThis[Symbol.for("openclaw.cliChannelOptionsTestApi")] = testing;
//#endregion
