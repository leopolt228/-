...
import { n as parseWindowsNetstatListeners, t as parseTcpEndpoint } from "./ports-netstat-Dvt67xpZ.js";
...
function parseListenerAddress(address) {
	...
	if (bracketMatch) {
		const port = Number.parseInt(expectDefined(bracketMatch[2], "bracket match capture group 2"), 10);
...
//#endregion
export { isDualStackLoopbackGatewayListeners as a, formatPortDiagnostics as i, inspectPortUsage as n, isExpectedGatewayListeners as o, classifyPortListener as r, isSameProcessSpecificIpv4WithLoopbackListeners as s, inspectPortConnections as t };
