...
import { i as isOpenClawOrgNpmSpec, s as parseRegistryNpmSpec } from "./npm-registry-spec-CqBTTiC9.js";
...
import { l as clearLoadInstalledPluginIndexInstallRecordsCache } from "./installed-plugin-index-record-reader-DjVucfOz.js";
...
import { t as invalidatePluginRuntimeDiscoveryAfterConfigMutation } from "./registry-refresh-B0V27wfG.js";
import { i as installPluginFromNpmPackArchive, r as installPluginFromNpmSpec } from "./install-CCEI5eu6.js";
import { n as resolveBundledInstallPlanForCatalogEntry } from "./plugin-install-plan-DbLkCjKz.js";
...
if (process.env.VITEST || false) globalThis[Symbol.for("openclaw.onboardingPluginInstallTestApi")] = testing;
...
async function installPluginFromClawHubSpecWithProgress(params) {
	...
	try {
		const { installPluginFromClawHub } = await import("./clawhub-BgDE4q4x.js");
