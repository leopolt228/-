...
import { et as parseConfigJson5 } from "./io-CEgS2K9F.js";
import { a as readLatestDiagnosticStabilityBundleSync, i as readDiagnosticStabilityBundleFileSync } from "./diagnostic-stability-bundle-0tcSxw3r.js";
import { n as redactConfigObject } from "./redact-snapshot-DpSfGa7F.js";
import { a as sanitizeSupportSnapshotValue, i as sanitizeSupportConfigValue, n as redactSupportString, r as redactTextForSupport, t as redactPathForSupport } from "./diagnostic-support-redaction-DTRhh32S.js";
import { t as buildConfigSchema } from "./schema-B0qGh61E.js";
import { t as readConfiguredLogTail } from "./log-tail-B80241Y2.js";
import { i as textSupportBundleFile, n as jsonlSupportBundleFile, o as writeSupportBundleZip, r as supportBundleContents, t as jsonSupportBundleFile } from "./diagnostic-support-bundle-nttvA44g.js";
...
function resolveBonjourEnvOverride(env) {
	...
	switch (raw) {
		...
		case "true":
		case "yes":
		case "on": return "force-disabled";
		case "0":
		case "false":
		case "no":
		case "off": return "force-enabled";
...
function sanitizeConfigShape(parsed, configPath, stat, env) {
	...
	const mdns = asOptionalRecord(asOptionalRecord(root.discovery)?.mdns);
...
function sanitizeConfigDetails(parsed, redaction) {
	return sanitizeSupportConfigValue(redactConfigObject(parsed, buildConfigSchema().uiHints), redaction);
}
