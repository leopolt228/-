...
import { i as DEFAULT_PROMPT, n as DEFAULT_MAX_BYTES, r as DEFAULT_MAX_CHARS_BY_CAPABILITY } from "./defaults.constants-iEQlxleo.js";
import { n as runtimeMediaModelSecretOwnerId, o as resolveEffectiveMediaEntryCapabilities } from "./runtime-media-secret-owner-B5XrdRNw.js";
...
function resolveModelEntries(params) {
	...
	const entries = [...(config?.models ?? []).map((entry, index) => ({
		entry,
		source: "capability",
