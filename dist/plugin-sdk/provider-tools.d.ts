import { Rt as ProviderNormalizeToolSchemasContext, a as AnyAgentTool, on as ProviderToolSchemaDiagnostic } from "../plugin-entry-Bj-pdgAt.js";
import { GEMINI_UNSUPPORTED_SCHEMA_KEYWORDS, cleanSchemaForGemini, findOpenAIStrictSchemaViolations, stripUnsupportedSchemaKeywords } from "@openclaw/ai/internal/openai";
...
schema: unknown, /** Dot/bracket path prefix used in returned diagnostics. */path: string, /** Schema keywords unsupported by the target provider family. */unsupportedKeywords: ReadonlySet<string>): string[];
/**
