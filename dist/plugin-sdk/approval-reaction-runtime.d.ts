...
import { C as PendingApprovalView, _ as ApprovalRequest } from "../approval-handler-runtime-types-CS23SSVQ.js";
import { r as ExecApprovalReplyDecision } from "../exec-approval-reply-DGMzVePl.js";
import { d as shouldSuppressLocalNativeExecApprovalPrompt } from "../approval-native-helpers-ML6Un8uD.js";
...
//#endregion
export { APPROVAL_REACTION_BINDINGS, ApprovalReactionDecisionBinding, ApprovalReactionDecisionResolution, ApprovalReactionPendingContent, ApprovalReactionPromptPayload, ApprovalReactionTargetRecord, ApprovalReactionTargetResolution, ApprovalReactionTargetStore, addApprovalReactionHintToText, buildApprovalPendingPromptPayload, buildApprovalReactionHint, buildApprovalReactionPendingContent, buildApprovalReactionPendingContentForRequest, buildApprovalReactionPromptPayloadForRequest, createApprovalReactionTargetStore, hasApprovalReactionHintText, insertApprovalReactionHintNearIdHeader, listApprovalReactionBindings, normalizeApprovalReactionEmoji, resolveApprovalReactionDecision, resolveTypedApprovalReactionTarget, shouldSuppressLocalNativeExecApprovalPrompt };