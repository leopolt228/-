...
import { At as boolean, Bt as discriminatedUnion, Et as array, Nn as record, Rn as string, Tn as object, Zn as unknown, dn as literal, wn as number, yt as _enum } from "./schemas-CBJjibl3.js";
...
discriminatedUnion("type", [
	...
	BaseEventSchema.extend({
		type: literal("call.assistant-speech"),
		transcript: string()
	}),
	BaseEventSchema.extend({
...
function readCallHistoryFromStore(storePath) {
	const stores = tryCreateCallRecordStateStores(storePath);
	if (stores) try {
...
async function findCallMatchesInStore(storePath, callId) {
