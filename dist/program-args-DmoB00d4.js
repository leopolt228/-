import { N as isNodeRuntime } from "./argv-D4LdWdQQ.js";
import { a as getWindowsSystem32ExePath } from "./windows-install-roots-BTRBDwn4.js";
import { n as findFirstAccessibleGatewayEntrypoint, r as isGatewayDistEntrypointPath, t as buildGatewayDistEntrypointCandidates } from "./gateway-entrypoint-C005pL9T.js";
...
const NODE_BINARY_LOOKUP_TIMEOUT_MS = 5e3;
...
async function resolveBinaryPath(binary) {
	...
	try {
		const resolved = execFileSync(cmd, [binary], {
			encoding: "utf8",
