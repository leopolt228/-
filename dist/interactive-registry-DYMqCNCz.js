...
function resolvePluginInteractiveRegistrationsMatch(registrations, channel, data) {
	return resolvePluginInteractiveMatch({
		interactiveHandlers: { get: (key) => registrations.find((registration) => toPluginInteractiveRegistryKey(registration.channel, registration.namespace) === key) },
		channel,
		data
	});
}
...
//#endregion
export { registerRegistryPluginInteractiveHandler as a, restorePluginInteractiveHandlers as c, releasePluginInteractiveCallbackDedupe as d, registerPluginInteractiveHandler as i, claimPluginInteractiveCallbackDedupe as l, clearPluginInteractiveHandlersForPlugin as n, resolvePluginInteractiveNamespaceMatch as o, listPluginInteractiveHandlers as r, resolvePluginInteractiveRegistrationsMatch as s, clearPluginInteractiveHandlers as t, commitPluginInteractiveCallbackDedupe as u };
