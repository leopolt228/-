...
import { i as resolveProviderRequestPolicy } from "./provider-attribution-D75_xhiu.js";
import { l as resolveProviderRequestPolicyConfig } from "./provider-request-config-DrrUROfX.js";
import { i as streamSimple } from "./stream-CKgZbNR4.js";
import { o as emitModelTransportDebug } from "./provider-transport-fetch-CqHtV1lD.js";
import { t as log$1 } from "./logger-DTutvtjM.js";
import { a as patchCodexNativeWebSearchPayload, o as resolveCodexNativeSearchActivation } from "./codex-native-web-search-core-Dpdma2GY.js";
import { A as mapThinkingLevelToReasoningEffort, M as applyAnthropicEphemeralCacheControlMarkers, P as resolveAnthropicEphemeralCacheControl, k as streamWithPayloadPatch, y as normalizeOpenAICompatibleReasoningPayload } from "./provider-stream-shared-BiURRLUJ.js";
import { a as resolveOpenAIResponsesPayloadPolicy, c as stripCompletionMessagesToRoleContent, i as applyOpenAIResponsesPayloadPolicy, r as createOpenAIResponsesTransportStreamFn, s as flattenCompletionMessagesToStringContent } from "./openai-transport-stream-810ZIbd4.js";
import { resolveOpenAIReasoningEffortForModel, supportsOpenAIReasoningEffort } from "@openclaw/ai/internal/openai";
...
//#endregion
export { isAnthropicModelRef as C, isAnthropicFamilyCacheTtlEligible as S, createOpenAITextVerbosityWrapper as _, createMinimaxFastModeWrapper as a, resolveOpenAIServiceTier as b, createOpenAIAttributionHeadersWrapper as c, createOpenAIDefaultTransportWrapper as d, createOpenAIFastModeWrapper as f, createOpenAIStringContentWrapper as g, createOpenAIServiceTierWrapper as h, isProxyReasoningUnsupported as i, createOpenAICompletionsStrictMessageKeysWrapper as l, createOpenAIResponsesContextManagementWrapper as m, createOpenRouterSystemCacheWrapper as n, createMinimaxThinkingDisabledWrapper as o, createOpenAIReasoningCompatibilityWrapper as p, createOpenRouterWrapper as r, createCodexNativeWebSearchWrapper as s, createKilocodeWrapper as t, createOpenAICompletionsToolsCompatWrapper as u, createOpenAIThinkingLevelWrapper as v, resolveAnthropicCacheRetentionFamily as w, resolveOpenAITextVerbosity as x, resolveOpenAIFastMode as y };
