...
import { m as HookExternalContentSource } from "./types-D43pE80v.js";
...
type CronJobState = {
  nextRunAtMs?: number; /** Exact startup catch-up slot protected from future-slot repair across restarts. */
  ...
  triggerState?: unknown; /** Explicit delivery outcome, separate from execution outcome. */
...
type CronJobPatch = Partial<Omit<CronJob, "id" | "createdAtMs" | "state" | "payload" | "delivery" | "failureAlert" | "declarationKey" | "displayName" | "owner" | "pacing">> & {
...
//#endregion
export { CronJobCreate as a, CronRunStatus as c, CronJob as i, resolveCronStorePath as n, CronJobPatch as o, saveCronStore as r, CronPayload as s, loadCronStore as t };