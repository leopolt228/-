...
import "./runtime-state-Bd0YsvqM.js";
...
async function cleanupPreviousPluginHostRegistry(params) {
	const [{ getRuntimeConfig }, { cleanupReplacedPluginHostRegistry }] = await Promise.all([import("./config/config.js"), import("./host-hook-cleanup-GooQgcvu.js")]);
...
function getActivePluginGatewayNodePolicyRegistry() {
	return (state.channel.pinned ? asPluginRegistry(state.channel.registry) : null) ?? (state.httpRoute.pinned ? asPluginRegistry(state.httpRoute.registry) : null) ?? (state.sessionExtension.pinned ? asPluginRegistry(state.sessionExtension.registry) : null) ?? asPluginRegistry(state.activeRegistry);
}
...
//#endregion
export { clearPluginRunContext as A, isPluginRegistryActivated as B, requireActivePluginHttpRouteRegistry as C, setActivePluginRegistry as D, resolveActivePluginHttpRouteRegistry as E, registerPluginSessionSchedulerJob as F, setPluginRunContext as I, buildPluginAgentTurnPrepareContext as L, getPluginRunContext as M, getPluginSessionSchedulerJobGeneration as N, createEmptyPluginRegistry as O, makePluginSessionSchedulerJobKey as P, normalizePluginHostHookId as R, requireActivePluginChannelRegistry as S, resetPluginRuntimeStateForTest as T, isPluginRegistryRetired as V, pinActivePluginSessionExtensionRegistry as _, getActivePluginGatewayNodePolicyRegistry as a, releasePinnedPluginHttpRouteRegistry as b, getActivePluginRegistry as c, getActivePluginRegistryWorkspaceDir as d, getActivePluginRuntimeSubagentMode as f, pinActivePluginHttpRouteRegistry as g, pinActivePluginChannelRegistry as h, getActivePluginGatewayCommandRegistry as i, deletePluginSessionSchedulerJob as j, cleanupPluginSessionSchedulerJobs as k, getActivePluginRegistryKey as l, listImportedRuntimePluginIds as m, getActivePluginChannelRegistry as n, getActivePluginHttpRouteRegistry as o, getActivePluginSessionExtensionRegistry as p, getActivePluginChannelRegistryVersion as r, getActivePluginHttpRouteRegistryVersion as s, collectLivePluginRegistries as t, getActivePluginRegistryVersion as u, recordImportedPluginId as v, requireActivePluginRegistry as w, releasePinnedPluginSessionExtensionRegistry as x, releasePinnedPluginChannelRegistry as y, withPluginHostCleanupTimeout as z };
