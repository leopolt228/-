...
import { a as listExplicitConfiguredChannelIdsForConfig, o as resolveConfiguredChannelPluginIds } from "./channel-presence-policy-ClfxdhHd.js";
import { c as loadGatewayStartupPluginPlan } from "./gateway-startup-plugin-ids-DDW1RRDk.js";
...
function collectConfiguredChannelIds(config, activationSourceConfig, env) {
	...
	return [.../* @__PURE__ */ new Set([...listPotentialConfiguredChannelIds(config, env, { includePersistedAuthState: false }), ...listExplicitConfiguredChannelIdsForConfig(activationSourceConfig)])].map((channelId) => normalizeOptionalLowercaseString(channelId)).filter((channelId) => {
