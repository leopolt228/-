...
import { r as guardedRm, t as guardedRename } from "./guarded-mutation-C9yfXO_j.js";
...
import { i as resolveDefaultPluginGitDir } from "./install-paths-CQBLzB1H.js";
...
import { n as preflightPluginGitInstallPolicy } from "./install-security-scan-D_fqlETr.js";
import { a as installPluginFromInstalledPackageDir, c as pluginAuditOutcomeForReason, l as PLUGIN_INSTALL_ERROR_CODE, o as emitPluginAuditSecurityEvent, s as emitPluginInstallSecurityEvent } from "./install-CCEI5eu6.js";
...
async function withGitStagingDir(persistentRepoDir, fn) {
	if (!persistentRepoDir) return await withTempDir("openclaw-git-plugin-", fn);
