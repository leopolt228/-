...
import { a as readEmbeddedGatewayToken } from "./service-audit-7zro2961.js";
import { a as isGatewayExternallySupervised, r as formatExternalSupervisorActionRequired } from "./gateway-supervision-BCaMyZ4m.js";
...
import { n as createDaemonInstallActionContext, p as buildDaemonServiceSnapshot, r as failIfNixDaemonInstallMode, v as installDaemonServiceAndEmit } from "./shared-B2j_B0O6.js";
...
async function runDaemonInstall(opts) {
	...
	if (isGatewayExternallySupervised()) {
		fail(`Gateway install blocked: ${formatExternalSupervisorActionRequired("install or rewrite the gateway service")}`);
		return;
	}
