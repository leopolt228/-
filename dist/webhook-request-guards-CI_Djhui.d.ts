 ...
 */
declare function runDetachedWebhookWork<T>(run: () => Promise<T>): Promise<T>;
...
//#endregion
export { WebhookAnomalyTracker as _, applyBasicWebhookRequestGuards as a, createWebhookAnomalyTracker as b, isJsonContentType as c, runDetachedWebhookWork as d, BoundedCounter as f, WEBHOOK_RATE_LIMIT_DEFAULTS as g, WEBHOOK_ANOMALY_STATUS_CODES as h, WebhookInFlightLimiter as i, readJsonWebhookBodyOrReject as l, WEBHOOK_ANOMALY_COUNTER_DEFAULTS as m, WEBHOOK_IN_FLIGHT_DEFAULTS as n, beginWebhookRequestPipelineOrReject as o, FixedWindowRateLimiter as p, WebhookBodyReadProfile as r, createWebhookInFlightLimiter as s, WEBHOOK_BODY_READ_DEFAULTS as t, readWebhookBodyOrReject as u, createBoundedCounter as v, createFixedWindowRateLimiter as y };