...
import { o as supportsNativeExecApprovalClient, r as listNativeExecApprovalClientLabels, t as describeNativeExecApprovalClientSetup } from "./exec-approval-surface-BeBSG2sP.js";
import { V as resolveExecApprovalAllowedDecisions } from "./exec-approvals-BWcbplqx.js";
...
function buildApprovalCommandFence(descriptors) {
	...
	return formatFencedCodeBlock(descriptors.map((descriptor) => descriptor.command).join("\n"), "txt");
}
...
function buildTypedApprovalActionDescriptors(params) {
	...
	if (!isWellFormedApprovalId(approvalId)) return [];
...
//#endregion
export { buildExecApprovalCommandText as a, buildExecApprovalUnavailableReplyPayload as c, buildTypedExecApprovalPendingReplyPayload as d, buildTypedExecApprovalPresentation as f, parseExecApprovalCommandText as g, getExecApprovalReplyMetadata as h, buildExecApprovalActionDescriptors as i, buildTypedApprovalActionDescriptors as l, getExecApprovalApproverDmNoticeText as m, buildApprovalPresentation as n, buildExecApprovalPendingReplyPayload as o, formatExecApprovalExpiresIn as p, buildApprovalPresentationFromActionDescriptors as r, buildExecApprovalPresentation as s, buildApprovalInteractiveReplyFromActionDescriptors as t, buildTypedApprovalPresentation as u };
