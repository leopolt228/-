...
import { o as assertSecretInputResolved } from "./types.secrets-BgE_Zq2x.js";
import { i as resolveProviderRequestPolicy, r as resolveProviderRequestCapabilities } from "./provider-attribution-D75_xhiu.js";
...
*/
const FORBIDDEN_HEADER_KEYS = /* @__PURE__ */ new Set([
	"__proto__",
	"prototype",
	"constructor"
]);
...
function applyResolvedAuthHeader(headers, auth) {
	...
	const keysToDelete = /* @__PURE__ */ new Set([normalizeLowercaseStringOrEmpty(auth.headerName)]);
...
//#endregion
export { buildCopilotDynamicHeaders as _, mergeModelProviderRequestOverrides as a, resolveProviderRequestHeaders as c, sanitizeConfiguredProviderRequest as d, COPILOT_EDITOR_PLUGIN_VERSION as f, COPILOT_USER_AGENT as g, COPILOT_INTEGRATION_ID as h, getModelProviderRequestTransport as i, resolveProviderRequestPolicyConfig as l, COPILOT_GITHUB_API_VERSION as m, attachModelProviderRequestTransport as n, normalizeBaseUrl as o, COPILOT_EDITOR_VERSION as p, buildProviderRequestDispatcherPolicy as r, resolveProviderRequestConfig as s, applyPreparedRuntimeAuthToModel as t, sanitizeConfiguredModelProviderRequest as u, buildCopilotIdeHeaders as v, hasCopilotVisionInput as y };
