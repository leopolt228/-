...
import { a as parseDeliveryInput, i as TrimmedNonEmptyStringFieldSchema, o as parseOptionalField, r as TimeoutSecondsFieldSchema } from "./delivery-field-schemas-DZf4ZPpU.js";
...
import { i as resolveCronCurrentSessionTarget, t as assertSafeCronSessionTargetId } from "./session-target-DJsUULzX.js";
...
function normalizeCronJobInput(raw, options = DEFAULT_OPTIONS) {
	...
	if (options.applyDefaults) {
		...
		if (!next.sessionTarget && isRecord(next.payload)) {
			...
			else if (kind === "agentTurn" || kind === "command" || kind === "script") next.sessionTarget = "isolated";
		}
