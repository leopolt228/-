import { i as ChannelApprovalNativeAvailabilityAdapter, l as ChannelApprovalNativeRuntimeAdapter, m as ExecApprovalChannelRuntimeEventKind } from "./approval-handler-runtime-types-CS23SSVQ.js";
...
declare function createLazyChannelApprovalNativeRuntimeAdapter<TPendingPayload = unknown, TPreparedTarget = unknown, TPendingEntry = unknown, TBinding = unknown, TFinalPayload = unknown>(params: {
  ...
  eventKinds?: readonly ExecApprovalChannelRuntimeEventKind[]; /** @deprecated Trusted compatibility override; omit to derive ownership from the payload. */
