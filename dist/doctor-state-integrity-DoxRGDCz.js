...
import { t as asNullableObjectRecord } from "./record-coerce-DHZ4bFlT.js";
import { t as expectDefined } from "./expect-CyE8FADM.js";
import "./src-COWbwBfI.js";
import { _ as uniqueStrings, u as normalizeStringEntriesLower } from "./string-normalization-CRyoFBPt.js";
...
import { c as resolveDefaultAgentId, n as listAgentIds, r as resolveAgentConfig, s as resolveDefaultAgentDir, t as listAgentEntries } from "./agent-scope-config-S7z_Yn4H.js";
import { t as resolveAgentHarnessPolicy } from "./policy-CZpNJ432.js";
import { i as listConfiguredChannelIdsForReadOnlyScope } from "./channel-presence-policy-ClfxdhHd.js";
import { c as parseModelRef, i as modelKey, o as normalizeProviderId } from "./model-selection-normalize-D7Dhjaxs.js";
import { r as resolveDefaultModelForAgent } from "./codex-plugin-diagnostics-CV4VBWUf.js";
import { a as resolveMainSessionKey, n as canonicalizeMainSessionAlias } from "./main-session-C7kXMD8t.js";
import { c as resolveSessionTranscriptsDirForAgent, f as formatSessionArchiveTimestamp, h as isPrimarySessionTranscriptFileName, i as resolveSessionFilePathOptions, l as resolveStorePath, r as resolveSessionFilePath } from "./paths-BpMRJ7TJ.js";
import { gt as listSessionEntries, rt as applySessionEntryReplacements } from "./session-accessor-Mu3lv_Tl.js";
...
import { i as isSubagentRecoveryWedgedEntry, r as formatSubagentRecoveryWedgedReason, t as clearWedgedSubagentRecoveryAbort } from "./subagent-recovery-state-feBn87fa.js";
import "./selection-6xddiFwm.js";
import "./channel-plugin-ids-DxHopQDb.js";
import { t as resolveHeartbeatDeliveryTarget } from "./targets-B6GGowJc.js";
import { n as resolveHeartbeatIntervalMs } from "./heartbeat-summary-D8_NFvmx.js";
import { n as isHeartbeatOkResponse, r as isHeartbeatUserMessage } from "./heartbeat-filter-heuIP_Mh.js";
import { t as note } from "./note-AoV1Tth-.js";
import { t as resolveMemoryBackendConfig } from "./backend-config-Bzby-qx1.js";
import { t as inspectMainSessionRecoveryHealth } from "./main-session-recovery-lifecycle-u7uCDmZl.js";
import { a as listPluginDoctorSessionRouteStateOwners } from "./doctor-contract-registry-C_4oQmE8.js";
import "./engine-storage-BItALzrQ.js";
import { n as clearTuiLastSessionPointers } from "./tui-last-session-6Ya7v2dU.js";
...
if (process.env.VITEST || false) globalThis[Symbol.for("openclaw.doctorHeartbeatMainSessionRepairTestApi")] = {
...
async function noteMainSessionRecoveryIntegrity(params) {
	...
	const wedged = entries.flatMap(({ entry, sessionKey }) => {
		...
		return health.status === "tombstoned" ? [{
			key: sessionKey,
			health
		}] : [];
	});
	if (wedged.length === 0) return entries.length;
	...
	if (staleAborted.length === 0) return entries.length;
	...
	const repaired = await applySessionEntryReplacements({
...
function scanSessionRouteStateOwners(params) {
	...
	for (const [key, entry] of Object.entries(params.store)) {
		if (!entry || typeof entry !== "object" || isValidAgentHarnessSessionStoreEntry(key, entry)) continue;
...
function listOrphanAgentDirs(cfg, stateDir) {
	...
	try {
		return fs.readdirSync(agentsRoot, { withFileTypes: true }).filter((entry) => entry.isDirectory()).map((entry) => ({
			...
			if (areComparablePathsEqual(nestedAgentDir, liveDefaultAgentDir)) return false;
...
//#endregion
export { collectWorkspaceBackupTip, detectLinuxSdBackedStateDir, detectLinuxVolatileStateDir, detectMacCloudSyncedStateDir, detectStateIntegrityHealthIssues, formatLinuxSdBackedStateDirWarning, formatLinuxVolatileStateDirWarning, noteStateIntegrity, noteWorkspaceBackupTip, stateIntegrityIssueToHealthFinding, stateIntegrityIssueToRepairEffect };
