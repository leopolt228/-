...
import { r as resolveActiveManagedProxyTlsOptions } from "./managed-proxy-undici-BCJBAJza.js";
import { t as createLoggerBackedRuntime } from "./runtime-logger.internal-B7qgxaF3.js";
import { t as createDeferred$1 } from "./deferred-DJrEoFQk.js";
...
function formatPluginConfigIssue(issue, options) {
	...
	if (issue.code === "unrecognized_keys" && issue.keys.length > 0) return options?.unknownKeyMessage?.(expectDefined(issue.keys[0], "keys entry at 0")) ?? `unknown config key: ${issue.keys[0]}`;
