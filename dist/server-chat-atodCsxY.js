...
import { h as getAgentRunContextOwnerStatus, m as getAgentRunContext, p as getAgentEventLifecycleGeneration } from "./agent-events-Dg0sI2pr.js";
import { o as resolveAssistantEventPhase } from "./chat-message-content-CeBHi_A4.js";
import { d as isTimeoutError, f as resolveFailoverReasonFromError } from "./failover-error-B8xHNn2y.js";
import { n as buildAgentRunTerminalOutcome } from "./agent-run-terminal-outcome-C9geO1r1.js";
import { l as loadGatewaySessionRow, u as loadSessionEntry } from "./session-utils-CEU0rCPC.js";
import { d as stripHeartbeatToken } from "./heartbeat-Bkwxbekw.js";
import { a as resolveToolSearchCodeDisplayTarget } from "./tool-display-DjpsCVVm.js";
import { h as normalizeAgentPlanSteps } from "./streaming-CeN4qI3u.js";
...
import { a as createChatRunState, c as createToolEventRecipientRegistry, i as createChatRunRegistry, l as isChatAbortMarkerCurrent, n as createChatAbortMarker, o as createSessionEventSubscriberRegistry, s as createSessionMessageSubscriberRegistry } from "./server-chat-state-B5sGX0h3.js";
import { t as formatForLog } from "./ws-log-Bj-6Do--.js";
import { a as isAgentLifecycleYieldedWaiting, i as persistGatewaySessionLifecycleEvent, n as isRestartRecoveryLifecycleEvent, r as isStaleLifecycleEventForSession, t as deriveGatewaySessionLifecycleProjectionPatch } from "./session-lifecycle-state-CcZ4iGFC.js";
...
function createAgentEventHandler({ broadcast, broadcastToConnIds, nodeSendToSession, agentRunSeq, chatRunState, resolveSessionKeyForRun, clearAgentRunContext, toolEventRecipients, sessionEventSubscribers, sessionMessageSubscribers, loadGatewaySessionRowForSnapshot = loadGatewaySessionRow, lifecycleErrorRetryGraceMs = AGENT_LIFECYCLE_ERROR_RETRY_GRACE_MS, isChatSendRunActive = () => false, clearTrackedActiveRun, markTrackedRunTerminalPersisted, trackTrackedRunTerminalPersistence, resolveActiveLifecycleGenerationForRun = () => void 0, updateRunToolErrorSummary, resolveSessionActiveRunState }) {
	...
	const emitChatDelta = (sessionKey, agentId, clientRunId, sourceRunId, seq, text, delta, opts) => {
		...
		const projected = projectLiveAssistantBufferedText(normalizeLiveAssistantBufferedText(mergedRawText));
	...
	const sendAgentPayload = (sessionKey, payload, opts) => {
		if (opts?.controlUiVisible ?? true) {
			broadcast("agent", payload, { sessionKeys: sessionKey ? [resolveSessionDeliveryKey(sessionKey, opts?.agentId)] : void 0 });
	...
	const handleEvent = (event) => {
		...
		if (last > 0 && evt.seq !== last + 1 && isControlUiVisible) {
			...
			}, { sessionKeys: sessionKey ? [resolveSessionDeliveryKey(sessionKey, sessionAgentId)] : void 0 });
		}
		...
		if (isToolEvent) {
			...
			} : agentPayload, runToolRecipients, { sessionKeys: sessionKey ? [resolveSessionDeliveryKey(sessionKey, sessionAgentId)] : void 0 });
