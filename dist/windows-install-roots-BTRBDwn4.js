...
function queryWindowsRegistryValue(key, valueName) {
...
function getWindowsPowerShellExePath(env = process.env) {
	return path.win32.join(getWindowsInstallRoots(env).systemRoot, "System32", "WindowsPowerShell", "v1.0", "powershell.exe");
}
...
//#endregion
export { getWindowsSystem32ExePath as a, getWindowsProgramFilesRoots as i, getWindowsInstallRoots as n, getWindowsWmicExePath as o, getWindowsPowerShellExePath as r, queryWindowsRegistryValue as s, getWindowsCmdExePath as t };
