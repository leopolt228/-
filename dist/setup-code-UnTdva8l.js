...
import { a as isCarrierGradeNatIpv4Address, c as isIpv4Address, f as isLoopbackIpAddress, g as parseCanonicalIpAddress, l as isIpv6Address, m as isRfc1918Ipv4Address } from "./ip-DorYMgxW.js";
...
import { r as materializeGatewayAuthSecretRefs } from "./auth-config-utils-D4OWSnZE.js";
...
import { b as PAIRING_SETUP_BOOTSTRAP_PROFILE, i as issueDeviceBootstrapToken, v as FULL_ACCESS_PAIRING_SETUP_BOOTSTRAP_PROFILE, x as deviceBootstrapProfilesEqual, y as NODE_PAIRING_SETUP_BOOTSTRAP_PROFILE } from "./device-bootstrap-jcudyeA5.js";
...
function resolvePairingSetupAccess(profile) {
	if (deviceBootstrapProfilesEqual(profile, FULL_ACCESS_PAIRING_SETUP_BOOTSTRAP_PROFILE)) return "full";
	if (deviceBootstrapProfilesEqual(profile, NODE_PAIRING_SETUP_BOOTSTRAP_PROFILE)) return "node";
	return "limited";
}
