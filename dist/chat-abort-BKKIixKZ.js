import { C as resolveExpiresAtMsFromDurationMs, S as resolveDateTimestampMs, o as asDateTimestampMs } from "./number-coercion-Crk_c9KW.js";
import { c as resolveDefaultAgentId } from "./agent-scope-config-S7z_Yn4H.js";
import { l as emitAgentEvent, p as getAgentEventLifecycleGeneration } from "./agent-events-Dg0sI2pr.js";
...
import { n as projectLiveAssistantBufferedText } from "./live-chat-projector-BHcCb693.js";
...
function boundInFlightRunSnapshotForChatHistory(params) {
	...
	if (params.snapshot.plan && messagesBytes + jsonUtf8Bytes(withoutText) <= params.maxBytes) return withoutText;
	...
	if (params.snapshot.text && messagesBytes + jsonUtf8Bytes(withoutPlan) <= params.maxBytes) return withoutPlan;
	return {
		runId: params.snapshot.runId,
		text: "",
		...droppedPlan
