...
import { o as retryAsync } from "./src-DKBD8PDy.js";
...
import "./embeddings-D-HBqAK-.js";
import { d as runMemoryHostTasksWithConcurrency, f as hasNonTextEmbeddingParts, h as splitTextToUtf8ByteLimit, m as estimateUtf8Bytes } from "./internal-B2SueKGX.js";
import { t as hashText } from "./hash-CLsGYYJA.js";
...
function formatBatchErrorDetail(detail) {
	...
	return `${truncateUtf16Safe(formatted, BATCH_ERROR_DETAIL_MAX_CHARS - 15)}${BATCH_ERROR_DETAIL_TRUNCATED_SUFFIX}`;
}
...
const resolveApiKeyForProvider = async (...args) => {
	return (await import("./model-auth-DSfNXC-c.js")).resolveApiKeyForProvider(...args);
};
//#endregion
...
//#endregion
export { isEmbeddingBatchUnavailableError as A, postJsonWithRetry as C, extractBatchErrorMessage as D, EmbeddingBatchUnavailableError as E, formatBatchErrorDetail as O, readEmbeddingBatchJsonl as S, withRemoteHttpResponse as T, runEmbeddingBatchGroups as _, normalizeEmbeddingModelWithPrefixes as a, EMBEDDING_BATCH_ENDPOINT as b, mapBatchEmbeddingsByIndex as c, uploadBatchJsonlFile as d, resolveBatchCompletionFromStatus as f, buildEmbeddingBatchGroupOptions as g, throwIfBatchTerminalFailure as h, resolveRemoteEmbeddingBearerClient as i, formatUnavailableBatchError as k, sanitizeEmbeddingCacheHeaders as l, throwIfBatchCompletionError as m, resolveRemoteEmbeddingClient as n, debugEmbeddingsLog as o, resolveCompletedBatchResult as p, fetchRemoteEmbeddingVectors as r, isMissingEmbeddingApiKeyError as s, createRemoteEmbeddingProvider as t, enforceEmbeddingMaxInputTokens as u, buildBatchHeaders as v, buildRemoteBaseUrlPolicy as w, applyEmbeddingBatchOutputLine as x, normalizeBatchBaseUrl as y };
