		...
		return await new Promise((resolve, reject) => {
			...
			if (options?.signal) {
				const abort = () => {
					...
					this.shutdownChild();
					reject(toLintErrorObject(options.signal?.reason ?? /* @__PURE__ */ new Error("Local embedding request aborted"), "Non-Error rejection"));
				};
...
//#endregion
export { sanitizeAndNormalizeEmbedding as i, createLocalEmbeddingProviderInProcess as n, getLocalEmbeddingRuntimeFacts as r, createLocalEmbeddingProvider as t };
