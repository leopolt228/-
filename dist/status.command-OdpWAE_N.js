...
import { t as OPENCLAW_WRAPPER_ENV_KEY } from "./program-args-DmoB00d4.js";
import { t as sanitizeTerminalText } from "./safe-text-OpUydskC.js";
import { c as normalizePairingConnectRequestId, d as readConnectPairingRequiredMessage, f as readPairingConnectErrorDetails } from "./connect-error-details-BxqBqDDT.js";
import { l as readRestartSentinel } from "./restart-sentinel-C6N0OP2Z.js";
...
const statusScanModuleLoader = createLazyImportLoader(() => import("./status.scan-Dlsqb8hd.js"));
const statusScanFastJsonModuleLoader = createLazyImportLoader(() => import("./status.scan.fast-json-Dfw_3F6V.js"));
const statusAllModuleLoader = createLazyImportLoader(() => import("./status-all-D_OoDcMt.js"));
const statusCommandTextRuntimeLoader = createLazyImportLoader(() => import("./status.command.text-runtime-DaAhRmCd.js"));
const statusNodeModeModuleLoader = createLazyImportLoader(() => import("./status.node-mode-D9kKzu4h.js"));
...
if (process.env.VITEST || false) globalThis[Symbol.for("openclaw.statusCommandTestApi")] = { resolvePairingRecoveryContext };
