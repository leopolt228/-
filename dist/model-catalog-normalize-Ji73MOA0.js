import { n as buildModelCatalogRef, r as normalizeModelCatalogProviderId, t as buildModelCatalogMergeKey } from "./model-catalog-refs-BcuK-xC3.js";
...
function normalizeOpenRouterRouting(value) {
	...
	const routing = {
		...
		...normalizeOpenRouterMetricPreference(value.preferred_min_throughput) !== void 0 ? { preferred_min_throughput: normalizeOpenRouterMetricPreference(value.preferred_min_throughput) } : {},
...
//#endregion
export { normalizeModelCatalogProviderRows as n, normalizeModelCatalog as t };
