...
import { M as isBunRuntime, N as isNodeRuntime } from "./argv-D4LdWdQQ.js";
...
import { C as isEnvironmentFileOnlySource, S as hasInlineEnvironmentSource, l as resolveSystemdUserUnitPath, y as collectInlineManagedServiceEnvKeys } from "./systemd-iYtBw5_g.js";
import { c as normalizeServicePathEntry, f as getMinimalServicePathPartsFromEnv, l as SERVICE_PROXY_ENV_KEYS, n as isVersionManagedNodePath, o as resolveSystemNodePath, s as isNonMinimalServicePathEntry, t as isSystemNodePath } from "./runtime-paths-HrqyQmEH.js";
import { t as POSIX_SHELL_WRAPPERS, y as resolveInlineCommandMatch } from "./shell-wrapper-resolution-DlXABXcG.js";
import { p as resolveLaunchAgentPlistPath } from "./launchd-BI3BhZkH.js";
	...
	if (isVersionManagedNodePath(execPath, platform)) {
		...
		if (!isSystemNodePath(execPath, env, platform)) {
			if (!await resolveSystemNodePath(env, platform)) issues.push({
				...
				message: "System Node 22 LTS (22.22.3+) or Node 24.15+ not found; install it before migrating away from version managers.",
				level: "recommended"
			});
		}
	}
