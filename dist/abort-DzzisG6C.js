...
import { Q as resolveSessionAbortTarget, X as markSessionAbortTarget, yt as loadSessionEntry } from "./session-accessor-Mu3lv_Tl.js";
import { t as getAcpSessionManager } from "./manager-CXN-VKs3.js";
import { i as setAbortMemory, n as isAbortRequestText } from "./abort-primitives-DNTxgxrx.js";
...
import { n as abortEmbeddedAgentRun } from "./runs-DDczt14d.js";
import "./sessions-Uqhj6EXw.js";
import { h as listSubagentRunsForController, s as getLatestSubagentRunByChildSessionKey, y as markSubagentRunTerminated } from "./subagent-registry-CY9-zfiv.js";
...
function markSubagentRunTerminatedBestEffort(params) {
	try {
		...
		logVerbose(`abort: failed to persist killed subagent ${params.runId ?? params.childSessionKey ?? "unknown"}: ${formatErrorMessage(error)}`);
		return 0;
	}
}
