...
import { S as resolveMessagePresentationButtonAction, g as renderMessagePresentationChartFallbackText, h as reduceLegacyInteractiveReply, v as renderMessagePresentationTableFallbackText, w as resolveMessagePresentationOptionAction, x as resolveMessagePresentationActionValue } from "./payload-Br8oiJ5V.js";
...
function buttonFallbackLabel(button, maxLabelLength) {
	...
	return action?.type === "url" || action?.type === "web-app" && action.url ? `${label}: ${action.url}` : label;
}
