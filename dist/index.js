#!/usr/bin/env node
import { i as formatUncaughtError } from "./errors-DdbcjW1Y.js";
import { t as formatCliFailureLines } from "./failure-output-REvZbrW7.js";
import { r as runFatalErrorHooks } from "./fatal-error-hooks-Cu2jsdBV.js";
import { t as isMainModule } from "./is-main-CH4EEB_R.js";
import { n as isBenignUncaughtExceptionError, s as isUncaughtExceptionHandled, t as installUnhandledRejectionHandler } from "./unhandled-rejections-DbQYZFVF.js";
...
if (!isMain) ({applyTemplate, createDefaultDeps, deriveSessionKey, describePortOwner, ensureBinary, ensurePortAvailable, getReplyFromConfig, handlePortError, loadConfig, loadSessionStore, monitorWebChannel, normalizeE164, PortInUseError, promptYesNo, resolveSessionKey, resolveStorePath, runCommandWithTimeout, runExec, saveSessionStore, waitForever} = await import("./library-CdjuQuVb.js"));
if (isMain) {
