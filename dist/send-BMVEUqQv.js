...
import { t as MarkdownIt } from "./markdown-it-CuMGuate.js";
...
import "./text-autolink-runtime-C9NOSJdd.js";
import { t as require_src } from "./src-Ch5YakSI.js";
...
import { r as normalizeMatrixResolvableTarget, t as isMatrixQualifiedUserId } from "./target-ids-B0f5Qh2N.js";
import { r as buildMatrixReactionContent } from "./reaction-common-uB9pjEoY.js";
import { a as EventType, c as MsgType, l as RelationType, n as persistMatrixDirectRoomMapping, s as MSC4357_LIVE_KEY, t as inspectMatrixDirectRooms } from "./direct-management-D6z1RUj8.js";
import { t as fromBuffer } from "./lib-C25Yng9b.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-Dw42w_cH.js";
import { O as textDecode, S as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, n as CouldNotDetermineFileTypeError } from "./BasicParser-ByPzoVVd.js";
import { l as toRatio, n as decodeString } from "./Util-BjVVMnKx.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-XI10AQ2O.js";
import { t as APEv2Parser } from "./APEv2Parser-fBEAU_W_.js";
import { r as hasID3v1Header } from "./ID3v1Parser-D_i92p40.js";
import { i as isStrictDirectRoom } from "./direct-room-DeTW2q2I.js";
...
const loadMatrixSendClientRuntime = createLazyRuntimeModule(() => import("./client-bootstrap-wS_7s8X8.js"));
	...
	for (const [index, token] of tokens.entries()) {
		...
		if (token.type === "list_item_close") {
			...
			if (item && item.immediateParagraphOpenIndexes.length === 1 && item.immediateParagraphCloseIndexes.length === 1) {
				...
				const openToken = openIndex === void 0 ? void 0 : tokens[openIndex];
				const closeToken = closeIndex === void 0 ? void 0 : tokens[closeIndex];
...
//#endregion
//#region node_modules/music-metadata/node_modules/media-typer/dist/index.js
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-FjnPFi-H.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-KaTkXmmp.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-BZxln-Qq.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-opQe6vwk.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-pC2El8i1.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-CyGVZkTY.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-CV5CjcWu.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser-WVx4SXnW.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-CC2VJ9TN.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-DpxqQjYJ.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-BVR-F-pR.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-DTorHMMa.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-DZPo54AL.js")).WaveParser;
	}
};
//#endregion
...
async function sendMessageMatrix(to, message, opts) {
	...
	return await withResolvedMatrixSendClient({
		...
		const sendContent = async (content, kind) => {
			...
			if (eventId) await opts.onDeliveryResult?.({
				messageId: eventId,
				roomId,
...
async function sendSingleTextMessageMatrix(roomId, text, opts) {
	...
	return await withResolvedMatrixSendClient({
		...
		const relation = normalizedThreadId ? buildThreadRelation(normalizedThreadId, opts.replyToId) : buildReplyRelation(opts.replyToId);
