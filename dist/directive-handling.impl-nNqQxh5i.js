...
import { S as resolveModelRefFromString, d as isModelKeyAllowedBySet, m as parseConfiguredModelVisibilityEntries, r as buildConfiguredModelCatalog, y as resolveConfiguredModelRef } from "./model-selection-shared-CPPxIJAX.js";
import { i as modelKey, n as findNormalizedProviderValue, o as normalizeProviderId } from "./model-selection-normalize-D7Dhjaxs.js";
...
import { i as resolveAuthProfileOrder, t as isConfiguredAwsSdkAuthProfileForProvider } from "./order-FUfwr_5s.js";
...
import { i as formatFastModeCurrentStatus, r as formatFastModeCommandOptions, s as formatFastModeValue } from "./fast-mode-CFWkImo-.js";
...
import { t as RUNTIME_MODEL_VISIBILITY_NORMALIZATION } from "./model-visibility-policy-D6Ef-vpo.js";
import "./sandbox-fNdb3CBK.js";
import { f as renderExecTargetLabel } from "./bash-tools.exec-runtime-Cmk75qPp.js";
...
import { i as resolveModelsCommandReply } from "./commands-models-Bh4BJhd9.js";
import { n as resolveSelectedAndActiveModel } from "./model-runtime-CT6T4rg0.js";
import { a as formatElevatedUnavailableText, c as formatInternalVerbosePersistenceDeniedText, d as applyModelRuntimeDirective, f as resolveModelRuntimeDirective, i as formatElevatedRuntimeHint, l as resolveDirectiveTouchedSessionFields, n as enqueueModeSwitchEvents, o as formatInternalExecPersistenceDeniedText, r as formatDirectiveAck, s as formatInternalVerboseCurrentReplyOnlyText, t as canPersistSessionDirectiveDefaults, u as withOptions } from "./directive-handling.shared-Gyu1Qbzl.js";
import { r as formatRemainingShort } from "./auth-health-1Cq6fRMd.js";
...
async function handleDirectiveOnly(params) {
	...
	if (modelSelection && isModelSelectionLocked(sessionEntry)) return { text: MODEL_SELECTION_LOCKED_MESSAGE };
	...
	if (directives.hasThinkDirective && !directives.thinkLevel && !directives.clearThinkLevel) {
		if (!directives.rawThinkLevel) return { text: withOptions(`Current thinking level: ${resolveSupportedThinkingLevel({
			provider: resolvedProvider,
			model: resolvedModel,
		...
		return { text: `Unrecognized thinking level "${directives.rawThinkLevel}". Valid levels: default, ${formatThinkingLevels(resolvedProvider, resolvedModel, ", ", thinkingCatalog, thinkingRuntime)}.` };
	}
	...
	if (directives.hasThinkDirective && directives.thinkLevel && !isThinkingLevelSupported({
		...
		catalog: thinkingCatalog,
		agentRuntime: thinkingRuntime
	})) return { text: `Thinking level "${directives.thinkLevel}" is not supported for ${resolvedProvider}/${resolvedModel}. Use one of: ${formatThinkingLevels(resolvedProvider, resolvedModel, ", ", thinkingCatalog, thinkingRuntime)}.` };
	...
	if (shouldPersistSessionEntry) {
		...
		if (storePath) {
			...
			if (persistence.status === "current") {
				...
				if (modelSelection) modelSelectionApplied = sessionChangesApplied && sessionModelOverrideChangesApplied({
					initial: initialSessionEntry,
					next: sessionEntry,
					current: persistedEntry,
					reassertLiveModelSwitchPending: modelSelectionUpdated && sessionEntry.liveModelSwitchPending === true
