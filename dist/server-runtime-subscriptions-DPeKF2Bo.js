...
import { b as onAgentRuntimeEvent, i as clearAgentRunContext, v as onAgentAuditEvent } from "./agent-events-Dg0sI2pr.js";
import { i as onSessionLifecycleEvent } from "./session-lifecycle-events-FRp1oGK4.js";
...
import { a as mergeAgentRunTerminalOutcome, n as buildAgentRunTerminalOutcome, o as normalizeAgentRunTimeoutPhase } from "./agent-run-terminal-outcome-C9geO1r1.js";
import { r as onTrustedMessageAuditEvent } from "./message-audit-events-jhQCeoBu.js";
import { r as onHeartbeatEvent } from "./heartbeat-events-DlVntfRX.js";
import { c as removeChatAbortControllerEntry } from "./chat-abort-BKKIixKZ.js";
import { r as resolveVisibleActiveSessionRunState } from "./session-active-runs-D3GwYcBp.js";
import { t as mapTaskSummary } from "./task-summary-Bpwrjvbe.js";
...
function startGatewayEventSubscriptions(params) {
	...
	const agentEventHandlerLoader = createLazyPromiseLoader(() => {
		return Promise.all([import("./server-chat-atodCsxY.js"), import("./server-session-key-D_WfklxT.js")]).then(([{ createAgentEventHandler }, { resolveSessionKeyForRun }]) => createAgentEventHandler({
	...
	const getSessionEventsModule = createLazyPromise(() => import("./server-session-events-CUZZYPnZ.js"), { cacheRejections: true });
	...
	const taskObserverRuntimePromise = import("./task-registry.store-C85hDyo_.js").then((module) => {
