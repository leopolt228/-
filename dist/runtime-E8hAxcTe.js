...
import { t as assertMediaNotDataUrl } from "./sandbox-paths-DEm0iftP.js";
import { _ as readStringParam, c as parseAvailableTags, d as readNonNegativeIntegerParam, h as readStringArrayParam, m as readReactionParams, p as readPositiveIntegerParam } from "./common-C39GdgQ7.js";
...
import { a as withNormalizedTimestamp } from "./date-time-BhYZ-ADP.js";
import "./runtime-group-policy-CXo40VxH.js";
import "./account-resolution-DWTS6EOM.js";
import { a as mergeDiscordAccountConfig, o as resolveDefaultDiscordAccountId, t as createDiscordActionGate } from "./accounts-sZJTKxVc.js";
import { Bt as ChannelType, Yt as PermissionFlagsBits } from "./discord-BO4_MvbK.js";
import { _ as getGateway, c as hasAnyGuildPermissionDiscord, f as createDiscordRuntimeAccountContext, i as fetchChannelPermissionsDiscord, l as isThreadChannelType$1, n as canManageGuildRoleDiscord, s as hasAnyChannelPermissionDiscord, t as canManageGuildMemberRoleDiscord } from "./send.permissions-BhFjVFcq.js";
...
import { a as normalizeDiscordSlug, c as resolveDiscordChannelConfigWithFallback, n as isDiscordGroupAllowedByPolicy, v as resolveGroupDmAllow } from "./allow-list-CB_R7CMq.js";
import { n as resolveDiscordChannelId } from "./target-parsing-BJUDamFJ.js";
import { d as resolveDiscordTargetChannelId } from "./send.shared-p57jtR08.js";
import { n as createReusableDiscordReplyReference } from "./chunk-DCIBMoLK.js";
import { n as sendPollDiscord, r as sendStickerDiscord, t as sendMessageDiscord } from "./send.outbound-CJThfrn0.js";
import { n as getPresence } from "./presence-cache-z1N8MbJ3.js";
import { A as uploadStickerDiscord, C as listGuildChannelsDiscord, D as timeoutMemberDiscord, E as resolveEventCoverImage, F as removeChannelPermissionDiscord, I as setChannelPermissionDiscord, M as deleteChannelDiscord, N as editChannelDiscord, O as listGuildEmojisDiscord, P as moveChannelDiscord, S as kickMemberDiscord, T as removeRoleDiscord, _ as fetchChannelInfoDiscord, a as deleteMessageDiscord, b as fetchRoleInfoDiscord, c as listPinsDiscord, d as readMessagesDiscord, f as searchMessagesDiscord, g as createScheduledEventDiscord, h as banMemberDiscord, i as createThreadDiscord, j as createChannelDiscord, k as uploadEmojiDiscord, l as listThreadsDiscord, m as addRoleDiscord, o as editMessageDiscord, p as unpinMessageDiscord, r as DiscordThreadInitialMessageError, s as fetchMessageDiscord, t as sendVoiceMessageDiscord, u as pinMessageDiscord, v as fetchGuildInfoDiscord, w as listScheduledEventsDiscord, x as fetchVoiceStatusDiscord, y as fetchMemberInfoDiscord } from "./send-0-RM57Eq.js";
import { i as removeReactionDiscord, n as reactMessageDiscord, r as removeOwnReactionsDiscord, t as fetchReactionsDiscord } from "./send.reactions-ArbA4fU1.js";
import "./targets-DgL1mmXR.js";
//#region extensions/discord/src/actions/runtime-deps.ts
...
const DISCORD_AUTO_ARCHIVE_MINUTES = /* @__PURE__ */ new Set([
	60,
	1440,
	4320,
	10080
...
*/
function readDiscordAutoArchiveDurationParam(params, key) {
	const value = readPositiveIntegerParam(params, key);
	if (value === void 0) return;
	if (!DISCORD_AUTO_ARCHIVE_MINUTES.has(value)) throw new Error(`${key} must be one of 60, 1440, 4320, or 10080 minutes`);
	return value;
}
...
function createDiscordMessagingActionContext(params) {
	...
	const directDmEnabled = accountConfig.dm?.enabled !== false && (accountConfig.dmPolicy ?? "pairing") !== "disabled";
	...
	switch (ctx.action) {
		...
		case "threadCreate": {
			...
			const payload = {
				name,
				messageId,
				autoArchiveMinutes: readDiscordAutoArchiveDurationParam(ctx.params, "autoArchiveMinutes"),
				content,
...
//#endregion
export { readDiscordAutoArchiveDurationParam as a, readDiscordChannelMoveParams as c, requiredGuildPermissionForModerationAction as i, readDiscordParentIdParam as l, isDiscordModerationAction as n, readDiscordChannelCreateParams as o, readDiscordModerationCommand as r, readDiscordChannelEditParams as s, handleDiscordAction as t };
