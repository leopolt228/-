...
type OAuthCredentials = {
  ...
  projectId?: string;
  accountId?: string;
  chatgptPlanType?: string; /** Non-secret subscription plan captured from external CLI logins (e.g. "max"). */
  subscriptionType?: string; /** Non-secret rate-limit tier captured from external CLI logins (e.g. "default_max_20x"). */
...
//#endregion
export { AuthProfileStore as a, AuthProfileFailureReason as i, AuthProfileBlockedSource as n, OAuthCredential as o, AuthProfileCredential as r, OAuthProvider as s, ApiKeyCredential as t };