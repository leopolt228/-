...
import { S as resolveGoogleGemini3ThinkingLevel } from "../../provider-stream-shared-BiURRLUJ.js";
import "../../string-coerce-runtime-DBMkn-gE.js";
import "../../number-runtime-C6TGSEc_.js";
import "../../runtime-env-BDC_axp1.js";
import "../../secret-input-Dzjaaiwk.js";
import { B as REALTIME_VOICE_AUDIO_FORMAT_G711_ULAW_8KHZ, V as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, m as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME } from "../../session-log-runtime-GBoG4Ecc.js";
import "../../realtime-voice-D9eMvxKo.js";
import { a as mulawToPcm, i as convertPcmToMulaw8k, s as resamplePcm } from "../../audio-energy-B9uVXLa_.js";
...
var GoogleRealtimeVoiceBridge = class {
	...
	async connect() {
		...
		if (this.hasConnectedSession && !canResumeSession) this.resetPendingTranscripts();
		this.intentionallyClosed = false;
		this.sessionConfigured = false;
		this.sessionReadyFired = false;
		this.consecutiveSilenceMs = 0;
	...
	submitToolResult(callId, result, options) {
		...
		try {
			...
			if (options?.willContinue === true && !this.supportsToolResultContinuation) {
				this.config.onError?.(/* @__PURE__ */ new Error(`Google Live model ${this.model} does not support continuing tool responses`));
				return;
			}
	...
	handleServerContent(content) {
		...
		if (content.outputTranscription) this.appendTranscript("assistant", content.outputTranscription);
