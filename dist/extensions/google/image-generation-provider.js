...
import { l as resolveInlineImageJsonResponseMaxBytes, n as generatedImageAssetFromBase64 } from "../../image-generation-pAFfF0km.js";
...
function buildGoogleImageGenerationProvider() {
	return {
		...
		isConfigured: ({ cfg, agentDir }) => hasConfiguredSecretInput(cfg?.models?.providers?.google?.apiKey) || isProviderApiKeyConfigured({
			provider: "google",
			agentDir
		}),
		capabilities: {
