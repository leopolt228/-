...
import { i as resolveGoogleChromeExecutableForPlatform, n as readBrowserVersion, r as resolveBrowserExecutableForPlatform, t as parseBrowserMajorVersion } from "../../chrome.executables-GOH5mZp7.js";
import { t as movePathToTrash } from "../../trash-CPISlM1A.js";
import "../../record-shared-CyHusTXE.js";
import { n as listSystemProfiles } from "../../system-profiles-CHPEDDz6.js";
...
function isLegacyClawdProfileConfigured(cfg, legacyProfileDir) {
	...
	if (Object.hasOwn(configuredProfiles, LEGACY_CLAWD_BROWSER_PROFILE_NAME)) return true;
...
async function noteChromeMcpBrowserReadiness(cfg, deps) {
	...
	if (platform === "darwin") {
		...
		const systemProfileCount = [
			...
			"edge",
			"chromium"
		].reduce((count, browser) => count + listSystemProfiles(browser, { homeDir: deps?.homeDir }).filter((profile) => profile.hasCookies).length, 0);
		noteFn([
