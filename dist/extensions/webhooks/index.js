...
import { At as boolean, Bt as discriminatedUnion, Ln as strictObject, Nn as record, Rn as string, Tn as object, Xn as union, dn as literal, on as json, wn as number, yt as _enum } from "../../schemas-CBJjibl3.js";
...
import { d as withResolvedWebhookRequestPipeline, l as resolveWebhookTargetWithAuthOrRejectSync, t as normalizeWebhookPath } from "../../webhook-targets-D0QbJdTx.js";
import "../../api-DLQnVoEz.js";
...
const webhookActionSchema = discriminatedUnion("action", [
	...
	strictObject({ action: literal("list_flows") }),
	strictObject({ action: literal("find_latest_flow") }),
	strictObject({
			...
			handle: async ({ targets }) => {
				...
				const target = resolveWebhookTargetWithAuthOrRejectSync({
					...
					isMatch: (candidate) => {
						...
						return typeof candidate.secretInput === "string" && safeEqualSecret(candidate.secretInput, presentedSecret);
					}
				});
