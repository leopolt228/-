...
type NotifySubscription = {
  ...
  addedAtMs: number; /** Unique for new arms; absent only on subscriptions imported from legacy state. */
  armId?: string;
};
