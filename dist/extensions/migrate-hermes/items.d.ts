...
declare const HERMES_REASON_MODEL_PROVIDER_CONFLICT = "model provider config conflict";
...
declare function findHermesModelProviderDependency(items: MigrationItem[], model: string): MigrationItem | undefined;
