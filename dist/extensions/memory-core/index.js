...
import { t as registerShortTermPromotionDreaming } from "../../dreaming-xl2Me5i6.js";
...
const loadMemoryToolsModule = createLazyRuntimeModule(() => import("../../tools-C_iwiky-.js"));
const loadRuntimeProviderModule = createLazyRuntimeModule(() => import("../../runtime-provider-C3TK-sxx.js"));
	...
	register(api) {
		...
		api.registerMemoryCapability({
			...
			publicArtifacts: { async listArtifacts(params) {
				const { listMemoryCorePublicArtifacts } = await import("../../public-artifacts-DFKckwQk.js");
		...
		api.registerCommand({
			...
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-BxQ5BK7N.js");
