...
import { B as ZodLiteral, C as ZodEnum, Mi as output, Q as ZodOptional, Y as ZodNumber, Z as ZodObject, bt as ZodUnion, c as ZodBoolean, ea as $catchall, it as ZodRecord, na as $strip, q as ZodNull, r as ZodArray, st as ZodString, ta as $strict, v as ZodDefault, xt as ZodUnknown, y as ZodDiscriminatedUnion } from "../../schemas-CL7kuExa.js";
import { Ei as RealtimeVoiceProviderConfig, Kn as PluginRuntime, Pi as RealtimeTranscriptionProviderConfig, ei as RealtimeTranscriptionProviderPlugin, es as TtsDirectiveOverrides, ti as RealtimeVoiceProviderPlugin, ts as TtsDirectiveParseResult } from "../../types-Bi5Leigi.js";
import { u as SessionScope } from "../../types-D43pE80v.js";
import { Zt as TalkEvent } from "../../diagnostic-events-D5MV3iZe.js";
import { g as OpenClawPluginApi } from "../../plugin-entry-Bj-pdgAt.js";
import { u as TtsConfigSchema } from "../../zod-schema.core-D3ggeDhC.js";
...
declare const NormalizedEventSchema: ZodDiscriminatedUnion<[ZodObject<{
  ...
  from: ZodOptional<ZodString>;
  to: ZodOptional<ZodString>;
  type: ZodLiteral<"call.assistant-speech">;
...
type PlayTtsInput = {
  ...
  text: string;
  voice?: string;
  locale?: string; /** Keep collecting speech after playback when the provider owns the listening XML. */
...
type OutboundCallOptions = {
  ...
  requesterSessionKey?: string; /** Agent selected for this call instead of the plugin default. */
  agentId?: string;
};
//#endregion
...
//#endregion
//#region extensions/voice-call/src/manager/events.d.ts
...
//#endregion
//#region extensions/voice-call/src/manager/outbound.d.ts
type SpeakOptions = {
  listenAfterPlayback?: boolean;
};
//#endregion
...
declare class CallManager {
   ...
   */
  speak(callId: CallId, text: string, options?: SpeakOptions): Promise<{
    success: boolean;
    error?: string;
  }>;
  /**
  ...
  getCallFromMemoryOrStore(callId: CallId): Promise<CallRecord | undefined>;
  /**
...
type VoiceCallStateRuntime = {
  state: Pick<PluginRuntime["state"], "resolveStateDir" | "openKeyedStore" | "openSyncKeyedStore" | "openChannelIngressQueue" | "openChannelIngressDrain">;
};
//#endregion
...
declare class RealtimeCallHandler {
  ...
  private readonly resolveInstructions?;
  ...
  private readonly rawPartialUserTranscriptsByCallId;
  ...
  constructor(config: VoiceCallRealtimeConfig, manager: CallManager, provider: VoiceCallProvider, realtimeProvider: RealtimeVoiceProviderPlugin, providerConfig: RealtimeVoiceProviderConfig, servePath: string, coreConfig?: OpenClawConfig | undefined, resolveInstructions?: ((call: CallRecord) => string) | undefined);
  setPublicUrl(url: string): void;
...
declare class VoiceCallWebhookServer {
  ...
  private processEventWithAutoResponse;
