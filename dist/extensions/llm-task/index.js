...
import "../../json-schema-runtime-l8iq8m93.js";
...
import { t as defineToolPlugin } from "../../tool-plugin-BvheByey.js";
import "../../api-sL6vRe-r.js";
...
var llm_task_default = defineToolPlugin({
	...
	configSchema: Type.Object({
		...
		allowedModels: Type.Optional(Type.Array(Type.String(), { description: "Allowlist of provider/model keys like openai/gpt-5.6-sol." })),
