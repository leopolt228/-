...
import { T as createReplyToFanout, _ as sendPayloadMediaSequence, p as resolvePayloadMediaUrls } from "./reply-payload-CPcXnHho.js";
...
import { a as sendMessageMatrix, l as sendTypingMatrix, o as sendPollMatrix } from "./send-BMVEUqQv.js";
import { t as isBunRuntime } from "./runtime-BefyhPWv.js";
import { n as resolveMatrixAuth } from "./config-CrspAanc.js";
import "./client-HJAK3fwW.js";
import { n as listMatrixDirectoryPeersLive, t as listMatrixDirectoryGroupsLive } from "./directory-live-C3P7YR4d.js";
...
const loadMatrixProbeRuntimeDeps = createLazyRuntimeModule(() => import("./probe.runtime-Cc5udAO1.js").then((runtimeModule) => ({ createMatrixClient: runtimeModule.createMatrixClient })));
...
const matrixChannelRuntime = {
	...
	matrixOutbound: {
		...
		sendText: async ({ cfg, to, text, deps, replyToId, threadId, accountId, audioAsVoice, onDeliveryResult }) => {
		...
		sendMedia: async ({ cfg, to, text, mediaUrl, mediaLocalRoots, mediaReadFile, deps, replyToId, threadId, accountId, audioAsVoice, onDeliveryResult }) => {
			const result = await (resolveOutboundSendDep(deps, "matrix") ?? sendMessageMatrix)(to, text, {
				cfg,
				mediaUrl,
				mediaLocalRoots,
