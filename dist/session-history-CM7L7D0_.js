...
import { c as selectSessionTranscriptLeafControlledPath, o as parseSessionTranscriptTreeEntry, s as scanSessionTranscriptTree } from "./transcript-tree-DuZTyiYZ.js";
import { d as parseSessionEntries, l as migrateSessionEntries } from "./session-manager-Ofb7FHrt.js";
...
import { c as isToolCallBlock, l as resolveToolUseId, r as readClaudeCliFallbackSeed } from "./cli-session-history.claude-q5_fT1P_.js";
import { v as cliBackendLog } from "./helpers-CH03IdKf.js";
import "./cli-session-history--pmepZi4.js";
...
function buildCliSessionHistoryPrompt(params) {
	...
	const renderTruncatedSummaryWithTail = (renderedSummary) => {
		...
		const summaryTruncated = truncateUtf16Safe(renderedSummary, Math.max(0, maxHistoryChars - 56 - separatorBudget - tailBudget)).trimEnd();
