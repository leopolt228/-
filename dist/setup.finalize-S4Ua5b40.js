...
import { l as pathExists } from "./utils-K2PjeLaV.js";
import { o as isSystemdUserServiceAvailable } from "./systemd-iYtBw5_g.js";
...
import { n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-GYctLxSN.js";
...
import { i as hasAuthProfileForProvider } from "./model-config.helpers-B_iHOOMM.js";
import { r as listConfiguredWebSearchProviders } from "./runtime-DYwYEdrm.js";
import { a as installCompletion, i as formatCompletionReloadCommand, l as resolveCompletionProfilePath } from "./completion-runtime-qXZnRNdo.js";
...
import { a as formatControlUiSshHint, f as probeGatewayReachable, g as waitForGatewayReachable, r as buildOnboardingControlUiUrl } from "./onboard-helpers-p2UlKv8D.js";
...
import { t as launchTuiCli } from "./tui-launch-2dTsmkcI.js";
...
async function startSessionGatewayForOnboarding(params) {
	...
	try {
		const { startGatewayServer } = await import("./server-ReArp9C2.js");
...
const loadOnboardSearchModule = createLazyRuntimeModule(() => import("./onboard-search-D3ZkmVA9.js"));
/**
...
async function finalizeSetupWizard(options) {
	...
	try {
		...
		const [{ resolveDefaultModelAuthStatus, resolveDefaultModelCatalogFacts }, { loadPreparedModelCatalogSnapshot }] = await Promise.all([import("./auth-choice-CsMGvpSY.js"), import("./prepared-model-catalog-C7ceMjSu.js")]);
