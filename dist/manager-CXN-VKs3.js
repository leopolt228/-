...
import { a as toAcpRuntimeError, n as AcpRuntimeError, o as withAcpRuntimeErrorBoundary, r as formatAcpErrorChain, t as ACP_ERROR_CODES } from "./errors-C7_LR8fF.js";
...
import { E as parseAgentSessionKey, b as isAcpSessionKey, l as normalizeMainKey } from "./session-key-Drrs61Fd.js";
...
import { a as buildRuntimeConfigOptionPairs, c as mergeRuntimeOptions, d as resolveRuntimeConfigOptionKey, f as resolveRuntimeOptionsFromMeta, g as validateRuntimeModeInput, i as resolveTurnTimeoutMs, l as normalizeRuntimeOptions, m as validateRuntimeConfigOptionInput, n as awaitTurnWithTimeout, o as buildRuntimeControlSignature, p as runtimeOptionsEqual, r as cleanupTimedOutTurn, s as inferRuntimeOptionPatchFromConfigOption, v as validateRuntimeOptionPatch } from "./manager.turn-timeout-BinyBw3X.js";
import { d as recordSessionHumanDirectMessage, m as recordSubagentTerminalState } from "./session-state-events-BG_mebdA.js";
import { i as failTaskRunByRunId, r as createRunningTaskRun, t as completeTaskRunByRunId, u as startTaskRunByRunId } from "./detached-task-runtime-BoSSz2n3.js";
import { n as resolveRequiredCompletionTerminalResult } from "./task-completion-contract-CVdE344F.js";
import { r as requireAcpRuntimeBackend, t as getAcpRuntimeBackend } from "./registry-B_cKoV-_.js";
import { n as readAcpSessionEntry, s as upsertAcpSessionMeta, t as listAcpSessionEntries } from "./session-meta-BBWApx8c.js";
...
const THINKING_CONFIG_KEYS = /* @__PURE__ */ new Set([
	"thinking",
	"effort",
	"reasoning_effort",
	"thought_level"
...
function isThinkingConfigKey(key) {
			...
			if (configOptions.length > 0) {
				...
				for (const [key, value] of configOptions) {
					...
					try {
						...
						if (isUnsupportedOptionalTimeoutConfigRejection(key, error) || isThinkingConfigKey(key) && isUnsupportedControlRejection(error)) continue;
						throw error;
					}
				}
			}
...
function resolveBackgroundTaskContext(params) {
	...
	return {
		requesterSessionKey,
		requesterOrigin: (params.deps.loadSessionEntry({
			cfg: params.cfg,
...
//#endregion
export { resolveAcpSessionResolutionError as a, isAcpTurnActive as i, testing as n, AcpSessionManager as r, getAcpSessionManager as t };
