...
import { n as UserTurnTranscriptRecorder } from "./user-turn-transcript.types-CKMcFFg2.js";
...
type GetReplyOptions = {
  ...
  userTurnTranscriptRecorder?: UserTurnTranscriptRecorder; /** Current user turn is already durable; replay it without appending another copy. */
  ...
  commentaryPayloadsEnabled?: boolean; /** Called when the agent emits a structured plan update. */
  ...
  onQueuedFollowupAdmitted?: () => Promise<void> | void; /** Allow channel-owned progress UI while final/source reply delivery remains message-tool-only. */
...
//#endregion
export { TaskSuggestionDeliveryMode as a, PromptImageOrderEntry as c, ReplyThreadingPolicy as i, GetReplyOptions as n, TurnAdoptionLifecycle as o, PartialReplyPayload as r, TypingController as s, BlockReplyContext as t };