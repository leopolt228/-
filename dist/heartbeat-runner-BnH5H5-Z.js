...
import { C as isSubagentSessionKey, E as parseAgentSessionKey, d as resolveAgentIdFromSessionKey, v as toAgentStoreSessionKey } from "./session-key-Drrs61Fd.js";
import { c as resolveDefaultAgentId, n as listAgentIds, o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-S7z_Yn4H.js";
import { r as getRuntimeConfig } from "./io-CEgS2K9F.js";
import { c as resolveSafeTimeoutDelayMs, r as MAX_SAFE_TIMEOUT_DELAY_MS } from "./timeouts-CThCRo6Z.js";
import { S as resolveModelRefFromString } from "./model-selection-shared-CPPxIJAX.js";
import "./config-BOMcY2yX.js";
import { r as loadOrCreateDeviceIdentity } from "./device-identity-cacJqJr9.js";
...
import { St as patchSessionEntry, nt as applySessionEntryLifecycleMutation, vt as loadExactSessionEntry, yt as loadSessionEntry } from "./session-accessor-Mu3lv_Tl.js";
...
import { r as DEFAULT_HEARTBEAT_FILENAME } from "./workspace-GYctLxSN.js";
import { a as isRetryableHeartbeatBusySkipReason, i as areHeartbeatsEnabled, n as HEARTBEAT_SKIP_LANES_BUSY, o as requestHeartbeat, r as HEARTBEAT_SKIP_REQUESTS_IN_FLIGHT, s as setHeartbeatWakeHandler, t as HEARTBEAT_SKIP_CRON_IN_PROGRESS } from "./heartbeat-wake-CH_r-5du.js";
import { f as resolveSystemEventDeliveryContext, l as peekSystemEventEntries, t as consumeSelectedSystemEventEntries } from "./system-events-BNfyhKS3.js";
import { S as replyRunRegistry, b as listActiveReplyRunSessionKeys } from "./reply-run-registry-BSL8NJYn.js";
import { p as listActiveEmbeddedRunSessionKeys } from "./run-state-D28kFtJW.js";
import { t as HEARTBEAT_TOKEN } from "./tokens-DKI4eGAu.js";
import { r as resolveEffectiveAgentRuntime } from "./thinking-runtime-g8O2MT43.js";
import { m as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent, u as isReasoningReplyPayload } from "./reply-payload-CPcXnHho.js";
import { c as parseHeartbeatTasks, d as stripHeartbeatToken, l as resolveHeartbeatPrompt$1, o as isHeartbeatContentEffectivelyEmpty, s as isTaskDue, u as resolveHeartbeatPromptForResponseTool } from "./heartbeat-Bkwxbekw.js";
import { n as resolveResponsePrefixTemplate } from "./response-prefix-template-DdRpfl7D.js";
import { r as buildRecoverablePendingFinalDeliveryText } from "./pending-final-delivery-C3iA5iUb.js";
import { a as hasActiveCronJobsExceptMarker, i as hasActiveCronJobs, o as isCronActiveJobMarkerCurrent } from "./active-jobs-BSWUEHJl.js";
import { c as getQueueSize, s as getCommandLaneSnapshots, u as isCommandLaneTaskMarkerCurrent } from "./command-queue-B2fMJE4M.js";
import { t as buildOutboundSessionContext } from "./session-context-Cq_Z7k0n.js";
import { a as getHeartbeatToolNotificationText, s as resolveHeartbeatToolResponseFromReplyResult } from "./heartbeat-tool-response-B3cJVfMo.js";
...
import { n as resolveHeartbeatDeliveryTargetWithSessionRoute, r as resolveHeartbeatSenderContext } from "./targets-B6GGowJc.js";
import { r as persistHeartbeatOutcome } from "./heartbeat-outcome-store-BWc9I4Il.js";
import { n as resolveHeartbeatIntervalMs, t as isHeartbeatEnabledForAgent } from "./heartbeat-summary-D8_NFvmx.js";
...
import { a as isRelayableExecCompletionEvent, i as isExecCompletionEvent, n as buildExecEventPrompt, r as isCronSystemEvent, t as buildCronEventPrompt } from "./heartbeat-events-filter-CwG3RmMF.js";
...
import { n as resolveCronSession } from "./session-BU2LrFuw.js";
import { n as resolveHeartbeatTerminalToolFailure, t as resolveHeartbeatReplyPayload } from "./heartbeat-reply-payload-JL317T9d.js";
...
import { a as markCommitmentsAttempted, n as listDueCommitmentSessionKeys, o as markCommitmentsStatus, r as listDueCommitmentsForSession } from "./store-tti8aokW.js";
import { a as resolveIndicatorType, t as emitHeartbeatEvent } from "./heartbeat-events-DlVntfRX.js";
...
function resolveHeartbeatSession(cfg, agentId, heartbeat, forcedSessionKey) {
	...
	const storePath = resolveStorePath(sessionCfg?.store, { agentId: resolvedAgentId });
...
async function resolveHeartbeatPreflight(params) {
	...
	try {
		heartbeatFileContent = (await readRegularFile({
			filePath: await fs.realpath(heartbeatFilePath),
		...
		if (err instanceof Error && err.message.startsWith("File exceeds")) log.warn(`heartbeat: skipping oversized ${DEFAULT_HEARTBEAT_FILENAME}: ${err.message}`);
	}
...
async function runHeartbeatOnce(opts) {
	...
	const cronLaneBusy = getSize("cron") > (ownsCronLaneTask ? 1 : 0) || getSize("cron-nested") > 0;
	...
	const clearSatisfiedPendingFinalDelivery = async (expectedText) => {
		await patchSessionEntry({
			...
			if (expectedText !== void 0 && normalizeOptionalString(current.pendingFinalDeliveryText) !== expectedText) return null;
	...
	try {
		...
		if (heartbeatTerminalToolFailure) {
			...
			const terminalPendingFinalText = replyPayload ? buildRecoverablePendingFinalDeliveryText([replyPayload]) : void 0;
		...
		if (visibleSendSucceeded && !shouldSkipMain && normalized.text.trim()) await patchSessionEntry({
			storePath,
			sessionKey
		}, (current, context) => {
			if (!context.existingEntry) return null;
...
//#endregion
export { testing as i, runHeartbeatOnce as n, startHeartbeatRunner as r, resolveHeartbeatPrompt as t };
