...
import { p as finiteSecondsToTimerSafeMilliseconds, y as parseStrictNonNegativeInteger } from "./number-coercion-Crk_c9KW.js";
...
import { At as boolean, Et as array, Rn as string, Tn as object, Zn as unknown, wn as number } from "./schemas-CBJjibl3.js";
...
import { i as createHybridChannelConfigAdapter, l as createScopedDmSecurityResolver } from "./channel-config-helpers-BFvX3ldW.js";
...
import { N as projectAccountConfigWarningCollector, P as projectAccountWarningCollector, k as createConditionalWarningCollector, w as composeWarningCollectors } from "./channel-policy-DtbLL_f5.js";
...
import { a as createWebhookInFlightLimiter, i as beginWebhookRequestPipelineOrReject } from "./webhook-request-guards-BwB_e49u.js";
import { a as createFixedWindowRateLimiter } from "./webhook-ingress-0GWTUyGu.js";
import { t as registerPluginHttpRoute } from "./http-registry-wH4gRLLj.js";
import { i as resolveAccount, n as synologyChatSetupWizard, r as listAccountIds, t as synologyChatSetupAdapter } from "./setup-surface-BTWQVtpD.js";
...
const SYNOLOGY_INGRESS_PRUNE_INTERVAL_MS = 3600 * 1e3;
const SYNOLOGY_INGRESS_MAX_CONCURRENT_DELIVERIES = 8;
const SYNOLOGY_INGRESS_COMPLETED_TTL_MS = 720 * 60 * 60 * 1e3;
const SYNOLOGY_INGRESS_COMPLETED_MAX_ENTRIES = 2e4;
const SYNOLOGY_INGRESS_FAILED_TTL_MS = 720 * 60 * 60 * 1e3;
const SYNOLOGY_INGRESS_FAILED_MAX_ENTRIES = 2e4;
var SynologyIngressPermanentError = class extends Error {
...
function createSynologyIngressMonitor(options) {
	...
	return {
		receive: async (rawEvent) => {
			if (!monitor.isRunning()) throw new Error("Synology Chat ingress is stopped.");
			let facts;
			try {
				facts = inspectSynologyIngressEvent(rawEvent);
			} catch (error) {
				if (error instanceof SynologyIngressPermanentError) return {
					kind: "invalid",
