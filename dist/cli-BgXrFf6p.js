...
import { P as timestampMsToIsoString, v as parseStrictInteger } from "./number-coercion-Crk_c9KW.js";
...
import { n as updateMatrixAccountConfig, t as resolveMatrixConfigPath } from "./config-update-C-pv6HRH.js";
import { n as matrixSetupAdapter } from "./setup-core-DjROwU_q.js";
import { t as withResolvedActionClient } from "./client-DH3ohVuB.js";
import { r as resolveMatrixAuthContext } from "./config-CrspAanc.js";
...
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-iSzZbrGr.js";
...
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-CEiCkQM2.js";
...
const loadMatrixActionClientModule = createLazyRuntimeModule(() => import("./client-BcycwJWi.js"));
const loadMatrixDirectManagementModule = createLazyRuntimeModule(() => import("./direct-management-DzIF7Hg_.js"));
...
async function readMatrixCliRecoveryKeyFromStdin() {
	const recoveryKey = (await readByteStreamWithLimit(process.stdin, {
		maxBytes: MATRIX_CLI_RECOVERY_KEY_STDIN_MAX_BYTES,
		onOverflow: ({ maxBytes }) => /* @__PURE__ */ new Error(`Matrix recovery key stdin exceeds ${maxBytes} bytes.`)
	})).toString("utf8").trim();
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-DS1z_cSe.js");
