...
import { i as resolveSafeInstallDir, n as unscopedPackageName } from "./install-safe-path-BwgrzVcF.js";
...
import "./manifest-FKjShfr0.js";
import { i as detectBundleManifestFormat } from "./bundle-manifest-BaKN9mzB.js";
import { o as scanInstalledPackageDependencyTree, s as scanPackageInstallSource } from "./install-security-scan-D_fqlETr.js";
import { t as parseFrontmatter } from "./frontmatter-BCE8gS7_.js";
import path from "node:path";
//#region src/hooks/install.ts
const HOOK_MD_MAX_BYTES = 1024 * 1024;
const loadHookInstallRuntime = createLazyRuntimeModule(() => import("./install.runtime-DevNH35f.js"));
...
async function resolveHookNameFromDir(hookDir) {
	...
	return parseFrontmatter(buffer.toString("utf-8")).name || path.basename(hookDir);
}
