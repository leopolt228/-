...
import { f as resetPublishedConfigRuntimeEnv, p as ALLOW_OLDER_BINARY_DESTRUCTIVE_ACTIONS_ENV } from "./config-env-vars-9fUuyise.js";
...
import { t as enforceGatewayRunFutureConfigGuard } from "./future-config-guard-BOi_RVwh.js";
...
async function pinGatewayRunRuntimePaths() {
	const [{ pinRuntimePaths }, { pinConfigDir }] = await Promise.all([import("./paths-CPxATrhx.js"), import("./utils-BjfobC1H.js")]);
...
async function isSameGatewayRunConfigSnapshot(expected, current, options = {}) {
	const { hashRuntimeConfigValue } = await import("./runtime-snapshot-q4RW06DS.js");
...
async function guardGatewayRunSelectedConfig(params) {
	...
	const [path, { applyConfigEnvVars, isConfigRuntimeEnvVarAllowed }, { loadGlobalRuntimeDotEnvFiles }, { normalizeEnv }, { normalizeStateDirEnv, resolveStateDir }, { resolveConfigDir }] = await Promise.all([
		import("node:path"),
		import("./config-env-vars-Cfw-ZJvc.js"),
		import("./dotenv-global-Cdv-nRU9.js"),
		import("./env-DIlThYTX.js"),
...
async function prepareGatewayRunBootstrap(params) {
	...
	const { planPristineStartupConfigMigrations, planPristineStartupStateMigrations } = await import("./pristine-startup-state-C2Xk-nbU.js");
...
//#endregion
export { applyFinalGatewayRunConfigEnv, clearGatewayRunConfigEnvironment, prepareGatewayRunBootstrap, recheckGatewayRunBootstrap, recheckGatewayRunReset, reloadTrustedGatewayRunEnvironment, selectGatewayRunEnvironment, wasPreparedGatewayRunCoreStatePristine, wasPreparedGatewayRunStatePristine };
