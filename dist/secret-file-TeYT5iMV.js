...
import { n as runPinnedWriteHelper, u as resolveHomeRelativePath } from "./pinned-write-LKmJLX8O.js";
import { t as openPinnedFileSync } from "./pinned-open-CED4V9Dl.js";
...
function readSecretFileOutcomeSync(filePath, label, options = {}) {
	...
	try {
		...
		return {
			ok: false,
			code: error instanceof FsSafeError && error.code === "too-large" ? "too-large" : "invalid-path",
			error: normalized,
