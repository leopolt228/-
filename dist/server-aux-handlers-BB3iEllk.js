...
import { n as resolveSecretRefValue } from "./resolve-DhgogJwd.js";
import { i as resolveManifestContractOwnerPluginId } from "./plugin-registry-2gpKUE2T.js";
import { i as createResolverContext } from "./runtime-shared-BL5llIf5.js";
...
import { t as resolveChannelApprovalAdapter } from "./plugins-CJcRWm9n.js";
...
import { a as getActiveSecretsRuntimeEnv, c as getActiveSecretsRuntimeSnapshotRevision, s as getActiveSecretsRuntimeSnapshot } from "./runtime-state-DTHJs1uZ.js";
...
import { c as buildPluginApprovalRequestMessage, o as approvalDecisionLabel, s as buildPluginApprovalExpiredMessage } from "./plugin-approvals-D2muXfhg.js";
...
import { t as analyzeCommandSecretAssignmentsFromSnapshot } from "./command-config-D67CIqxS.js";
...
import { p as formatExecApprovalExpiresIn } from "./exec-approval-reply-DHhrBmrX.js";
import { i as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-Bs3wIn9d.js";
import { a as buildTypedApprovalPendingReplyPayload, i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, o as buildTypedPluginApprovalPendingReplyPayload } from "./approval-renderers-BM3Q3d_m.js";
import { l as listDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-DUA4LHep.js";
import { c as loadApnsRegistrations, h as resolveApnsRelayConfigFromEnv, r as clearApnsRegistrationIfCurrent } from "./push-apns-store-KXfXqjY4.js";
import { d as pruneTerminalOperatorApprovals, n as closeOrphanedOperatorApprovals } from "./operator-approval-store-DgskoN7_.js";
import { t as resolveApprovalSessionAudienceWithFallback } from "./approval-session-audience-CDTwB397.js";
import { t as SYSTEM_AGENT_APPROVAL_DECISIONS } from "./system-agent-approvals-BczGX_94.js";
import { a as sendApnsExecApprovalResolvedWake, c as shouldClearStoredApnsRegistration, i as sendApnsExecApprovalAlert, o as sendApnsPluginApprovalAlert, s as sendApnsPluginApprovalResolvedWake, t as resolveApnsAuthConfigFromEnv } from "./push-apns-Bu5h5nO7.js";
import { n as ExecApprovalManager } from "./exec-approval-manager-BE07NlLl.js";
import { t as QuestionManager } from "./question-manager-COK3zNCG.js";
...
function cancelRunBoundExecApprovals(params) {
	let cancelled = 0;
	for (const pending of params.manager.listPendingRecords()) {
		if (pending.request.runId !== params.runId) continue;
		const result = params.manager.forceDenyDetailed(pending.id, "run-aborted", {
			kind: "system",
			id: null
		}, "cancelled");
		if (result.outcome !== "denied" || !result.liveRecord) continue;
		cancelled += 1;
		publishAppliedApprovalResolution({
			...
			params.context.logGateway?.error?.(`exec approvals: run-abort publication failed: ${String(error)}`);
		});
	}
	return cancelled;
}
...
function createGatewayAuxHandlers(params) {
	...
	const cancelRunBoundApprovals = (runId, context) => cancelRunBoundExecApprovals({
		runId,
	...
	const loadExecApprovalHandlers = createLazyPromise(() => import("./exec-approval-CrHRG10L.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
		forwarder: execApprovalForwarder,
		iosPushDelivery: execApprovalIosPushDelivery
	})), { cacheRejections: true });
	const questionManager = new QuestionManager();
	const loadQuestionHandlers = createLazyPromise(() => import("./question-CIf5UhDq.js").then(({ createQuestionHandlers }) => createQuestionHandlers(questionManager)), { cacheRejections: true });
	...
	const loadPluginApprovalHandlers = createLazyPromise(() => import("./plugin-approval-CIfEkbpg.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, {
		forwarder: execApprovalForwarder,
		iosPushDelivery: pluginApprovalIosPushDelivery
	})), { cacheRejections: true });
	const loadApprovalHandlers = createLazyPromise(() => import("./approval-CsQ5Ns9V.js").then(({ createApprovalHandlers }) => createApprovalHandlers({
		execApprovalManager,
	...
	const loadSecretsHandlers = createLazyPromise(() => import("./secrets-Vs0EGxfh.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
			...
			try {
				for (;;) {
					...
					const prepared = await params.activateRuntimeSecrets(previousSnapshot.sourceConfig, {
						...
						canPublishFailureAsDegraded: () => getActiveSecretsRuntimeSnapshotRevision() === previousSnapshotRevision
					});
