...
import { r as buildConfiguredModelCatalog, y as resolveConfiguredModelRef } from "./model-selection-shared-CPPxIJAX.js";
...
import { s as formatFastModeValue } from "./fast-mode-CFWkImo-.js";
import { t as resolveFastModeState } from "./fast-mode-DLmTLUz8.js";
import { t as collectEnabledInsecureOrDangerousFlagsFromCurrentSnapshot } from "./dangerous-config-flags-current-ExokZh8J.js";
...
async function logGatewayStartup(params) {
	...
	const enabledDangerousFlags = collectEnabledInsecureOrDangerousFlagsFromCurrentSnapshot(params.cfg) ?? (await import("./dangerous-config-flags-BmE-4ZY3.js")).collectEnabledInsecureOrDangerousFlags(params.cfg);
...
async function collectConfiguredChannelStartupWarnings(params) {
	const [blockerModule, presencePolicyModule, pluginRegistryModule] = await Promise.all([
		import("./channel-plugin-blockers-PObpgN2f.js"),
		import("./channel-presence-policy-BixAUD17.js"),
		import("./plugin-registry-oxJDsekA.js")
	]);
