...
import { a as listThinkingLevels } from "./thinking-DDtbvjQ1.js";
import { t as BASE_THINKING_LEVELS } from "./thinking.shared-BWnbgBUO.js";
import { r as getActivePluginChannelRegistryVersionFromState } from "./runtime-channel-state-DFG20Bn5.js";
import { i as listLoadedChannelPlugins } from "./registry-loaded-BV9s-P0K.js";
import { l as resolveFastModeModelAutoOnSeconds, t as formatFastModeAutoLabel } from "./fast-mode-CFWkImo-.js";
...
function defineChatCommand(command) {
	...
	return {
		...
		nativeProviders: command.nativeProviders ? normalizeStringEntries(command.nativeProviders) : void 0,
	...
	const commands = [
		...
		defineChatCommand({
			...
			args: [{
				...
				type: "string",
				choices: ({ provider, model, catalog, agentRuntime }) => listThinkingLevelChoices(provider, model, catalog, agentRuntime)
			}],
			argsMenu: "auto"
		}),
		defineChatCommand({
...
//#endregion
export { shouldForwardModelCommandToServer as n, getChatCommands as t };
