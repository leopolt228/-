import { Hn as DiscordIntentsConfig, Mn as DiscordAccountConfig, Vn as DiscordGuildEntry, i as OpenClawConfig } from "./types.openclaw-DAPZkTyD.js";
...
import { n as RuntimeEnv$1 } from "./runtime-DRcp7-j9.js";
import { ps as ChannelIngressQueue } from "./types-Bi5Leigi.js";
import { _ as InboundEventKind } from "./templating-CzGprbNA.js";
...
import { l as NativeCommandSpec } from "./commands-registry.types-B_p0nGwG.js";
import { s as resolveAgentRoute } from "./resolve-route-yrQmlqjV.js";
import { n as ChannelMatchSource } from "./channel-config-BBLiKj96.js";
import { T as ChannelIngressMonitorLifecycle, w as ChannelIngressMonitorDeliveryResult } from "./channel-outbound-DzxDweud.js";
import { l as ThreadBindingManager } from "./thread-bindings.manager-D9sCrWEq.js";
import { $ as APIGatewayBotInfo, At as APIRole, B as APIGuildMemberAvatar, C as APIBaseMessage, Ct as ChannelType, Dt as VideoQualityMode, Et as ThreadChannelType, F as APIFlaggedGuildMember, G as GuildExplicitContentFilter, H as APIGuildMemberUser, I as APIGuild, J as GuildVerificationLevel, K as GuildMFALevel, L as APIGuildIntegration, M as APIBaseGuild, Mt as _NonNullableFields, N as APIBaseGuildMember, Nt as Snowflake, Ot as APIEmoji, P as APIBaseVoiceGuildMember, Q as StickerFormatType, R as APIGuildIntegrationType, St as APIThreadMember, T as APIMessage, Tt as TextChannelType, U as APIUnavailableGuild, V as APIGuildMemberJoined, W as GuildDefaultMessageNotifications, X as APISticker, Y as IntegrationExpireBehavior, _ as ApplicationCommandOptionType, _t as APIOverwrite, at as PresenceUpdateStatus, b as APIEntitlement, bt as APITextChannel, c as APIInteraction, ct as APIGroupDMChannel, dt as APIGuildForumDefaultReactionEmoji, et as GatewayActivity, f as ApplicationCommandType, ft as APIGuildForumTag, gt as APINewsChannel, ht as APIGuildVoiceChannel, it as GatewayThreadMembersUpdate, jt as _AddUndefinedToPossiblyUndefinedPropertiesOfInterface, kt as APIUser, lt as APIGuildCategoryChannel, m as APIApplicationCommandPermission, mt as APIGuildStageVoiceChannel, nt as GatewayPresenceUpdate, ot as APIAnnouncementThreadChannel, p as InteractionContextType, pt as APIGuildMediaChannel, q as GuildSystemChannelFlags, rt as GatewayThreadListSync, s as APIApplication, st as APIChannel, tt as GatewayGuildMembersChunkPresence, u as APIApplicationCommand, ut as APIGuildForumChannel, vt as APIPrivateThreadChannel, wt as GuildChannelType, x as APISubscription, xt as APIThreadChannel, yt as APIPublicThreadChannel, z as APIGuildMember } from "./send.shared-B9tglP0k.js";
import { a as APIGuildScheduledEventRecurrenceRule, c as GuildScheduledEventStatus, n as APIVoiceState, o as GuildScheduledEventEntityType, r as APIGuildScheduledEvent, t as APIBaseVoiceState } from "./voice-BqCzA7ym.js";
import { C as RequestClient, w as RequestClientOptions } from "./send.types-BrHT45LA.js";
import { c as AutocompleteInteraction, d as Message, f as User, i as BaseMessageInteractiveComponent, l as Guild, n as Modal, s as parseCustomId, u as GuildMember } from "./components.modal-BAErVd1x.js";
