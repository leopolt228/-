...
import { c as postJsonRequest, h as resolveProviderOperationTimeoutMs, i as fetchProviderDownloadResponse, l as postMultipartRequest, n as createProviderOperationDeadline, o as fetchWithTimeoutGuarded, p as resolveProviderHttpRequestConfig, r as createProviderOperationTimeoutResolver, s as pollProviderOperationJson } from "./shared-CpiwWgfg.js";
	...
	try {
		...
		return {
			buffer: await readResponseWithLimit(response, params.maxBytes, {
				timeoutMs,
				onTimeout: ({ timeoutMs: bodyTimeoutMs }) => /* @__PURE__ */ new Error(`OpenAI generated video download timed out after ${deadline.timeoutMs ?? bodyTimeoutMs}ms`),
				onOverflow: ({ maxBytes }) => /* @__PURE__ */ new Error(`OpenAI generated video download exceeds ${maxBytes} bytes`)
			}),
			mimeType,
