...
import { c as tryReadJson } from "./json--wG6OtAJ.js";
...
import { i as resolveSkillKey } from "./frontmatter-DtMv1fzk.js";
import { t as resolveSkillSource } from "./source-9Jdpd6BI.js";
import { t as findContainingAllowedSkillSymlinkTarget } from "./symlink-targets-hkpQUOjD.js";
...
function parseSkillProposalRecord(raw) {
	...
	if (record.schema !== "openclaw.skill-workshop.proposal.v1" || !PROPOSAL_ID_PATTERN.test(record.id) || record.kind !== "create" && record.kind !== "update" || ![
		...
		"quarantined",
		"stale"
	].includes(record.status) || typeof record.title !== "string" || typeof record.description !== "string" || typeof record.createdAt !== "string" || typeof record.updatedAt !== "string" || typeof record.draftHash !== "string" || record.draftFile !== PROPOSAL_DRAFT_FILE || !hasValidProposalOriginProvenance(record) || !isValidSupportFileList(record.supportFiles) || !record.target || typeof record.target !== "object" || typeof record.target.skillName !== "string" || typeof record.target.skillKey !== "string" || typeof record.target.skillDir !== "string" || typeof record.target.skillFile !== "string" || !record.scan || typeof record.scan !== "object") return null;
	return record;
}
...
//#endregion
export { readWorkspaceSupportFile as A, MAX_SKILL_PROPOSAL_ORIGIN_RUN_IDS as C, assertWorkspaceSkillWriteTarget as D, assertInsideWorkspace as E, normalizeSkillIndexName as F, canonicalizePath as I, formatPathRelativeToCwdOrAbsolute as L, buildSkillIndexEntries as M, filterPromptVisibleSkillEntries as N, normalizeWorkspaceSkillSupportPath as O, filterUserInvocableSkillEntries as P, isLocalPath as R, writeSkillProposalRollback as S, MAX_WORKSPACE_SKILL_SUPPORT_FILE_BYTES as T, replaceSkillProposalDraft as _, restoreCuratedSkill as a, withSkillProposalTargetLock as b, createSkillProposalId as c, prepareSkillProposalSupportFiles as d, readProposalSupportFiles as f, refreshSkillProposalManifest as g, readSkillProposalRecord as h, pinCuratedSkill as i, writeWorkspaceSkill as j, readWorkspaceSkillFile as k, createSkillProposalRollback as l, readSkillProposalManifest as m, getSkillCuratorDoctorWarning as n, startSkillCuratorMaintenance as o, readSkillProposal as p, getSkillCuratorStatus as r, unpinCuratedSkill as s, getArchivedSkillFiles as t, hashSkillProposalContent as u, resolveSkillProposalTarget as v, SKILL_WORKSHOP_SCHEMA as w, writeSkillProposal as x, updateSkillProposalRecord as y };
