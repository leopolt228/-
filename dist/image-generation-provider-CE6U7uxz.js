...
import { i as assertOkOrThrowProviderError, m as readProviderJsonResponse, r as assertOkOrThrowHttpError } from "./provider-http-errors-DrOMjuGn.js";
import { m as mergeSsrFPolicies } from "./ssrf-eKWXIRoD.js";
...
import { n as buildHostnameAllowlistPolicyFromSuffixAllowlist, u as ssrfPolicyFromDangerouslyAllowPrivateNetwork } from "./ssrf-policy-BcGHIF9t.js";
import "./ssrf-runtime-b7ye-Z-7.js";
import "./provider-http-D2uO-AEP.js";
import { a as imageFileExtensionForMimeType, d as toImageDataUrl } from "./image-generation-pAFfF0km.js";
import { t as resolveFalHttpRequestConfig } from "./http-config-CEvtJXuo.js";
...
if (process.env.VITEST === "true") {
	...
	Reflect.set(globalThis, key, {
		...api,
		setImageFetchGuard: setFalFetchGuardForTesting
	});
}
...
async function fetchImageBuffer(url, deadline, networkPolicy, maxBytes = DEFAULT_GENERATED_IMAGE_MAX_BYTES) {
	...
	return {
		...
		async generateImage(req) {
			...
			const { response, release } = await falFetchGuard({
				...
				timeoutMs: deadline.timeoutMs === void 0 ? void 0 : resolveProviderOperationTimeoutMs({
					deadline,
