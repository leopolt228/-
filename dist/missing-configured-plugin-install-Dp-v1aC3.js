...
import { c as readLegacyNpmPluginDeclaration } from "./discovery-Bhd5Zo0N.js";
import "./utils-K2PjeLaV.js";
import { n as VERSION, o as resolveCompatibilityHostVersion } from "./version-CeFj_iGk.js";
import { i as isOpenClawOrgNpmSpec, s as parseRegistryNpmSpec, t as compareOpenClawReleaseVersions } from "./npm-registry-spec-CqBTTiC9.js";
import { t as parseClawHubPluginSpec } from "./clawhub-spec-CzLwxQg_.js";
import { a as resolveDefaultPluginNpmDir, l as resolvePluginNpmPackageDir, o as resolvePluginInstallDir, r as resolveDefaultPluginExtensionsDir } from "./install-paths-CQBLzB1H.js";
import { n as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-index-record-reader-DjVucfOz.js";
import { _ as resolveOfficialExternalProviderPluginIds, g as resolveOfficialExternalProviderContractPluginIds, h as resolveOfficialExternalPluginLabel, l as listOfficialExternalPluginCatalogEntries, m as resolveOfficialExternalPluginInstall, p as resolveOfficialExternalPluginId, v as resolveOfficialExternalProviderPluginIdsForEnv, y as resolveOfficialExternalWebProviderContractPluginIdsForEnv } from "./official-external-plugin-catalog-D3_jWsTb.js";
...
import { n as listExplicitlyDisabledChannelIdsForConfig, r as listPotentialConfiguredChannelIds } from "./config-presence-BPKU2NeJ.js";
import { s as resolveConfiguredChannelPresencePolicy } from "./channel-presence-policy-ClfxdhHd.js";
import { t as collectConfiguredMemoryEmbeddingProviderIds } from "./gateway-startup-plugin-ids-DDW1RRDk.js";
import { t as collectConfiguredSpeechProviderIds } from "./gateway-startup-speech-providers-DTiClTx9.js";
import { n as resolveWebSearchInstallCatalogEntriesForEnv, r as resolveWebSearchInstallCatalogEntry } from "./web-search-install-catalog-DbGxewYv.js";
import { s as loadManifestMetadataSnapshot } from "./manifest-contract-eligibility-DbVdNqi2.js";
import { c as buildNpmResolutionInstallFields, s as writePersistedInstalledPluginIndexInstallRecords, u as resolveNpmInstallRecordSpec } from "./installed-plugin-index-records-D6eYE-Kv.js";
...
import { r as listRawChannelPluginCatalogEntries } from "./catalog-Bm_jQvAj.js";
import { d as resolveRegistryUpdateChannel, l as normalizeUpdateChannel } from "./update-channels-CQNa2YMG.js";
...
import { n as updateNpmInstalledPlugins, r as isClawHubTrustSkippedOutcome } from "./update-DBbaWg3o.js";
import { i as collectConfiguredRuntimePluginIds, n as VERSION_BOUND_RUNTIME_PLUGIN_IDS, t as CONFIGURED_RUNTIME_PLUGIN_INSTALL_CANDIDATES } from "./configured-runtime-plugin-installs-Cs9SeMel.js";
import { c as isLegacyPackageUpdateDoctorPass, f as shouldDeferConfiguredPluginInstallRepair, u as isPostCoreConvergencePass } from "./update-phase-HdecdncY.js";
import { t as asObjectRecord } from "./object-BsiS9JXh.js";
import { n as collectConfiguredModelProviderSelectionIds, r as collectConfiguredProviderSelectionIds, t as collectConfiguredMediaProviderSelectionIds } from "./configured-provider-selection-ids-ZpDbWKnj.js";
...
function resolveCandidateInstallSpec(params) {
	if (params.candidate.defaultChoice !== "npm" && params.candidate.clawhubSpec) return resolveClawHubInstallSpecsForUpdateChannel({
		spec: params.candidate.clawhubSpec,
		updateChannel: params.updateChannel
	}).installSpec;
	if (params.candidate.npmSpec) return resolveNpmInstallSpecsForUpdateChannel({
		spec: params.candidate.npmSpec,
		updateChannel: params.updateChannel,
		officialPackageName: params.candidate.trustedSourceLinkedOfficialInstall ? parseRegistryNpmSpec(params.candidate.npmSpec)?.name : void 0,
		coreVersion: params.coreVersion
	}).installSpec;
	if (params.candidate.clawhubSpec) return resolveClawHubInstallSpecsForUpdateChannel({
		spec: params.candidate.clawhubSpec,
		updateChannel: params.updateChannel
	}).installSpec;
}
...
//#endregion
export { repairMissingPluginInstallsForIds as a, repairMissingConfiguredPluginInstalls as i, configuredPluginInstallIssueToRepairEffect as n, collectConfiguredProviderPluginIds as o, detectConfiguredPluginInstallHealthIssues as r, configuredPluginInstallIssueToHealthFinding as t };
