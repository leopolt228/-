...
import { n as resolveCompatibleRuntimePluginRegistry } from "./loader-Bp4FN_wM.js";
import { c as getActivePluginRegistry, d as getActivePluginRegistryWorkspaceDir, n as getActivePluginChannelRegistry, o as getActivePluginHttpRouteRegistry, t as collectLivePluginRegistries } from "./runtime-BapEso0o.js";
...
function listLoadedRuntimePluginIdsAcrossSurfaces() {
	const loaded = [];
	for (const registry of collectLivePluginRegistries()) for (const plugin of registry.plugins ?? []) if (isRuntimePluginRecordLoaded(plugin)) loaded.push(plugin.id);
...
//#endregion
export { registryContainsRuntimePluginIds as i, getLoadedRuntimePluginRegistry as n, listLoadedRuntimePluginIdsAcrossSurfaces as r, getActiveRuntimePluginRegistry as t };
