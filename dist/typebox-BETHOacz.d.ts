...
declare function stringEnum<T extends readonly string[]>(values: T, options?: StringEnumOptions<T>): Type.TUnsafe<T[number]> | Type.TEnum<T[number][]>;
declare function optionalStringEnum<T extends readonly string[]>(values: T, options?: StringEnumOptions<T>): Type.TOptional<Type.TUnsafe<T[number]> | Type.TEnum<T[number][]>>;
//#endregion
