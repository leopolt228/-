...
function appendGatewayLifecycleAuditLog(env, entry) {
	try {
		...
		fs.appendFileSync(logPath, `[${(/* @__PURE__ */ new Date()).toISOString()}] openclaw gateway lifecycle ${fields.join(" ")}\n`, "utf8");
	} catch {}
}
...
//#endregion
export { resolveGatewayRestartLogPath as a, resolveGatewayLogPaths as i, renderCmdRestartLogSetup as n, resolveGatewaySupervisorLogPaths as o, renderPosixRestartLogSetup as r, shellEscapeRestartLogValue as s, appendGatewayLifecycleAuditLog as t };
