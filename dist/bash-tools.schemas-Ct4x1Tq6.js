...
const execSchema = Type.Object({
	...
	workdir: Type.Optional(Type.String({ description: "Working directory. Blank/whitespace values are invalid; omit to use the default cwd." })),
...
//#endregion
export { nodeExecSchema as n, processSchema as r, execSchema as t };
