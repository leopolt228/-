import { c as normalizeOptionalString, l as normalizeOptionalStringifiedId, s as normalizeOptionalLowercaseString, t as hasNonEmptyString$1 } from "./string-coerce-DW4mBlAt.js";
...
function resolveActionDeliveryTargetAlias(action, params, options) {
	...
	const aliases = options?.aliasSpec ?? getBootstrapChannelPlugin(channel)?.actions?.messageActionTargetAliases?.[action];
...
//#endregion
export { actionHasResourceReference as a, resolveActionDeliveryTargetAlias as c, hasNonEmptyString as i, hasPotentialPluginActionParam as l, CHANNEL_TARGET_DESCRIPTION as n, actionHasTarget as o, applyTargetToParams as r, actionRequiresTarget as s, CHANNEL_TARGETS_DESCRIPTION as t };
