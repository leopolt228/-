...
import { a as createSetupInputPresenceValidator } from "./setup-helpers-mUFOk9iT.js";
import { J as setSetupChannelEnabled, Q as splitSetupEntries, a as createAllowFromSection, f as createStandardChannelSetupStatus, v as mergeAllowFromEntries } from "./setup-wizard-helpers-BswN5Wen.js";
...
const lineSetupWizard = {
	...
	credentials: [defineTokenCredential({
		...
		envValue: ({ accountId }) => accountId === "default" ? normalizeOptionalString(process.env.LINE_CHANNEL_ACCESS_TOKEN) : void 0,
		...
		envValue: ({ accountId }) => accountId === "default" ? normalizeOptionalString(process.env.LINE_CHANNEL_SECRET) : void 0,
		patchAccount: ({ cfg, accountId, patch, clearFields }) => patchLineAccountConfig({
			cfg,
			accountId,
			enabled: true,
