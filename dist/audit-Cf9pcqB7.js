...
import { n as resolveSecretRefValue, r as resolveSecretRefValues } from "./resolve-DhgogJwd.js";
import { t as isNonEmptyString } from "./shared-hYiou55H.js";
import { n as hasConfiguredPlaintextSecretValue, r as isExpectedResolvedSecretValue } from "./secret-value-6FGp-c6U.js";
...
import { c as isNonSecretApiKeyMarker, u as isSecretRefHeaderValueMarker } from "./model-auth-markers-Bqpoo9x7.js";
import { a as readPersistedAuthProfileStoreRaw, c as resolveAuthProfileDatabasePath } from "./sqlite-CCIog9t1.js";
import "./model-selection-Dx2ArePR.js";
import { n as selectRefsForExecPolicy, t as getSkippedExecRefStaticError } from "./exec-resolution-policy-C0e-fEEV.js";
import { t as isLikelySensitiveModelProviderHeaderName } from "./model-provider-header-policy-CwM0ZwJ1.js";
import { a as parseEnvAssignmentValue, c as iterateAuthProfileCredentials, i as listSecretsDotEnvPaths, n as listAuthProfileStoreAgentDirs, o as readJsonObjectIfExists, r as listLegacyAuthJsonPaths, s as createSecretsConfigIO, t as listAgentModelsJsonPaths } from "./storage-scan-Rciqo1bv.js";
...
function collectConfigSecrets(params) {
	...
	for (const target of discoverConfigSecretTargets(params.config)) {
		...
		if (target.entry.id === "models.providers.*.apiKey" && typeof target.value === "string" && isNonSecretApiKeyMarker(target.value)) continue;
