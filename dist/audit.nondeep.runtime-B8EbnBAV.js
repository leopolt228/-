...
import { n as isDangerousNetworkMode, r as normalizeNetworkMode } from "./network-mode-_J-LGFGe.js";
import { m as createPluginRegistryIdNormalizer, u as loadPluginRegistrySnapshot } from "./plugin-registry-2gpKUE2T.js";
...
import { t as resolveAllowedAgentIds } from "./hooks-policy-DRmducaV.js";
import { r as resolveProviderToolPolicy } from "./provider-tool-policy-KyAGXjuf.js";
import { n as resolveConfiguredToolPolicies } from "./agent-tools.policy-aD3y5gLo.js";
import { n as GATEWAY_CONTROL_PLANE_TOOLS } from "./dangerous-tools-CKOgTnGD.js";
import { l as resolveNodeCommandAllowlist, s as listDangerousPluginNodeCommands, t as DEFAULT_DANGEROUS_NODE_COMMANDS } from "./node-command-policy-DMws3TUh.js";
import { n as listReadOnlyChannelPluginsForConfig } from "./read-only-CTGMGkDz.js";
import { t as getBlockedBindReason } from "./validate-sandbox-security-CUTQ0ApU.js";
import { r as resolveNativeSkillsEnabled } from "./commands-I8ZNoVIP.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-CTFrGP7b.js";
import { t as inspectReadOnlyChannelAccount } from "./read-only-account-inspect-rYpL0x66.js";
import { a as readInstalledPackageVersion } from "./package-update-utils-BuB4WZ15.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-CfoIpgW5.js";
import { t as hasConfiguredInternalHooks } from "./configured-pV8SaeM2.js";
import { a as collectStateDeepFilesystemFindings, i as collectSandboxBrowserHashLabelFindings, o as readConfigSnapshotForAudit, s as listInstalledPluginDirs, t as collectIncludeFilePermFindings } from "./audit-extra.async-BzFDsJ05.js";
...
function isBrowserEnabled(cfg) {
	...
	return passesManifestOwnerBasePolicy({
		plugin: { id: "browser" },
		normalizedConfig: normalizePluginsConfigWithResolver(cfg.plugins, (pluginId) => normalizeOptionalLowercaseString(pluginId) ?? "")
	});
}
...
function collectNodeDangerousAllowCommandFindings(cfg) {
	...
	findings.push({
		...
		detail: `gateway.nodes.allowCommands includes: ${dangerousAllowed.join(", ")}. These commands can trigger high-impact device actions or read sensitive data (desktop input/camera/screen/contacts/calendar/reminders/health/SMS/file).`,
...
const loadPluginTrustPolicyDeps = createLazyPromise(() => Promise.all([
	import("./config-DlMiXrPs.js"),
	import("./tool-policy-BmRa23VR.js"),
	import("./tool-policy-match-Cbvwgack.js"),
	import("./tool-policy-CuzDIMZu.js"),
