...
import { D as resolveIntegerOption, b as parseStrictPositiveInteger, j as resolveTimerTimeoutMs, o as asDateTimestampMs, p as finiteSecondsToTimerSafeMilliseconds } from "./number-coercion-Crk_c9KW.js";
...
import { n as CHAT_CHANNEL_ORDER, r as normalizeChatChannelId } from "./ids-retRJEzF.js";
import { t as pruneMapToMaxSize } from "./map-size-DAGm21RM.js";
import { _ as resolveSessionAgentId, f as resolveAgentSkillsFilter, i as hasLegacyAutoFallbackWithoutOrigin, p as resolveAutoFallbackPrimaryProbe, t as clearAutoFallbackPrimaryProbeSelection, w as hasSessionAutoModelFallbackProvenance } from "./agent-scope-CrBA-6Gx.js";
import { n as normalizeAgentId } from "./agent-id-DDgUze4y.js";
import { C as isSubagentSessionKey, E as parseAgentSessionKey, b as isAcpSessionKey, i as buildAgentMainSessionKey, l as normalizeMainKey } from "./session-key-Drrs61Fd.js";
import { t as DEFAULT_AGENT_WORKSPACE_DIR } from "./workspace-default-h9TzWSvp.js";
import { a as resolveAgentDir, o as resolveAgentWorkspaceDir, r as resolveAgentConfig, t as listAgentEntries } from "./agent-scope-config-S7z_Yn4H.js";
...
import { a as normalizeElevatedLevel, c as normalizeTraceLevel, i as isSessionDefaultDirectiveValue, o as normalizeReasoningLevel, s as normalizeThinkLevel, u as normalizeVerboseLevel } from "./thinking.shared-BWnbgBUO.js";
...
import { d as markCommandReplyForDelivery } from "./reply-payload-BtIUrr9c.js";
import { n as canonicalizeMainSessionAlias } from "./main-session-C7kXMD8t.js";
import { a as normalizeDeliveryChannelRoute, n as deliveryContextFromSession, o as normalizeDeliveryContext, r as deliveryContextKey, s as normalizeSessionDeliveryFields } from "./delivery-context.shared-D6zu5SGz.js";
...
import { b as loadReplySessionInitializationSnapshot, y as commitReplySessionInitialization, yt as loadSessionEntry } from "./session-accessor-Mu3lv_Tl.js";
...
import { H as conversationIdentityFromMsgContext, W as deriveSessionMetaPatch } from "./targets-DhNEpENL.js";
import { r as sqliteSessionFileMarkerMatchesSession, t as formatSqliteSessionFileMarker } from "./sqlite-marker-BejbySI1.js";
import { Mt as runExclusiveSessionStoreWrite, O as resolveAgentHarnessSessionContextError, P as DEFAULT_RESET_TRIGGERS, Tt as interruptSessionWorkAdmissions, it as resolveMaintenanceConfigFromInput, kt as runExclusiveSessionLifecycleMutation } from "./store-DDuGv_UJ.js";
...
import { d as ensureAgentWorkspace, p as isWorkspaceBootstrapPending } from "./workspace-GYctLxSN.js";
...
import { h as registerMainSessionGroupWatch, n as classifySessionStateActor, t as acknowledgeSessionStateNotices, v as decodeSessionStateNoticeContextKey } from "./session-state-events-BG_mebdA.js";
import { a as enqueueSystemEvent, l as peekSystemEventEntries, t as consumeSelectedSystemEventEntries } from "./system-events-BNfyhKS3.js";
...
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-DNTxgxrx.js";
import { t as hasControlCommand } from "./command-detection-B3_n5-oK.js";
import { n as isInternalSourceReplyChannel } from "./source-reply-delivery-mode-D3kMtu3s.js";
import { n as resolveAgentTimeoutMs } from "./timeout-BEGWfRGM.js";
import { A as waitForReplyRunEndBySessionId, C as resolveActiveReplyRunSessionId, S as replyRunRegistry, h as isReplyRunActiveForSessionId, o as abortReplyRunBySessionId, t as REPLY_RUN_IDLE_SETTLE_TIMEOUT_MS, v as isReplyRunStreamingForSessionId, w as resolveActiveReplyRunThreadId } from "./reply-run-registry-BSL8NJYn.js";
import { a as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as isSilentReplyText } from "./tokens-DKI4eGAu.js";
import { a as isSessionWorkStartInvalidatedError, o as resolveSessionLifecycleTimestamps, r as hasTerminalMainSessionTranscriptNewerThanRegistry, s as resolveSessionWorkStartError } from "./lifecycle-Vx3ij-ME.js";
...
import { c as isInterSessionInputProvenance, r as annotateInterSessionPromptText } from "./input-provenance-B6vSIOBi.js";
...
import { n as normalizeQueueDropPolicy, r as normalizeQueueMode } from "./settings-w2c261hm.js";
import { a as createUserTurnTranscriptRecorder, c as resolvePersistedUserTurnText, n as buildPersistedUserTurnMediaInputsFromFields } from "./user-turn-transcript-Dums4a4X.js";
import { o as resolveReplyToMode } from "./reply-threading-BP15SwF-.js";
import { a as HEARTBEAT_TRANSCRIPT_PROMPT, d as stripHeartbeatToken } from "./heartbeat-Bkwxbekw.js";
...
import { c as getQueueSize, n as clearCommandLane } from "./command-queue-B2fMJE4M.js";
...
import { n as resolveChannelGroupRequireMention } from "./group-policy-BdSJjJjj.js";
...
import { n as formatToolSummary, r as resolveToolDisplay } from "./tool-display-DjpsCVVm.js";
import { d as isChannelProgressDraftWorkToolName, f as isCommandToolName } from "./streaming-CeN4qI3u.js";
import { t as collectTextContentBlocks } from "./content-blocks-DRK0dze4.js";
import { P as resolveBootstrapMode } from "./openclaw-tools-U0Zy3sfO.js";
...
import { n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-BYVkVTQj.js";
import { a as isModelSelectionLocked, n as MODEL_SELECTION_LOCKED_RESET_MESSAGE, r as ModelSelectionLockedError, t as MODEL_SELECTION_LOCKED_MESSAGE } from "./model-overrides-BlzAR7Nc.js";
import { r as resolveIngressWorkspaceOverrideForSessionRun } from "./spawned-context-DFWZoOgE.js";
import { i as resolveParentForkDecision, r as forkSessionFromParent } from "./session-fork-DrD0yo6D.js";
...
import { a as appendUntrustedContext, n as MEDIA_ONLY_USER_TEXT, t as isReasoningTagProvider } from "./provider-utils-DzZ6N2aL.js";
...
import { t as appendCronStyleCurrentTimeLine } from "./current-time-sWC78VoB.js";
import { n as resolveEmbeddedFullAccessState } from "./sandbox-info-B3tJ5vwX.js";
import { r as updateAmbientTranscriptWatermark } from "./ambient-transcript-watermark-CalzDYx2.js";
import { i as isExecCompletionEvent } from "./heartbeat-events-filter-CwG3RmMF.js";
...
import { a as admitReplyTurn, i as resolveEffectiveReplyRoute, r as isSystemEventProvider, t as createReplyTimingTracker } from "./reply-timing-tracker-g5baX4Sf.js";
import { n as shouldUseFromAsSenderFallback } from "./command-auth-Bx3Uf_Nq.js";
import { c as takeCommandSessionMetadataChangesFromTargets } from "./commands-goal-CaX8R908.js";
...
import { n as recoverTerminalSessionEntryForVisibleTurn, t as isRecoverableTerminalSessionStatus } from "./terminal-status-BFa5n9vV.js";
...
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-JuM7Ltm-.js";
import { a as resolveGetReplyConfig, c as shouldUseReplyFastTestBootstrap, d as createReplySessionEntryHandle, i as initFastReplySessionState, l as shouldUseReplyFastTestRuntime, n as stageRemoteInboundMediaIfNeeded, o as shouldHandleFastReplyTextCommands, r as buildFastReplyCommandContext, s as shouldUseReplyFastDirectiveExecution, t as resolveRunTypingPolicy } from "./typing-policy-B954WVHa.js";
import { n as hasInboundMedia, r as hasInboundMediaForUnderstanding, t as hasInboundAudio } from "./inbound-media-5a6CUBEc.js";
...
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-Ch-SbDB6.js";
...
import { n as runWithSessionInitConflictRetry, t as ReplySessionInitConflictError } from "./session-init-conflict-retry-DkUj_yZr.js";
...
import { t as resolveBlockStreamingChunking } from "./block-streaming-YtzUyjFS.js";
import { n as buildCommandContext, t as isResetAuthorizedForContext } from "./reset-authorization-uQSdWwlJ.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-6mu6Yswr.js";
...
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-CXB7FsER.js";
...
import { i as resolveSkillCommandInvocation, r as listReservedChatSlashCommandNames } from "./chat-commands-DGIUwBOP.js";
import { t as persistReplySessionEntry } from "./session-entry-persistence-JT1j-eUU.js";
import { n as consumeSessionSkillSuggestion } from "./skill-suggestions-DD5U4Ght.js";
import { a as buildInboundUserContextPrefix, c as resolveInboundUserContextPromptJoiner, d as resolveSilentReplySettings, i as buildInboundMetaSystemPrompt, l as resolveCurrentTurnImages, n as resolveTypingMode, o as formatActiveGoalContext, r as resolveActiveRunQueueAction } from "./typing-mode-C3UXh-PJ.js";
import { n as resolvePreparedReplyQueueState } from "./get-reply-run-queue-B0s_Ucm8.js";
import { n as resolveEffectiveToolInventory } from "./tools-effective-inventory-l7p1c1wA.js";
import { t as buildChannelSummary } from "./channel-summary--CQsu60o.js";
import { i as sanitizeProgressStatusText, t as PROGRESS_STATUS_PREAMBLE_FRESH_MS } from "./progress-draft-compositor-BtUZIejX.js";
...
const matchLevelDirective = (body, pattern, normalize) => {
	...
	const argStart = i;
	while (i < body.length && /[A-Za-z-]/.test(body.charAt(i))) i += 1;
	const candidate = i > argStart ? body.slice(argStart, i) : void 0;
	if (candidate !== void 0 && (normalize(candidate) !== void 0 || body.slice(i).trim().length === 0)) return {
		start,
		end: i,
		rawLevel: candidate
	};
...
const directiveLevelsLoader = createLazyImportLoader(() => import("./directive-handling.levels-Dcv7hmL0.js"));
const directiveImplLoader = createLazyImportLoader(() => import("./directive-handling.impl-Dog_uGp2.js"));
const directiveFastLaneLoader = createLazyImportLoader(() => import("./directive-handling.fast-lane-DqM0WVVd.js"));
...
async function applyInlineDirectiveOverrides(params) {
		...
		if (hasOnlyModelDirective(directives) && effectiveModelDirective) {
			...
			if (modelSelection) {
				...
				if (persisted.errorText) {
					...
					return {
						kind: "reply",
						reply: { text: persisted.errorText }
					};
				}
				...
				const parts = [
					...
					persisted.runtimeChange?.kind === "clear" ? "Runtime reset to configured policy." : persisted.runtimeChange?.kind === "set" ? `Runtime set to ${persisted.runtimeChange.runtime} for this session.` : void 0,
	...
	if (hasAnyDirective && command.isAuthorizedSender) {
		...
		if (!fastLane.sessionChangesApplied) {
			...
			return {
				kind: "reply",
				reply: directiveAck ?? { text: "Session settings were not applied because the session changed. Retry." }
			};
		}
	}
	const persisted = await (await loadDirectivePersist()).persistInlineDirectives({
...
function buildGroupIntro(params) {
	...
	if (activation === "always") return "Activation: always-on (you receive every group message). You see every message; most need no response. When you do reply, address the specific sender noted in the message context.";
...
const skillToolDispatchRuntimeLoader = createLazyImportLoader(() => import("./tool-dispatch-rh9IPdSN.js"));
const abortCutoffRuntimeLoader = createLazyImportLoader(() => import("./abort-cutoff.runtime.js"));
const commandsRuntimeLoader$1 = createLazyImportLoader(() => import("./commands.runtime-Cunk65Q-.js"));
...
const commandsRuntimeLoader = createLazyImportLoader(() => import("./commands.runtime-Cunk65Q-.js"));
const skillCommandsRuntimeLoader = createLazyImportLoader(() => import("./chat-commands.runtime.js"));
const statusCommandRuntimeLoader = createLazyImportLoader(() => import("./commands-status-BScsneW0.js"));
...
function buildReplyPromptEnvelopeBase(params) {
	...
	const currentInboundContextText = isRoomEvent ? roomEventContext : [inboundUserContext, userRequestDeliveryDirective].filter(Boolean).join("\n\n");
	...
	return {
		effectiveBaseBody: isRoomEvent ? ROOM_EVENT_PROMPT : params.hasUserBody ? resetModelBody : MEDIA_ONLY_USER_TEXT,
		transcriptBody: params.isHeartbeat ? HEARTBEAT_TRANSCRIPT_PROMPT : params.isBareSessionReset ? softResetTail || `[OpenClaw session ${params.startupAction}]` : isRoomEvent ? resolveRoomEventTranscriptBody(params) : params.hasUserBody ? params.baseBody : MEDIA_ONLY_USER_TEXT,
...
function projectSkillSuggestionForTurn(entry, suggestion) {
	if (!entry) return;
	if (suggestion) return {
		...entry,
		pendingSkillSuggestion: suggestion
	};
	if (!entry.pendingSkillSuggestion) return entry;
...
const embeddedAgentRuntimeLoader = createLazyImportLoader(() => import("./embedded-agent.runtime-BHoeo7Dt.js"));
...
async function runPreparedReply(params) {
	...
	const sessionPromptSourceReplyDeliveryMode = opts?.sessionPromptSourceReplyDeliveryMode ?? sourceReplyDeliveryMode;
	...
	let consumedSkillSuggestion;
	const resolveContextSessionEntry = async (entry) => {
		if (isHeartbeat) return;
		let currentEntry = entry;
		if (!consumedSkillSuggestion && currentEntry?.pendingSkillSuggestion) try {
			...
			if (consumed) {
				...
				consumedSkillSuggestion = skillSuggestionEnabled ? consumed.suggestion : void 0;
				sessionEntry = consumed.entry;
				sessionEntryHandle?.replaceCurrent(consumed.entry);
				if (sessionStore) sessionStore[sessionKey] = consumed.entry;
			}
		} catch (error) {
	...
	let inboundContextSessionEntry = await resolveContextSessionEntry(sessionStore?.[sessionKey] ?? sessionEntryHandle?.getCurrent() ?? sessionEntry);
	let activeGoalContext = formatActiveGoalContext(inboundContextSessionEntry);
	let inboundUserContext = buildInboundUserContextPrefix(inboundUserContextSessionCtx, envelopeOptions, inboundContextSessionEntry);
	...
	let prefixedBodyBase = heartbeatRunScope === "commitment-only" ? effectiveBaseBody : await applySessionHints({
	...
	if (!thinkingLevelSupported) {
		if (directives.hasThinkDirective && directives.thinkLevel !== void 0 || explicitThinkingLevelOverride !== void 0) {
			typing.cleanup();
			return { text: `Thinking level "${resolvedThinkLevel}" is not supported for ${provider}/${model}. Use one of: ${formatThinkingLevels(provider, model, ", ", thinkingCatalog, thinkingRuntime)}.` };
		}
	...
	if (commandTurnContinuationTargetKey === void 0 && providedReplyOperation !== void 0 && providedReplyOperation.result === null && providedReplyOperation.phase === "queued" && sessionId !== void 0 && sessionId !== providedReplyOperation.sessionId) providedReplyOperation.updateSessionId(sessionId);
	...
	const resolvePreparedSessionState = () => {
		...
		return {
			...
			sessionId: latestSessionId,
			sessionFile: existingSessionFile && sqliteSessionFileMarkerMatchesSession(existingSessionFile, latestSessionId) ? existingSessionFile : storePath ? formatSqliteSessionFileMarker({
				agentId,
				sessionId: latestSessionId,
				storePath
...
function createProgressNarrator(params) {
	...
	const addNote = (note, options) => {
		...
		if (notes.length > MAX_ACTIVITY_NOTES) notes.splice(0, notes.length - MAX_ACTIVITY_NOTES);
	...
	const shouldRunNow = (immediate) => {
		...
		if (immediate || notesAtLastRun < 0) return true;
	...
	return {
		...
		noteToolStart(payload) {
			...
			addNote(formatToolSummary(hideDetail ? {
				...display,
				detail: void 0
			} : display));
		},
		noteCommandOutput(payload) {
			...
			const subject = params.hideCommandText ? payload.name || "command" : payload.title || payload.name || "command";
...
const loadDeliverRuntime = createLazyPromiseLoader(() => import("./runtime-DjiAO-3g.js"), { cacheRejections: true }).load;
...
async function initSessionStateAttemptLocked(params, attemptContext, staleSnapshotRetried, lifecycleMutationIdentity) {
	...
	const expectedExistingSessionId = params.expectedExistingSessionId?.trim() || void 0;
	...
	if (previousSessionEntry) clearSessionResetRuntimeState([sessionKey, previousSessionEntry.sessionId], { activeReplySessionId: previousSessionEntry.sessionId });
	...
	if (isNewSession) {
		...
		sessionEntry.memoryFlushFailureCount = void 0;
		sessionEntry.memoryFlushLastFailedAt = void 0;
		sessionEntry.memoryFlushLastFailureError = void 0;
...
async function getReplyFromConfig(ctx, opts, configOverride) {
	...
	if (!isFastTestEnv && normalizeOptionalString(finalized.MediaRemoteHost) && hasInboundMedia(finalized)) await traceGetReplyPhase("reply.stage_remote_media_pre_understanding", () => stageRemoteInboundMediaIfNeeded({
		ctx: finalized,
		cfg,
		...
		if (opts?.isHeartbeat) {
			if (classifyHeartbeatPendingFinalDelivery(text, resolveHeartbeatAckMaxChars(cfg, agentId)).shouldClear) {
				...
				if (sessionKey && storePath) {
					const { updateSessionEntry } = await import("./session-accessor-QYu3Z6AW.js");
