...
import { C as DiagnosticMemoryUsage, Z as DiagnosticSessionActiveWorkKind, it as DiagnosticSessionState, y as DiagnosticLivenessWarningReason } from "./diagnostic-events-D5MV3iZe.js";
...
type DiagnosticSessionRecoverySkipReason = "active_embedded_run" | "active_reply_work" | "deferred_maintenance_wait" | "active_lane_task" | "already_in_flight" | "missing_session_ref" | "stale_session_state";
...
declare function resolveStuckSessionWarnMs(): number;
declare function resolveStuckSessionAbortMs(stuckSessionWarnMs: number): number;
