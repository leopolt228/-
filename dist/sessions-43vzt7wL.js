...
import { E as parseAgentSessionKey, b as isAcpSessionKey } from "./session-key-Drrs61Fd.js";
...
import { a as toSessionDisplayRow, i as formatSessionModelCell, l as resolveSessionDisplayModelRef, n as formatSessionFlagsCell, r as formatSessionKeyCell, s as resolveSessionDisplayDefaults, t as formatSessionAgeCell } from "./sessions-table-BNioeusD.js";
...
const contextLookupRuntimeLoader = createLazyImportLoader(() => import("./context-DkOlpGmA.js"));
...
function toJsonSessionRow(row) {
	...
	if (marker) jsonRow.sessionFile = formatSqliteSessionFileMarker({
		...marker,
		storePath: resolveSqliteTargetFromSessionStorePath(marker.storePath, { agentId: marker.agentId }).path
	});
	return jsonRow;
}
...
const testing = { parseSessionsLimit };
if (process.env.VITEST || false) globalThis[Symbol.for("openclaw.sessionsCommandTestApi")] = testing;
//#endregion
