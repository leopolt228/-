...
import "./openclaw-exec-env-BmbZ1aqS.js";
import { c as sanitizeHostExecEnvWithDiagnostics, n as isDangerousHostEnvOverrideVarName, o as normalizeHostOverrideEnvVarKey, r as isDangerousHostEnvVarName } from "./host-env-security-pMY6K0Qy.js";
import { p as safeStatSync } from "./path-DILYn_gk.js";
import { c as emitTrustedSecurityEvent, n as emitDiagnosticEvent } from "./diagnostic-events-Dt41CZkD.js";
...
import { C as isSubagentSessionKey, E as parseAgentSessionKey, S as isCronSessionKey, d as resolveAgentIdFromSessionKey } from "./session-key-Drrs61Fd.js";
import { a as logWarn, r as logInfo } from "./logger-DT9z6GgH.js";
import { o as resolveShellEnvFallbackTimeoutMs, r as getShellPathFromLoginShell } from "./shell-env-4g6GM0d2.js";
import { i as addSafeTimeoutDelayGraceMs } from "./timeouts-CThCRo6Z.js";
import { a as resolveApprovalAuditTrustPath, d as resolveExecutionTargetTrustPath } from "./exec-command-resolution-m9V5wfx_.js";
import { N as splitShellArgs } from "./shell-wrapper-resolution-DlXABXcG.js";
import { n as APPROVALS_SCOPE, s as WRITE_SCOPE } from "./operator-scopes-BHrNTqoH.js";
import { m as runWithGatewayIndependentRootWorkAdmission, t as GatewayDrainingError } from "./gateway-work-admission-CLw1UuhK.js";
...
import { i as normalizeMessageChannel, n as isGatewayMessageChannel } from "./message-channel-normalize-DYDkUiW3.js";
import { s as isNativeApprovalChannel } from "./message-channel-CkiwT4Uh.js";
import { t as formatDurationCompact } from "./format-duration-DKk9BtRb.js";
import { a as failedTextResult } from "./common-C39GdgQ7.js";
import { n as textResult } from "./tool-results-BCM3fdVS.js";
import { C as formatExecDeniedUserMessage, T as parseExecApprovalResultText, d as sanitizeUserFacingText, w as isExecDeniedResultText } from "./sanitize-user-facing-text-sWgeyF-a.js";
import { d as PROCESS_TOOL_DISPLAY_SUMMARY, u as EXEC_TOOL_DISPLAY_SUMMARY } from "./tool-catalog-Bi5DGU0C.js";
import { I as BACKGROUND_EXEC_TASK_KIND } from "./task-registry-BkemWOKR.js";
...
import { a as coerceEnv, c as readEnvInt, i as clampWithDefault, l as sliceLogLines, n as buildSandboxEnv, o as deriveSessionName, s as pad, u as truncateMiddle } from "./bash-tools.shared-BoXDo33n.js";
import { a as drainSession, c as getSession, d as markBackgrounded, f as markExited, i as deleteSession, l as listFinishedSessions, m as tail, p as setJobTtlMs, s as getFinishedSession, u as listRunningSessions } from "./bash-process-registry-BrIqJ2bV.js";
import { t as getProcessSupervisor } from "./supervisor-Da_-xdZV.js";
import { a as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-surface-BeBSG2sP.js";
import { o as stripMalformedXmlArgValueSuffixFromKeys } from "./agent-tools.params-BZyOAvBo.js";
import { t as callGatewayTool } from "./gateway-wQ1RjFk5.js";
import { c as describeInterpreterInlineEval } from "./risks-BpC_U-rz.js";
import { t as buildEnforcedShellCommand } from "./exec-approvals-analysis-eausQ51Q.js";
import { i as evaluateShellAllowlistWithAuthorization } from "./exec-approvals-allowlist-D7Zoo1vy.js";
import { B as resolveDurableExecApprovalRequirement, I as requireValidExecTarget, K as resolveExecApprovalsFromFile, L as requiresExecApproval, Q as resolveExecModePolicy, R as resolveAllowAlwaysPatternCoverage, S as minSecurity, T as normalizeExecAsk, U as resolveExecApprovalUnavailableDecisions, V as resolveExecApprovalAllowedDecisions, X as resolveExecApprovalsTranscriptPath, b as maxAsk, c as commandRequiresSecurityAuditSuppressionApproval, h as hasNodeCommandAllowAlwaysMarker, l as commitExecAuthorizationLocked, m as hasExactCommandDurableExecApproval, p as hasDurableExecApproval, q as resolveExecApprovalsLocked, u as createExecApprovalPolicySnapshot, v as loadExecApprovals, z as resolveAllowAlwaysPersistenceDecision } from "./exec-approvals-BWcbplqx.js";
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-BM73PpFN.js";
import { r as processSchema, t as execSchema } from "./bash-tools.schemas-Ct4x1Tq6.js";
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-Dxbvzdgj.js";
import "./delivery-context-CxAO83bE.js";
import { i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-TLOpgxbj.js";
...
import { _ as renderExecOutputText, a as DEFAULT_PENDING_MAX_OUTPUT, c as buildExecRuntimeErrorOutcome, d as normalizeNotifyOutput, g as appendExecTimeoutRetryGuidance, h as runExecProcess, i as DEFAULT_PATH, l as createApprovalSlug, m as resolveExecTarget, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveApprovalRunningNoticeMs, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, v as renderExecUpdateText } from "./bash-tools.exec-runtime-Cmk75qPp.js";
import { c as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-DHhrBmrX.js";
import { n as rejectUnsafeExecControlShellCommand } from "./exec-control-command-guard-CyOO2D14.js";
...
import { n as defaultExecAutoReviewer, t as createModelExecAutoReviewer } from "./exec-auto-reviewer-LWv_XfgC.js";
import { a as resolveRegisteredExecApprovalDecision, i as registerExecApprovalRequestForHostOrThrow, n as buildExecApprovalTurnSourceContext, r as isExecApprovalRunAbortedError, t as buildExecApprovalRequesterContext } from "./bash-tools.exec-approval-request-B0ymPSVY.js";
import { a as registerExecApprovalFollowupRuntimeHandoff, r as isExecApprovalFollowupSessionRebound, t as buildExecApprovalFollowupIdempotencyKey } from "./bash-tools.exec-approval-followup-state-CRgc7YZn.js";
import { r as resolveSystemRunCommandRequest, t as extractShellCommandFromArgv } from "./system-run-command-DwzUlALL.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-DXJcKC0x.js";
import { n as recordCommandPoll, r as resetCommandPollCount } from "./command-poll-backoff-Bl8MZxpL.js";
...
*/
const log$1 = createSubsystemLogger("agents/exec-approval-followup");
...
function isExecApprovalFollowupDirectDeliveryStale(params) {
	...
	try {
		return isExecApprovalFollowupSessionRebound({
			expectedSessionId,
			resolvedSessionId: normalizeOptionalString(loadSessionEntry({
				storePath: resolveStorePath(normalizeOptionalString(params.sessionStore), { agentId: resolveAgentIdFromSessionKey(sessionKey) }),
				sessionKey,
				clone: false
			})?.sessionId)
		});
	} catch (err) {
		log$1.debug(`exec approval followup session-rebind check skipped for ${sessionKey}; delivering: ${formatUnknownError(err)}`);
		return false;
	}
}
...
async function sendExecApprovalFollowup(params) {
	...
	if (isDenied) {
		if (isExecApprovalFollowupDirectDeliveryStale({
			...
			log$1.info(`Dropping stale denied exec approval followup ${params.approvalId}: session ${sessionKey ?? ""} was rebound before the approval resolved`);
			return false;
		}
	...
	if (isExecApprovalFollowupDirectDeliveryStale({
		...
		log$1.info(`Dropping stale exec approval followup ${params.approvalId} direct fallback: session ${sessionKey ?? ""} was rebound before the approval resolved`);
		return false;
	}
	if (await sendDirectFollowupFallback({
		approvalId: params.approvalId,
...
async function resolveApprovalDecisionOrUndefined(params) {
	try {
		...
		if (isExecApprovalRunAbortedError(error)) throw error;
		params.onFailure();
		return;
	}
}
...
async function processGatewayAllowlist(params) {
	...
	const gatewayEnforcedCommand = (hostSecurity === "allowlist" || fallbackSecurity === "allowlist") && analysisOk ? resolveGatewayEnforcedCommand({
		command: params.command,
		segments: allowlistEval.segments,
		authorizationPlan: allowlistEval.authorizationPlan,
	...
	if (requiresAsk) {
		...
		const autoReviewResolvedPath = autoReviewHasBoundCommand ? resolveExecutionTargetTrustPath(autoReviewSegment?.resolution ?? null, params.workdir) : void 0;
		const autoReviewHasExecutableBinding = autoReviewHasBoundCommand && autoReviewEnforcedCommand !== void 0 && autoReviewResolvedPath !== void 0;
		const canAutoReviewApprovalMiss = params.autoReview === true && hostAsk !== "always" && autoReviewHasExecutableBinding && !requiresSecurityAuditSuppressionApproval;
		let autoReviewRequiresHumanApproval = params.autoReview === true && hostAsk !== "always" && !autoReviewHasExecutableBinding || requiresAllowlistPlanApproval || requiresHeredocApproval || requiresSecurityAuditSuppressionApproval;
		if (canAutoReviewApprovalMiss) {
			...
			if (decision.decision === "allow-once" && decision.risk === "low" && autoReviewEnforcedCommand) {
				...
				return { execCommandOverride: autoReviewEnforcedCommand };
			}
		...
		if (shouldResolveExecApprovalUnavailableInline({
			...
			const { baseDecision, approvedByAsk, deniedReason } = applyTimedOutAllowlistFallback(createExecApprovalDecisionState({
			...
			await commitExecutionAuthorization({
				...
				resolvedPath: resolveApprovalAuditTrustPath(allowlistEval.segments[0]?.resolution ?? null, params.workdir),
				...preResolvedDecision === "allow-always" ? { allowAlwaysDecision: effectiveAllowAlwaysPersistence } : {}
			});
			const execCommandOverride = preResolvedDecision === null && fallbackSecurity === "allowlist" ? fallbackEnforcedCommand : enforcedCommand;
			return {
				execCommandOverride,
		...
		const resolveApprovalForExecution = async (onFailure) => {
			const decision = await resolveApprovalDecisionOrUndefined({
				...
				if (isExecApprovalRunAbortedError(error)) return "run-aborted";
				throw error;
			});
			if (decision === "run-aborted") return {
			...
			const { baseDecision, approvedByAsk: baseApprovedByAsk, deniedReason: baseDeniedReason } = applyTimedOutAllowlistFallback(initialDecisionState);
			let approvedByAsk = baseApprovedByAsk;
			let deniedReason = baseDeniedReason;
			if (decision === "allow-once") approvedByAsk = true;
			else if (decision === "allow-always") approvedByAsk = true;
			...
			return {
				...
				allowAlwaysDecision: decision === "allow-always" ? effectiveAllowAlwaysPersistence : void 0,
				execCommandOverride: decision === null && fallbackSecurity === "allowlist" ? fallbackEnforcedCommand : enforcedCommand
			};
		};
		...
		(async () => {
			let approvalDecision;
			try {
				approvalDecision = await resolveApprovalForExecution(() => void sendExecApprovalFollowupResult(followupTarget, `Exec denied (gateway id=${approvalId}, approval-request-failed): ${params.command}`));
			} catch {
...
async function analyzeNodeApprovalRequirement(params) {
	...
	return {
		...
		autoReviewArgv: autoReviewBindingEval.segments.length === 1 && (autoReviewBindingEval.segments.at(0)?.raw === void 0 || autoReviewBindingEval.segments.at(0)?.raw.trim() === autoReviewBindingCommand.trim()) ? autoReviewBindingEval.segments.at(0)?.argv : void 0
	};
}
//#endregion
...
async function executeNodeHostCommand(params) {
	const { hostSecurity, hostAsk, askFallback } = await resolveExecHostApprovalContext({
		agentId: params.agentId,
		security: params.security,
		ask: params.ask,
		host: "node"
	...
	if (shouldSkipNodeApprovalPrepare({
		...
		await assertCurrentNodeGatewayPolicyAllowsDispatch({
			...
			currentPolicyAllows: (current) => shouldSkipNodeApprovalPrepare({
	...
	params.signal?.throwIfAborted();
	const { analysisOk, allowlistSatisfied, durableApprovalSatisfied, nodeApprovalPolicyKnown, nodeSecurity, nodeAsk, inlineEvalHit, requiresSecurityAuditSuppressionApproval, autoReviewArgv, allowAlwaysPersistence } = approvalAnalysis;
	...
	if (requiresAsk) {
		...
		if (!inlineApprovedByAsk) {
			...
			if (shouldResolveExecApprovalUnavailableInline({
				...
				const currentFallback = baseDecision.timedOut ? await resolveCurrentTimeoutFallback() : null;
				if (currentFallback) {
				...
				const strictInlineEvalDecision = enforceStrictInlineEvalApprovalBoundary({
					...
					approvedByAsk,
					deniedReason,
					requiresInlineEvalApproval: currentFallback?.requiresExplicitApproval ?? inlineEvalHit !== null,
				...
				inlineApprovalSource = preResolvedDecision === null ? "ask-fallback" : void 0;
				if (inlineApprovalSource) {
					inlineDispatchAuthority = "ask-fallback";
					inlineFallbackPolicy = currentFallback ?? void 0;
				} else inlineDispatchAuthority = "human-approval";
				inlineApprovalDecision = inlineApprovalSource ? null : strictInlineEvalDecision.approvedByAsk ? "allow-once" : null;
				inlineApprovalId = approvalId;
			} else {
				const followupTarget = buildExecApprovalFollowupTarget({
					approvalId,
				...
				(async () => {
					...
					try {
						...
						const raw = await callGatewayTool("node.invoke", { timeoutMs: target.invokeTimeoutMs }, buildNodeSystemRunInvoke({
							...
							approvalDecision: approvalSource ? null : approvalDecision === "allow-always" && inlineEvalHit !== null ? "allow-once" : approvalDecision,
							approvalSource,
							runId: approvalId,
						...
						const output = normalizeNotifyOutput(tail([
							payload.stdout,
							payload.stderr,
							payload.error
						].filter(Boolean).join("\n"), 400));
	...
	return formatNodeRunToolResult({
		raw: (inlineApprovedByAsk || inlineApprovalSource) && inlineApprovalId ? await callGatewayTool("node.invoke", { timeoutMs: target.invokeTimeoutMs }, invoke, { scopes: APPROVED_NODE_INVOKE_SCOPES }) : await callGatewayTool("node.invoke", { timeoutMs: target.invokeTimeoutMs }, invoke),
		startedAt,
		cwd: params.workdir,
...
const fsSafeModuleLoader = createLazyImportLoader(() => import("./fs-safe-DRcRCdxN.js"));
...
function createExecTool(defaults) {
	...
	return {
		...
		execute: async (toolCallId, args, signal, onUpdate) => {
			...
			const foregroundFallbackWarning = !allowBackground && (backgroundRequested || yieldRequested) ? "Warning: background execution is disabled; running synchronously." : void 0;
...
async function handleProcessSendKeys(params) {
	...
	return {
		content: [{
			type: "text",
			text: `Sent ${Buffer.byteLength(data, "utf8")} bytes to session ${params.sessionId}.` + (warnings.length ? `\nWarnings:\n- ${warnings.join("\n- ")}` : "")
		}],
		details: {
			status: "running",
			sessionId: params.sessionId,
			...
			switch (params.action) {
				case "poll": {
					if (!scopedSession) {
						if (scopedFinished) {
							...
							return {
								content: [{
									type: "text",
									text: appendExecTimeoutRetryGuidance((scopedFinished.tail || `(no output recorded${scopedFinished.truncated ? " — truncated to cap" : ""})`) + `\n\nProcess exited with ${scopedFinished.exitSignal ? `signal ${scopedFinished.exitSignal}` : `code ${scopedFinished.exitCode ?? 0}`}.`, scopedFinished.exitReason)
								}],
								details: {
									status: scopedFinished.status === "completed" ? "completed" : "failed",
									sessionId: params.sessionId,
									exitCode: scopedFinished.exitCode ?? void 0,
									...scopedFinished.exitSignal != null ? { exitSignal: scopedFinished.exitSignal } : {},
									...scopedFinished.exitReason ? {
										exitReason: scopedFinished.exitReason,
										timedOut: scopedFinished.exitReason === "overall-timeout" || scopedFinished.exitReason === "no-output-timeout"
									} : {},
									...scopedFinished.noOutputTimedOut !== void 0 ? { noOutputTimedOut: scopedFinished.noOutputTimedOut } : {},
					...
					if (exited) {
						...
						markExited(scopedSession, scopedSession.exitCode ?? null, scopedSession.exitSignal ?? null, status, scopedSession.exitReason, scopedSession.noOutputTimedOut);
					}
					...
					return {
						content: [{
							type: "text",
							text: appendExecTimeoutRetryGuidance((output || "(no new output)") + (exited ? `\n\nProcess exited with ${exitSignal ? `signal ${exitSignal}` : `code ${exitCode}`}.` : buildInputWaitHint(runtime) || "\n\nProcess still running."), exited ? scopedSession.exitReason : void 0)
						}],
						details: {
							status,
							sessionId: params.sessionId,
							exitCode: exited ? exitCode : void 0,
							...exited && scopedSession.exitSignal != null ? { exitSignal: scopedSession.exitSignal } : {},
							...exited && scopedSession.exitReason ? {
								exitReason: scopedSession.exitReason,
								timedOut: scopedSession.exitReason === "overall-timeout" || scopedSession.exitReason === "no-output-timeout"
							} : {},
							...exited && scopedSession.noOutputTimedOut !== void 0 ? { noOutputTimedOut: scopedSession.noOutputTimedOut } : {},
