...
import { $ as executeSqliteQueryTakeFirstSync, Q as executeSqliteQuerySync, a as openOpenClawStateDatabase, c as runOpenClawStateWriteTransaction, et as getNodeSqliteKysely, j as normalizeSqliteNumber } from "./openclaw-state-db-DkOMT2fb.js";
...
function loadOrCreateAuditIdentityKey(db) {
	...
	if (executeSqliteQueryTakeFirstSync(db, kysely.selectFrom("audit_events").select("sequence").where("kind", "=", "message").limit(1))) throw new Error("audit identity key is missing");
	const candidate = {
...
//#endregion
export { pruneExpiredAuditEvents as n, recordAuditEvent as r, listAuditEvents as t };
