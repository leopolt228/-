	...
	en: {
		...
		wizard: {
			...
			appRecommendations: {
				...
				scanning: "Scanning installed apps — names are matched with your configured model and ClawHub search (disable via wizard.appRecommendations)…",
			...
			finalize: {
				...
				daemonRuntimeNodeHint: "Required because OpenClaw state uses node:sqlite; Bun cannot run the Gateway.",
	...
	"zh-CN": {
		...
		wizard: {
			...
			appRecommendations: {
				...
				scanning: "正在扫描已安装应用 — 应用名称将通过你配置的模型与 ClawHub 搜索进行匹配（可通过 wizard.appRecommendations 关闭）…",
				select: "安装推荐的插件和技能",
	...
	"zh-TW": {
		...
		wizard: {
			...
			appRecommendations: {
				...
				scanning: "正在掃描已安裝的應用程式 — 應用程式名稱會透過你設定的模型與 ClawHub 搜尋進行比對（可透過 wizard.appRecommendations 停用）…",
				select: "安裝推薦的插件和技能",
