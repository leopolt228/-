...
import { D as formatStoppedCronSessionDiagnosticFields, E as resolveStuckSessionRecoveryRef, O as resolveCronSessionDiagnosticContext, T as formatRecoveryOutcome } from "./diagnostic-CiatiVjT.js";
...
import { _ as resolveActiveEmbeddedRunHandleSessionIdBySessionFile, g as resolveActiveEmbeddedRunHandleSessionId, l as isEmbeddedAgentRunActive, t as abortAndDrainEmbeddedAgentRun, u as isEmbeddedAgentRunHandleActive, v as resolveActiveEmbeddedRunSessionIdBySessionFile, y as resolveEmbeddedAgentReplyRunPhase } from "./runs-DDczt14d.js";
import { a as getCommandLaneActiveTaskIds, h as resetCommandLane, o as getCommandLaneSnapshot } from "./command-queue-B2fMJE4M.js";
...
async function recoverStuckDiagnosticSession(params) {
	...
	try {
		...
		if (!activeSessionId && activeWorkSessionId && isEmbeddedAgentRunActive(activeWorkSessionId)) {
			if (resolveEmbeddedAgentReplyRunPhase(activeWorkSessionId) === "waiting_for_deferred_maintenance") {
				const outcome = {
					status: "skipped",
					action: "keep_lane",
