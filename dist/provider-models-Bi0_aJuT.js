...
import { f as cloneFirstTemplateModel } from "./provider-model-shared-Dzz3IkWT.js";
...
function resolveGoogleGeminiForwardCompatModel(params) {
	...
	else if (lower.startsWith(GEMINI_3_1_FLASH_PREFIX) || lower.startsWith(GEMINI_3_5_FLASH_PREFIX) || lower.startsWith(GEMINI_3_FLASH_PREFIX) || lower === GEMINI_FLASH_LATEST_ID) family = {
