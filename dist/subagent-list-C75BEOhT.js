...
import { f as countPendingDescendantRunsFromRuns, j as subagentRuns, l as countActiveDescendantRunsFromRuns, n as getSubagentRunsSnapshotForRead } from "./subagent-registry-state-D4-t_yGj.js";
import { t as compareSubagentRunGeneration } from "./subagent-run-generation-DZIUUsme.js";
import { a as shouldKeepSubagentRunChildLink, n as hasSubagentRunEnded, o as getSubagentSessionRuntimeMs, r as isLiveUnendedSubagentRun, s as getSubagentSessionStartedAt } from "./subagent-run-liveness-DmeVB_Vn.js";
import "./subagent-registry-read-DeKC5r-U.js";
...
function buildLatestSubagentRunIndex(runs, options) {
	...
	for (const entry of runs.values()) {
		...
		if (!existing || compareSubagentRunGeneration(entry, existing) > 0) latestByChildSessionKey.set(childSessionKey, entry);
	}
