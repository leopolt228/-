...
import { t as resolveOAuthClientConfig } from "./oauth.credentials-BzsULcSm.js";
import { t as fetchWithTimeout } from "./oauth.http-B1DC0aY7.js";
import { n as resolveGooglePersonalOAuthIdentity, t as resolveGoogleOAuthIdentity } from "./oauth.project-Ck1f7dI3.js";
import { t as isGeminiCliPersonalOAuth } from "./oauth.settings-BMn_Gm2R.js";
...
async function requestTokenGrant(body, signal) {
...
async function resolveGeminiCliIdentity(accessToken, signal) {
	return isGeminiCliPersonalOAuth() ? await resolveGooglePersonalOAuthIdentity(accessToken, signal) : await resolveGoogleOAuthIdentity(accessToken, signal);
}
