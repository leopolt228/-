import { t as SafeBinProfile } from "./exec-safe-bin-policy-profiles-CWCK911g.js";
...
//#endregion
export { requireValidExecTarget as $, resolveExecutionTargetResolution as $t, commandRequiresSecurityAuditSuppressionApproval as A, resolveSafeBins as At, normalizeExecApprovalUnavailableDecisions as B, ShellChainOperator as Bt, ExecTarget as C, evaluateExecAllowlistWithAuthorization as Ct, SystemRunApprovalPlan as D, normalizeSafeBins as Dt, SystemRunApprovalFileOperand as E, isSafeBinUsage as Et, isExecApprovalDecisionAllowed as F, tokenizeWindowsSegment as Ft, normalizeExecSecurity as G, parseExecArgvToken as Gt, normalizeExecAsk as H, ExecArgvToken as Ht, loadExecApprovals as I, windowsEscapeArg as It, persistAllowAlwaysPatterns as J, resolveApprovalAuditTrustPath as Jt, normalizeExecTarget as K, resolveAllowlistCandidatePath as Kt, maxAsk as L, analyzeArgvCommand as Lt, hasDurableExecApproval as M, resolvePlannedSegmentArgv as Mt, hasExactCommandDurableExecApproval as N, analyzeWindowsShellCommand as Nt, addAllowlistEntry as O, resolveAllowAlwaysPatternEntries as Ot, hasNodeCommandAllowAlwaysMarker as P, isWindowsPlatform as Pt, requestExecApprovalViaSocket as Q, resolveExecutionTargetCandidatePath as Qt, mergeExecApprovalsSocketDefaults as R, ExecCommandAnalysis as Rt, ExecSecurity as S, evaluateExecAllowlist as St, SystemRunApprovalBinding as T, evaluateShellAllowlistWithAuthorization as Tt, normalizeExecHost as U, ExecutableResolution as Ut, normalizeExecApprovals as V, CommandResolution as Vt, normalizeExecMode as W, matchAllowlist as Wt, recordAllowlistMatchesUse as X, resolveCommandResolutionFromArgv as Xt, readExecApprovalsSnapshot as Y, resolveCommandResolution as Yt, recordAllowlistUse as Z, resolveExecutableTrustPath as Zt, ExecApprovalsResolved as _, AllowAlwaysPattern as _t, DEFAULT_EXEC_APPROVAL_TIMEOUT_MS as a, ExecAllowlistEntry as an, resolveExecApprovalUnavailableDecisions as at, ExecHost as b, ExecSegmentSatisfiedBy as bt, ExecApprovalDecision as c, resolveExecApprovalsFromFile as ct, ExecApprovalResolved as d, resolveExecApprovalsTranscriptPath as dt, resolveExecutionTargetTrustPath as en, requiresExecApproval as et, ExecApprovalUnavailableDecision as f, resolveExecModeFromPolicy as ft, ExecApprovalsFile as g, saveExecApprovals as gt, ExecApprovalsDefaults as h, restoreExecApprovalsSnapshot as ht, DEFAULT_EXEC_APPROVAL_DECISIONS as i, resolvePolicyTargetTrustPath as in, resolveExecApprovalRequestAllowedDecisions as it, ensureExecApprovals as j, buildEnforcedShellCommand as jt, addDurableCommandApproval as k, resolveAllowAlwaysPatterns as kt, ExecApprovalRequest as l, resolveExecApprovalsPath as lt, ExecApprovalsDefaultOverrides as m, resolveExecPolicyForMode as mt, AllowAlwaysPersistenceReason as n, resolvePolicyTargetCandidatePath as nn, resolveAllowAlwaysPersistenceDecision as nt, EXEC_TARGET_VALUES as o, CommandExplanationSummary as on, resolveExecApprovals as ot, ExecApprovalsAgent as p, resolveExecModePolicy as pt, persistAllowAlwaysDecision as q, resolveApprovalAuditCandidatePath as qt, DEFAULT_EXEC_APPROVAL_ASK_FALLBACK as r, resolvePolicyTargetResolution as rn, resolveExecApprovalAllowedDecisions as rt, ExecApprovalCommandSpan as s, resolveExecApprovalsDisplayPath as st, AllowAlwaysPersistenceDecision as t, resolvePolicyAllowlistCandidatePath as tn, resolveAllowAlwaysPatternCoverage as tt, ExecApprovalRequestPayload as u, resolveExecApprovalsSocketPath as ut, ExecApprovalsSnapshot as v, ExecAllowlistAnalysis as vt, OPTIONAL_EXEC_APPROVAL_DECISIONS as w, evaluateShellAllowlist as wt, ExecMode as x, SkillBinTrustEntry as xt, ExecAsk as y, ExecAllowlistEvaluation as yt, minSecurity as z, ExecCommandSegment as zt };