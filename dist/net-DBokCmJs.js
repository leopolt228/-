...
import { f as isLoopbackIpAddress, h as normalizeIpAddress, i as isCanonicalDottedDecimalIPv4, p as isPrivateOrLoopbackIpAddress, s as isIpInCidr } from "./ip-DorYMgxW.js";
import { t as isContainerEnvironment } from "./container-environment-CNsJSTpY.js";
import { i as safeNetworkInterfaces, n as pickMatchingExternalInterfaceAddress, r as readNetworkInterfaces } from "./network-interfaces-S5y8vKUw.js";
import { n as pickPrimaryTailnetIPv4 } from "./tailnet-GjWC2Uzc.js";
...
async function resolveGatewayListenHosts(bindHost, opts) {
	if (bindHost !== "127.0.0.1") {
		if (!isValidIPv4(bindHost) || bindHost === "0.0.0.0") return [bindHost];
