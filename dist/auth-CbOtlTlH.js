...
import { i as resolvePluginSetupRegistry, r as resolvePluginSetupProvider } from "./setup-registry-DIXn9uxN.js";
...
import { a as removeProviderAuthProfilesWithLock, c as upsertAuthProfileWithLock, r as promoteAuthProfileInOrder } from "./profiles-C6oqGGG6.js";
import { n as clearAuthProfileCooldown } from "./usage-DaLssncS.js";
import "./workspace-GYctLxSN.js";
import { t as isRemoteEnvironment } from "./remote-env-DSyyEvIx.js";
import { a as restorePriorAgentsDefaultsModelUnlessOptIn, i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-1_AB1oXL.js";
...
import { n as validateAnthropicSetupToken } from "./provider-auth-token-DyHOhkct.js";
...
import { a as loadValidConfigOrThrow, d as updateConfig, s as resolveKnownAgentId } from "./shared-Dys0_Ah-.js";
...
async function runProviderAuthMethod(params) {
	...
	const result = await params.method.run({
		...
		openUrl: params.openUrl ?? (async (url) => {
			const { openUrl } = await import("./onboard-helpers-BtjO0REF.js");
			await openUrl(url);
		}),
...
//#endregion
export { modelsAuthAddCommand, modelsAuthLoginCommand, modelsAuthPasteApiKeyCommand, modelsAuthPasteTokenCommand, modelsAuthSetupTokenCommand, resolveLoginProfiles, resolveRequestedLoginProviderOrThrow, runModelsAuthLoginFlow };
