...
function findRuntimeInjectionIndex(html) {
	let cursor = 0;
	let fallback = 0;
	while (cursor < html.length) {
		...
		if (content.startsWith("/")) return fallback || tagStart;
...
//#endregion
export { isA2uiPath as a, injectCanvasRuntime as i, CANVAS_HOST_PATH as n, CANVAS_WS_PATH as r, A2UI_PATH as t };
