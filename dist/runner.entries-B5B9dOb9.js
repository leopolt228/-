...
import { C as FsSafeError, g as assertNoWindowsNetworkPath, x as safeFileURLToPath } from "./path-DILYn_gk.js";
import { g as pathExists, r as writeExternalFileWithinRoot } from "./fs-safe-Dy0g6QwA.js";
...
import { t as buildRandomTempFilePath } from "./temp-download-DkyJ3ps0.js";
import { n as createConfigScopedPromiseLoader } from "./plugin-cache-primitives-BaxqicKH.js";
import { r as getOfficialExternalPluginCatalogManifest, u as listOfficialExternalProviderCatalogEntries } from "./official-external-plugin-catalog-D3_jWsTb.js";
...
import { n as CUSTOM_LOCAL_AUTH_MARKER } from "./model-auth-markers-Bqpoo9x7.js";
import { a as mergeModelProviderRequestOverrides, d as sanitizeConfiguredProviderRequest, u as sanitizeConfiguredModelProviderRequest } from "./provider-request-config-DrrUROfX.js";
import { c as kindFromMime, i as getFileExtension, n as detectMime, o as isAudioFileName } from "./mime-De36NoRj.js";
...
import { i as convertHeicToJpeg } from "./image-ops-BFeNLIan.js";
...
import { r as readRemoteMediaBuffer, t as MediaFetchError } from "./fetch-Mq4HGaV9.js";
import { r as mergeInboundPathRoots, t as isInboundPathAllowed } from "./inbound-path-policy-CH_uJYn5.js";
import { i as getDefaultMediaLocalRoots } from "./local-roots-BxhvvT09.js";
import { n as resolveOfficialExternalPluginRepairHint } from "./official-external-plugin-repair-hints-DvYibrHg.js";
import { r as providerOperationRetryConfig } from "./operation-retry-Dmka1f2f.js";
...
import { a as DEFAULT_TIMEOUT_SECONDS, l as getMediaUnderstandingProvider, n as DEFAULT_MAX_BYTES, o as DEFAULT_VIDEO_MAX_BASE64_BYTES, s as MIN_AUDIO_FILE_BYTES, t as CLI_OUTPUT_MAX_BUFFER } from "./defaults.constants-iEQlxleo.js";
import { t as assertRuntimeMediaRequestSecretOwnerAvailable } from "./runtime-media-secret-owner-B5XrdRNw.js";
import { c as resolveTimeoutMs, n as resolveMaxBytes, o as resolvePrompt, r as resolveMaxChars } from "./resolve-CMSY74Kr.js";
...
import { n as executeWithApiKeyRotation, t as collectProviderApiKeysForExecution } from "./api-key-rotation-DYvDBVp_.js";
	...
	async getBuffer(params) {
		...
		if (entry.resolvedPath) try {
			...
			if (entry.resolvedPath) {
				...
				entry.buffer = buffer;
				entry.bufferMime = entry.bufferMime ?? await detectMime({
					buffer,
					filePath,
...
const loadModelAuth = createLazyRuntimeModule(async () => await import("./model-auth-DSfNXC-c.js"));
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || (await import("./defaults-Vj9KZsKF.js")).resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio",
			workspaceDir: params.workspaceDir
...
//#endregion
export { isAudioAttachment as C, extractPdfContent as E, selectAttachments as S, resolveAttachmentKind as T, clearLocalAudioInspectionCacheForTests as _, runCliEntry as a, MediaAttachmentCache as b, normalizeImageDescriptionInput as c, DEFAULT_INPUT_TIMEOUT_MS as d, extractFileContentFromSource as f, resolveInputFileLimits as g, normalizeMimeType as h, normalizeDecisionReason as i, DEFAULT_INPUT_IMAGE_MAX_BYTES as l, normalizeMimeList as m, findDecisionReason as n, runProviderEntry as o, extractImageContentFromSource as p, formatDecisionSummary as r, summarizeDecisionReason as s, buildModelDecision as t, DEFAULT_INPUT_IMAGE_MIMES as u, formatLocalAudioSelection as v, normalizeAttachments as w, isMediaUnderstandingSkipError as x, inspectLocalAudioSelection as y };
