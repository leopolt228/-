...
import { E as collectDurableServiceEnvVarSources, T as writeManagedServiceEnvKeysToEnvironment, b as formatManagedServiceEnvKeys, w as readManagedServiceEnvKeysFromEnvironment, x as hasEnvironmentFileSource } from "./systemd-iYtBw5_g.js";
...
import { i as resolveOpenClawWrapperPath, n as resolveGatewayProgramArguments, t as OPENCLAW_WRAPPER_ENV_KEY } from "./program-args-DmoB00d4.js";
import { d as buildServiceEnvironment, s as isNonMinimalServicePathEntry } from "./runtime-paths-HrqyQmEH.js";
import { n as loadPluginManifestRegistry } from "./manifest-registry-DkJa8Tn0.js";
import { a as isPluginIntegrationSecretProviderConfig, s as resolveSecretProviderIntegrationConfig } from "./resolve-DhgogJwd.js";
...
import { i as resolveDaemonServicePathDirs, n as resolveDaemonInstallRuntimeInputs, t as emitDaemonInstallRuntimeWarning } from "./daemon-install-plan.shared-lLg4qu1Q.js";
...
const PRESERVED_OPENCLAW_OPERATOR_OPT_IN_ENV_KEYS = /* @__PURE__ */ new Set(["OPENCLAW_CLI_CONTAINER_BYPASS", "OPENCLAW_CONTAINER_HINT"]);
...
function collectExistingEnvironmentFileManagedServiceEnvVars(params) {
	...
	for (const [rawKey, rawValue] of Object.entries(params.existingEnvironment)) {
		...
		if (isDangerousHostEnvVarName(key) || isDangerousHostEnvOverrideVarName(key)) continue;
		if (!hasEnvironmentFileSource(readExistingEnvironmentValueSource({
