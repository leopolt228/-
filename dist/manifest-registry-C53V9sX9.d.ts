 ...
 */
type PluginDiagnosticCode = "channel-setup-failure" | "plugin-verification";
...
type ModelCatalogProvider = {
  baseUrl?: string;
  api?: ModelCatalogApi;
  headers?: Record<string, string>; /** Provider-recommended small model id for short internal utility tasks. */
...
type PluginManifestSecretInputPath = {
  ...
  expected?: "string"; /** Runtime owner kind used to isolate this surface when resolution fails. */
  ownerKind?: "route";
};
...
type PluginManifest = {
   ...
   */
  commandAliases?: PluginManifestCommandAlias[]; /** Usage/billing credentials excluded from inference auth but included in secret scrubbing. */
  providerUsageAuthEnvVars?: Record<string, string[]>; /** Provider ids that should reuse another provider id for auth lookup. */
  ...
  skills?: string[];
  name?: string;
  description?: string; /** Optional presentation hints for plugin catalog surfaces. */
  catalog?: PluginManifestCatalog; /** Optional HTTPS URL for marketplace/catalog card artwork. */
  icon?: string;
  version?: string;
  uiHints?: Record<string, PluginConfigUiHint>;
  /**
...
type PluginManifestContracts = {
  ...
  workerProviders?: string[]; /** Provider ids whose plugin owns usage auth and snapshot hooks. */
...
type PluginManifestProviderAuthChoice = {
  ...
  choiceLabel?: string;
  choiceHint?: string; /** Optional HTTPS artwork URL for native and web onboarding surfaces. */
  icon?: string; /** Optional HTTPS product or installation URL for onboarding surfaces. */
  website?: string; /** Lower values sort earlier in interactive assistant pickers. */
  ...
  cliFlag?: string;
  cliOption?: string;
  cliDescription?: string; /** One pasted secret plus provider defaults is sufficient for app-guided setup. */
  appGuidedSecret?: boolean; /** Provider-owned interactive login that native setup clients can render generically. */
  appGuidedAuth?: "oauth" | "device-code";
  /**
   * Interactive onboarding surfaces where this auth choice should appear.
   * Defaults to `["text-inference"]` when omitted.
   */
  onboardingScopes?: PluginManifestOnboardingScope[]; /** Provider runtime can discover and prepare an already-installed local model. */
...
type PluginPackageChannel = {
  ...
  markdownCapable?: boolean; /** Closed manifest flags for approval behavior available before the channel runtime loads. */
...
//#endregion
export { PluginDiagnostic as _, PluginDependencyStatus as a, PluginManifestContracts as c, PluginKind as d, UnifiedModelCatalogEntry as f, PluginConfigUiHint as g, PluginBundleFormat as h, PluginDiscoveryResult as i, PluginPackageChannel as l, UnifiedModelCatalogSource as m, PluginManifestRegistry as n, OpenClawPackageBuild as o, UnifiedModelCatalogKind as p, PluginCandidate as r, PluginManifestActivation as s, PluginManifestRecord as t, PluginPackageInstall as u, PluginFormat as v };