import { n as resolvePlannedSegmentArgv } from "./exec-approvals-analysis-eausQ51Q.js";
...
function shouldRewriteCandidate(params) {
	if (params.mode === "enforced") return true;
...
//#endregion
export { buildAuthorizedShellCommandFromPlan as t };
