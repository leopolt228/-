...
import { a as resolveCoreToolProfilePolicy, t as CORE_TOOL_GROUPS } from "./tool-catalog-Bi5DGU0C.js";
...
function expandPluginGroups(list, groups) {
	...
	for (const entry of list) {
		...
		const promotedCoreTools = (SHIPPED_PLUGIN_POLICY_FAMILY_CORE_TOOLS.get(normalized) ?? []).filter((toolName) => !groups.all.includes(toolName));
