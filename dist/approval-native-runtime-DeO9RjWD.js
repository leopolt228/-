...
import { l as readConnectErrorDetailCode } from "./connect-error-details-BxqBqDDT.js";
import { i as isApprovalMethod } from "./method-scopes-DN3UnWnt.js";
...
import { n as createApprovalNativeRouteReporter } from "./approval-native-route-coordinator-Bjc3IzVv.js";
import { t as buildChannelApprovalNativeTargetKey } from "./approval-native-target-key-CcEHFoK3.js";
import { t as createOperatorApprovalsGatewayClient } from "./operator-approvals-client-BjN2cyQf.js";
...
function createChannelNativeApprovalRuntime(adapter) {
	...
	const routeReporter = (gatewayRuntime?.routeCoordinator.createReporter ?? createApprovalNativeRouteReporter)({
		...
		requestGateway: async (method, params) => {
			...
			const { callGatewayLeastPrivilege } = await import("./call-Au-Dq1sZ.js");
