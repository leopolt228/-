...
import { r as isSetupSingleAccountPromotionKey, t as collectSingleAccountPromotionEntries } from "./setup-promotion-keys-8uS1jFgo.js";
...
function moveSingleAccountKeysIntoAccount(params) {
	...
	for (const key of params.keysToMove) if (!(key in nextAccount)) nextAccount[key] = cloneIfObject(params.channel[key]);
...
function resolveSingleAccountPromotionTarget(params) {
	...
	return namedAccounts.length === 1 ? expectDefined(namedAccounts[0], "named accounts entry at 0") : DEFAULT_ACCOUNT_ID;
}
/**
