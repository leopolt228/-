...
import { S as registerAgentRunContext } from "./agent-events-Dg0sI2pr.js";
...
import { r as wrapUntrustedPromptDataBlock } from "./sanitize-for-prompt-Drdy09dw.js";
import { n as runAgentHarnessBeforeMessageWriteHook } from "./hook-helpers-ey8aD0rO.js";
import { o as runWithModelFallback, u as LiveSessionModelSwitchError } from "./model-fallback-CVFSvXjG.js";
...
import { a as getCliSessionBinding, c as resolveCurrentChannelTarget, n as resolveFallbackCronSourceDeliveryPlan, o as runCliAgent, r as resolveCronFallbacksOverride, s as resolveCronChannelOutputPolicy } from "./source-delivery-fallback-DFAB3Epk.js";
import { l as syncCronSessionLiveSelection, p as resolveCronPayloadOutcome } from "./run-session-state-BkyW25dE.js";
...
function createCronPromptExecutor(params) {
	const sessionFile = params.cronSession.sessionEntry.sessionFile?.trim() || formatSqliteSessionFileMarker({
		agentId: params.agentId,
