...
import { l as mimeTypeFromFilePath, r as extensionForMime } from "./mime-De36NoRj.js";
import { n as estimateBase64DecodedBytes } from "./base64-hBzWwdnH.js";
import { l as saveMediaBuffer, r as deleteMediaBuffer } from "./store-NmJjqmad.js";
import { k as sniffMimeFromBase64 } from "./openclaw-tools-U0Zy3sfO.js";
...
function resolveChatAttachmentMaxBytes(cfg) {
	...
	return Math.floor((typeof configured === "number" && Number.isFinite(configured) && configured > 0 ? configured : DEFAULT_CHAT_ATTACHMENT_MAX_MB) * 1024 * 1024);
}
