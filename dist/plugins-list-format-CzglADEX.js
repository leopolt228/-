...
function formatPluginLine(plugin, verbose = false) {
	...
	const desc = plugin.description ? theme.muted(plugin.description.length > 60 ? `${truncateUtf16Safe(plugin.description, 57)}...` : plugin.description) : theme.muted("(no description)");
