...
import { _ as truncateErrorDetail } from "./provider-http-errors-DrOMjuGn.js";
import { n as resolveProviderEndpoint } from "./provider-attribution-D75_xhiu.js";
import { _ as buildCopilotDynamicHeaders, l as resolveProviderRequestPolicyConfig, y as hasCopilotVisionInput } from "./provider-request-config-DrrUROfX.js";
import { r as sanitizeInlineImageDataUrl } from "./inline-image-data-url-oC-MoRLP.js";
import { N as resolveProviderTransportTurnStateWithPlugin } from "./provider-runtime-BE5KxvKF.js";
import { t as detectOpenAICompletionsCompat } from "./openai-completions-compat-5VEhvM0W.js";
import { t as resolveOpenAIStrictToolSetting } from "./ai-transport-host-CpSAJnEP.js";
import { a as formatModelTransportDebugBaseUrl, c as resolveModelSseDebugMode, o as emitModelTransportDebug, r as resolveModelRequestTimeoutMs, s as resolveModelPayloadDebugMode, t as buildGuardedModelFetch } from "./provider-transport-fetch-CqHtV1lD.js";
import { t as event_stream_exports } from "./event-stream-MHM-_qcK.js";
import { n as repairToolUseResultPairing } from "./session-transcript-repair-RGUYmndm.js";
...
import { s as isCodeModeModelVisibleToolName } from "./code-mode-control-tools-Byyzl1H3.js";
import { h as isGoogleGemini3ProModel, j as resolveOpenAIReasoningEffortMap, m as isGoogleGemini3FlashModel } from "./provider-stream-shared-BiURRLUJ.js";
import { randomUUID } from "node:crypto";
import { clampOpenAIPromptCacheKey, convertMessages, createResponsesToolCallTracker, findOpenAIStrictToolProjectionDiagnostics, isOpenAICompatibleAzureResponsesBaseUrl, isOpenAIGpt54MiniModel, isOpenAIGpt55Model, isOpenAIGpt56Model, isResponsesTextContentPartType, isResponsesTextDeltaEventType, mapOpenAIStopReason, mapResponsesTerminalUsage, normalizeOpenAIReasoningEffort, normalizeOpenAIStrictToolParameters, projectOpenAITools, readResponsesReasoningTokens, readResponsesToolCallItemIdentity, reconcileOpenAICompletionsToolChoice, reconcileOpenAIResponsesToolChoice, resolveAzureDeploymentNameFromMap, resolveOpenAIProjectedToolsStrictToolFlag, resolveOpenAIReasoningEffortForModel, resolveResponsesMessageSnapshotCollapse, resolveResponsesTerminalStopReason, supportsOpenAIReasoningEffort } from "@openclaw/ai/internal/openai";
...
import { describeToolResultMediaPlaceholder, extractToolResultText, isImageWithMediaPayload, sanitizeSurrogates, stripSystemPromptCacheBoundary } from "@openclaw/ai/internal/shared";
...
//#endregion
//#region src/agents/openai-transport-shared.ts
...
//#endregion
//#region src/agents/openai-transport-params.ts
...
function readToolPayloadField$1(record, field) {
	try {
		return record[field];
	} catch {
		return;
...
function transportPayloadToolName(tool) {
	...
	const name = readToolPayloadField$1(tool, "name");
	if (typeof name === "string") return name;
	const fn = readToolPayloadField$1(tool, "function");
	if (!isRecord(fn)) return;
	const fnName = readToolPayloadField$1(fn, "name");
...
//#endregion
//#region src/agents/openai-completions-transport.ts
	...
	return (model, context, options) => {
		...
		(async () => {
			...
			try {
				...
				let params = buildOpenAICompletionsParams$1(model, context, options);
...
function buildOpenAICompletionsParams$1(model, context, options) {
	const compat = getCompat(model);
...
//#endregion
//#region src/agents/openai-responses-terminal-outcome.ts
function readIncompleteReason(response) {
...
function recordResponsesTerminalOutcome(params) {
...
//#endregion
//#region src/agents/openai-responses-transport.ts
/**
...
function buildOpenAICompletionsParams(model, context, options) {
	return buildOpenAICompletionsParams$1(model, context, options);
}
//#endregion
export { isReasoningOnlyLengthAssistantTurn as C, hasOnlyAssistantReasoningContent as S, finalizeTransportStream as _, resolveOpenAIResponsesPayloadPolicy as a, sanitizeTransportPayloadText as b, stripCompletionMessagesToRoleContent as c, resolveMaxTokensParam as d, coerceTransportToolCallArguments as f, failTransportStream as g, encodeAssistantTextSignatureV1 as h, applyOpenAIResponsesPayloadPolicy as i, supportsModelTools as l, createWritableTransportEventStream as m, createAzureOpenAIResponsesTransportStreamFn as n, createOpenAICompletionsTransportStreamFn as o, createEmptyTransportUsage as p, createOpenAIResponsesTransportStreamFn as r, flattenCompletionMessagesToStringContent as s, buildOpenAICompletionsParams as t, canonicalizeMaxTokensParam as u, mergeTransportHeaders as v, transformTransportMessages as x, sanitizeNonEmptyTransportPayloadText as y };
