...
import { s as writeTextFileAtomic, t as isNonEmptyString } from "./shared-hYiou55H.js";
import { t as assertExpectedResolvedSecretValue } from "./secret-value-6FGp-c6U.js";
import { n as getPath, r as setPathCreateStrict, t as deletePathStrict } from "./path-utils-BQoJTFAB.js";
import { i as normalizePluginConfigId } from "./provider-auth-aliases-DqR_mVNH.js";
import { r as listKnownSecretEnvVarNames } from "./provider-env-vars-BX8unNjx.js";
...
import { i as coercePersistedAuthProfileStore, o as loadPersistedAuthProfileStore } from "./persisted-BCOBzYGx.js";
import { c as resolveAuthProfileDatabasePath } from "./sqlite-CCIog9t1.js";
import { _ as saveAuthProfileStoreIfPersistenceSnapshotMatches, d as loadAuthProfileStoreForSecretsRuntime, h as restoreAuthProfileStorePersistenceSnapshot, t as captureAuthProfileStorePersistenceSnapshot } from "./store-BTcmQtbp.js";
...
import { a as parseEnvAssignmentValue, c as iterateAuthProfileCredentials, i as listSecretsDotEnvPaths, n as listAuthProfileStoreAgentDirs, o as readJsonObjectIfExists, r as listLegacyAuthJsonPaths, s as createSecretsConfigIO } from "./storage-scan-Rciqo1bv.js";
import { n as normalizeSecretsPlanOptions, r as resolveValidatedPlanTarget } from "./plan-CAhNK4aB.js";
...
async function runSecretsApply(params) {
	...
	try {
		...
		for (const snapshot of authStoreSnapshots.values()) {
			...
			try {
				restoreAuthProfileStorePersistenceSnapshot(snapshot.persistence, snapshot.owned, snapshot.agentDir);
			} catch {}
		}
