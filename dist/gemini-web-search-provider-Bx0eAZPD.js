...
const loadGeminiWebSearchRuntime = createLazyRuntimeModule(() => import("./gemini-web-search-provider.runtime.js"));
...
function createGeminiWebSearchProvider() {
	const contractFields = createBaseWebSearchProviderContractFields({
