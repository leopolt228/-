...
import { g as readMatrixIdbSnapshotJson, t as MATRIX_IDB_SNAPSHOT_FILENAME, y as writeMatrixIdbSnapshotJson } from "./crypto-state-store-eod25Kjg.js";
	...
	deleteIndex(name) {
		...
		this.transaction._execRequestAsync({
			operation: () => {
				...
				if (rawIndex === rawIndex2) this._rawObjectStore.rawIndexes.delete(name);
			},
			source: this
		});
	}
