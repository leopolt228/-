...
import { o as isFileLogLevelEnabled, r as getChildLogger, y as levelToMinLevel } from "./logger-Dy4xN1lg.js";
import { t as loggingState } from "./state-CZ7QadD1.js";
import { l as shouldLogSubsystemToConsole, n as formatConsoleTimestamp, r as getConsoleSettings } from "./console-DvVy2coK.js";
...
function pickSubsystemColor(color, subsystem) {
	...
	return color[expectDefined(SUBSYSTEM_COLORS[idx], "subsystem colors entry at idx")];
}
