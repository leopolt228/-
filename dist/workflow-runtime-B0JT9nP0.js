...
import { b as ssrfPolicyFromHttpBaseUrlAllowedOrigin, m as mergeSsrFPolicies } from "./ssrf-eKWXIRoD.js";
import { r as fetchWithSsrFGuard } from "./fetch-guard-C7JzO8vD.js";
import { o as normalizeBaseUrl } from "./provider-request-config-DrrUROfX.js";
...
if (process.env.VITEST === "true") Reflect.set(globalThis, Symbol.for("openclaw.comfyTestApi"), {
...
const readJsonResponseForTest = readJsonResponse;
...
async function runComfyWorkflow(params) {
	...
	const explicitAllowPrivateNetwork = readConfigBoolean(capabilityConfig, "allowPrivateNetwork") === true;
...
//#endregion
export { runComfyWorkflow as i, isComfyCapabilityConfigured as n, readJsonResponseForTest as r, DEFAULT_COMFY_MODEL as t };
