...
import { m as readProviderJsonResponse, n as asObject, r as assertOkOrThrowHttpError } from "./provider-http-errors-DrOMjuGn.js";
import { c as postJsonRequest, p as resolveProviderHttpRequestConfig } from "./shared-CpiwWgfg.js";
...
import { a as DEFAULT_VYDRA_VOICE_ID, c as normalizeVydraBaseUrl, m as trimToUndefined, o as downloadVydraAsset, r as DEFAULT_VYDRA_SPEECH_MODEL, s as extractVydraResultUrls, t as DEFAULT_VYDRA_BASE_URL, u as resolveVydraGeneratedMediaMaxBytes } from "./shared-DyjX7xto.js";
...
function buildVydraSpeechProvider() {
	return {
		...
		isConfigured: ({ providerConfig }) => Boolean(resolveSpeechProviderApiKey(readVydraSpeechConfig(providerConfig).apiKey, process.env.VYDRA_API_KEY)),
		synthesize: async (req) => {
			...
			try {
				...
				const audioUrl = extractVydraResultUrls(await readProviderJsonResponse(response, "Vydra speech synthesis"), "audio")[0];
