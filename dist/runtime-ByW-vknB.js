...
import { h as redactRegisteredSecretValues, p as hasRegisteredSecretValuesForRedaction } from "./redact-DNq_HeDt.js";
import { a as sha256Hex } from "./crypto-digest-CmUwt1S-.js";
import { a as openOpenClawStateDatabase, g as resolveSqliteDatabaseFilePaths, k as applyPrivateModeSync } from "./openclaw-state-db-DkOMT2fb.js";
import { i as requireNodeSqlite, r as runSqliteImmediateTransactionSync } from "./sqlite-transaction-DCHi8Wi-.js";
import { a as migrateSqliteSchemaToStrict, i as registerSqliteCacheExitClose, t as configureSqliteConnectionPragmas } from "./sqlite-wal-jkTlXxi6.js";
...
function redactedCaptureHeaders(headers) {
	...
	const redacted = {};
	for (const [name, value] of entries) redacted[name] = isSensitiveCaptureHeaderName(name) ? REDACTED_CAPTURE_HEADER_VALUE : redactRegisteredSecretValues(value, () => REDACTED_CAPTURE_HEADER_VALUE);
	return redacted;
}
