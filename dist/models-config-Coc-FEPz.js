...
import { c as resolveDefaultAgentId, o as resolveAgentWorkspaceDir, s as resolveDefaultAgentDir } from "./agent-scope-config-S7z_Yn4H.js";
import { t as MODEL_APIS } from "./types.models-BHfgMdAm.js";
import { n as resolveInstalledManifestRegistryIndexFingerprint } from "./manifest-registry-installed-D9b8crqj.js";
...
import { r as getRuntimeConfig, t as projectConfigOntoRuntimeSourceSnapshot } from "./io-CEgS2K9F.js";
import "./env-vars-CdPCvJw6.js";
import { c as getRuntimeConfigSourceSnapshot, u as hashRuntimeConfigValue } from "./runtime-snapshot-BW7iP5ad.js";
import { m as parseConfiguredModelVisibilityEntries } from "./model-selection-shared-CPPxIJAX.js";
import { n as normalizeConfiguredProviderCatalogModelId } from "./model-ref-shared-BlCyhiC_.js";
import "./config-BOMcY2yX.js";
import { c as isNonSecretApiKeyMarker, d as resolveEnvSecretRefHeaderValueMarker, f as resolveNonEnvSecretRefApiKeyMarker, p as resolveNonEnvSecretRefHeaderValueMarker } from "./model-auth-markers-Bqpoo9x7.js";
import { d as resolveOwningPluginIdsForProviderRef } from "./providers--CvgyIAL.js";
import { m as normalizeProviderConfigWithPlugin, n as applyProviderNativeStreamingUsageCompatWithPlugin, w as resolveProviderConfigApiKeyWithPlugin } from "./provider-runtime-BE5KxvKF.js";
...
import { a as isGeneratedPluginModelCatalog, c as listPluginModelCatalogRelativePaths, l as resolvePluginModelCatalogOwnerPluginId, n as decodePluginModelCatalogRelativePathPluginId, o as isPluginModelCatalogRelativePath, r as encodePluginModelCatalogRelativePath, t as PLUGIN_MODEL_CATALOG_GENERATED_BY } from "./plugin-model-catalog-DQnRGIJo.js";
import { a as runProviderStaticCatalog, i as runProviderCatalog, n as normalizePluginDiscoveryResult, r as resolveRuntimePluginDiscoveryProviders, t as groupPluginDiscoveryProvidersByOrder } from "./provider-discovery-B-1rMaLa.js";
import { a as normalizeConfiguredProviderApiKey, c as resolveApiKeyFromProfiles, l as resolveMissingProviderApiKey, o as normalizeHeaderValues, r as createProviderAuthResolver, s as normalizeResolvedEnvApiKey, t as createProviderApiKeyResolver } from "./models-config.providers.secrets-M8Q2_pbW.js";
...
//#endregion
//#region src/agents/models-config.providers.keys.ts
...
if (process.env.VITEST || false) globalThis[Symbol.for("openclaw.modelsConfigImplicitProvidersTestApi")] = {
...
function normalizeSourceProviderLookup(providers) {
	if (!providers) return {};
	return normalizeProviderMapKeys(Object.fromEntries(Object.entries(providers).filter(([, provider]) => isRecord(provider))));
}
