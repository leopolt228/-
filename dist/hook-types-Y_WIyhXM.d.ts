...
import { h as PluginHookChannelContext, t as FinalizedMsgContext } from "./templating-CzGprbNA.js";
import { t as DiagnosticTraceContext } from "./diagnostic-trace-context-c5mRZYEt.js";
import { t as PluginConversationBinding } from "./conversation-binding.types-LLufWXN1.js";
 ...
 */
| "subagent_spawning" | "subagent_delivery_target" | "subagent_spawned" | "subagent_progress" | "subagent_ended" /** @deprecated Use gateway_stop. */ | "deactivate" | "gateway_start" | "gateway_stop" | "heartbeat_prompt_contribution" | "cron_reconciled" | "cron_changed" | "before_dispatch" | "reply_dispatch" | "before_install" | "before_agent_run" | "resolve_exec_env";
...
//#endregion
export { PluginHookSubagentSpawnedEvent as $, PluginHookLlmInputEvent as A, PluginHookBeforePromptBuildEvent as At, PluginHookReplyPayloadSendingContext as B, PluginHookCronReconciledContext as C, PluginHookMessageSentEvent as Ct, PluginHookGatewayStopEvent as D, PluginHookBeforeToolCallResult as Dt, PluginHookGatewayStartEvent as E, PluginApprovalResolution as Et, PluginHookRegistration as F, ReplyDispatchRuntimeInfo as Ft, PluginHookSessionContext as G, PluginHookReplyPayloadSendingResult as H, PluginHookReplyDispatchContext as I, ReplyDispatcher as It, PluginHookSubagentContext as J, PluginHookSessionEndEvent as K, PluginHookReplyDispatchEvent as L, ReplyFollowupAdmissionBarrierTimeoutPolicy as Lt, PluginHookModelCallEndedEvent as M, ReplyDispatchBeforeDeliver as Mt, PluginHookModelCallStartedEvent as N, ReplyDispatchBeforeDeliverOptions as Nt, PluginHookHandlerMap as O, PluginHookBeforeModelResolveEvent as Ot, PluginHookName as P, ReplyDispatchKind as Pt, PluginHookSubagentProgressEvent as Q, PluginHookReplyDispatchResult as R, PluginHookCronChangedEvent as S, PluginHookMessageSendingResult as St, PluginHookGatewayContext as T, InputGateDecision as Tt, PluginHookResolveExecEnvContext as U, PluginHookReplyPayloadSendingEvent as V, PluginHookResolveExecEnvEvent as W, PluginHookSubagentDeliveryTargetResult as X, PluginHookSubagentDeliveryTargetEvent as Y, PluginHookSubagentEndedEvent as Z, PluginHookBeforeMessageWriteEvent as _, PluginHookInboundClaimContext as _t, PluginHookBeforeAgentFinalizeEvent as a, PluginHookToolRequesterContext as at, PluginHookBeforeToolCallEvent as b, PluginHookMessageReceivedEvent as bt, PluginHookBeforeAgentReplyResult as c, PluginHookToolResultPersistResult as ct, PluginHookBeforeDispatchContext as d, PluginHeartbeatPromptContributionEvent as dt, PluginHookSubagentSpawningEvent as et, PluginHookBeforeDispatchEvent as f, PluginHeartbeatPromptContributionResult as ft, PluginHookBeforeInstallResult as g, PluginJsonValue as gt, PluginHookBeforeInstallEvent as h, PluginNextTurnInjectionRecord as ht, PluginHookAgentEndEvent as i, PluginHookToolKind as it, PluginHookLlmOutputEvent as j, PluginHookBeforePromptBuildResult as jt, PluginHookInboundClaimResult as k, PluginHookBeforeModelResolveResult as kt, PluginHookBeforeAgentRunEvent as l, PluginAgentTurnPrepareEvent as lt, PluginHookBeforeInstallContext as m, PluginNextTurnInjectionEnqueueResult as mt, PluginHookAfterToolCallEvent as n, PluginHookToolContext as nt, PluginHookBeforeAgentFinalizeResult as o, PluginHookToolResultPersistContext as ot, PluginHookBeforeDispatchResult as p, PluginNextTurnInjection as pt, PluginHookSessionStartEvent as q, PluginHookAgentContext as r, PluginHookToolInputKind as rt, PluginHookBeforeAgentReplyEvent as s, PluginHookToolResultPersistEvent as st, PluginHookAfterCompactionEvent as t, PluginHookSubagentSpawningResult as tt, PluginHookBeforeCompactionEvent as u, PluginAgentTurnPrepareResult as ut, PluginHookBeforeMessageWriteResult as v, PluginHookInboundClaimEvent as vt, PluginHookCronReconciledEvent as w, GateHookResult as wt, PluginHookContextWindowSource as x, PluginHookMessageSendingEvent as xt, PluginHookBeforeResetEvent as y, PluginHookMessageContext as yt, PluginHookReplyPayload as z };