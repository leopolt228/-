...
import { i as formatLookupMiss } from "./error-format-CG7mpTEd.js";
import { o as resolveAllAgentSessionStoreTargetsSync } from "./targets-DhNEpENL.js";
import { B as deleteTaskFlowRecordById, G as getTaskFlowById, K as getTaskFlowRegistryRestoreFailure, M as isTaskFlowCancellationPending, c as getTaskById, et as updateFlowRecordByIdExpectedRevision, g as listTasksForFlowId, k as updateTaskNotifyPolicyById, q as listTaskFlowRecords } from "./task-registry-BkemWOKR.js";
...
import { a as runSessionRegistryMaintenanceForStore } from "./sessions-Uqhj6EXw.js";
import { a as getInspectableTaskRegistrySummary, c as reconcileInspectableTasks, d as runTaskRegistryMaintenance, i as getInspectableTaskAuditSummary, l as reconcileTaskLookupToken, o as getTaskRegistryMaintenanceDiagnostics, s as previewTaskRegistryMaintenance, t as configureTaskRegistryMaintenance } from "./task-registry.maintenance-CSMi6B7X.js";
import { i as summarizeRetainedLostTaskAuditFindings, n as listTaskAuditFindings } from "./task-registry.audit-DiY0ICYg.js";
import { t as normalizeCronLaneSegment } from "./task-runs-DrI8SkHH.js";
import { i as summarizeTaskFlowAuditFindings, n as buildTaskSystemAuditJsonPayload, r as listTaskFlowAuditFindings, t as buildTaskSystemAuditFindings } from "./tasks-audit-system-BcLSWsB6.js";
...
async function tryCancelGatewayOwnedTaskViaGateway(task) {
	if (task.runtime !== "cron" && task.runtime !== "acp") return null;
	try {
		...
		if (task.runtime === "acp") return {
			found: true,
			cancelled: false,
			reason: `ACP task cancellation requires the live Gateway tasks.cancel path: ${error instanceof Error ? error.message : String(error)}`,
			task
		};
		return null;
	}
