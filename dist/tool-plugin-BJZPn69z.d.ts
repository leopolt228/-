import { s as PluginManifestActivation } from "./manifest-registry-C53V9sX9.js";
import { t as JsonSchemaObject } from "./json-schema.types-z_ZXZBRr.js";
import { f as AgentToolUpdateCallback } from "./types-Dedz4oTJ.js";
import { N as OpenClawPluginToolContext, a as AnyAgentTool, g as OpenClawPluginApi, wn as definePluginEntry } from "./plugin-entry-Bj-pdgAt.js";
...
type ToolPluginToolDefinition<TConfig, TParamsSchema extends TSchema> = ToolPluginToolDefinitionBase<TParamsSchema> & ({
  /** Optional schema for the JSON value returned in `AgentToolResult.details`. */outputSchema?: TSchema; /** Execute one concrete tool call and return either plain text or JSON-serializable data. */
  ...
  execute?: never; /** Factory tools declare output schemas on their returned `AnyAgentTool` objects. */
  outputSchema?: never;
});
...
//#endregion
export { ToolPluginMetadata as a, defineToolPlugin as c, ToolPluginFactoryContext as i, getToolPluginMetadata as l, DefinedToolPluginEntry as n, ToolPluginStaticToolMetadata as o, ToolPluginExecutionContext as r, ToolPluginToolDefinition as s, DefineToolPluginOptions as t, toolPluginMetadataSymbol as u };