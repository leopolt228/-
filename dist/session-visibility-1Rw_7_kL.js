...
import { s as listAmbientGroupWatchTargets } from "./session-state-events-BG_mebdA.js";
...
function createSessionVisibilityRowChecker(params) {
	const requesterAgentId = normalizeLowercaseStringOrEmpty(params.requesterAgentId) || resolveAgentIdFromSessionKey(params.requesterSessionKey);
