...
import { a as resolveAgentDir, n as listAgentIds, o as resolveAgentWorkspaceDir } from "./agent-scope-config-S7z_Yn4H.js";
...
import { r as getActivePluginChannelRegistryVersion, u as getActivePluginRegistryVersion } from "./runtime-BapEso0o.js";
...
import { s as peekSessionMcpRuntime, v as resolveSessionMcpConfigSummary } from "./agent-bundle-mcp-manager-api-ChkvrkDs.js";
...
import { n as getConnectedNodePluginToolsVersion } from "./node-plugin-tool-snapshot-DXd55NZ5.js";
import { xi as validateToolsEffectiveParams } from "./src-Cy32TawB.js";
...
import { a as resolveEffectiveToolRawDescription, i as resolveEffectiveToolLabel, o as summarizeEffectiveToolDescription, r as disambiguateEffectiveToolLabels } from "./tools-effective-inventory-build-DMgCbFbg.js";
import { i as buildEffectiveToolInventoryGroups, n as resolveEffectiveToolInventory, r as resolveEffectiveToolInventoryRuntimeModelContext } from "./tools-effective-inventory-l7p1c1wA.js";
...
function resolveTrustedToolsEffectiveContext(params) {
	const loaded = loadSessionEntry(params.sessionKey, params.requestedAgentId ? { agentId: params.requestedAgentId } : void 0);
	if (!loaded.entry) {
