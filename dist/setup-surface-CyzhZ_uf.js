...
import { o as isPrivateOrLoopbackHost } from "./net-DBokCmJs.js";
import "./string-coerce-runtime-DBMkn-gE.js";
import { O as promptAccountId, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-BswN5Wen.js";
import { t as promptChannelAccessConfig } from "./setup-group-access-Dz4Z8Sy-.js";
import "./setup-BBJhG_GE.js";
import { o as isPrivateNetworkOptInEnabled } from "./ssrf-policy-BcGHIF9t.js";
...
import { r as resolveMatrixEnvAuthReadiness } from "./env-auth-GBg-erEj.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-z3wSTh4Y.js";
import { r as moveSingleMatrixAccountConfigToNamedAccount, t as resolveMatrixSetupDmAllowFrom } from "./setup-dm-policy-fDPoECZm.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-DZDSgSmi.js";
import { n as updateMatrixAccountConfig } from "./config-update-C-pv6HRH.js";
import { n as validateMatrixHomeserverUrl, t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-C_AgZBwW.js";
...
async function promptMatrixAllowFrom(params) {
	...
	while (true) {
		...
		if (pending.length > 0) {
			const { resolveMatrixTargets } = await import("./resolve-targets-B2HvR7se.js");
	...
	if (accessConfig) if (accessConfig.policy !== "allowlist") next = setMatrixGroupPolicy(next, accessConfig.policy, params.accountId);
		...
		if (accessConfig.entries.length > 0) try {
			...
			for (const entry of accessConfig.entries) {
				...
				const { listMatrixDirectoryGroupsLive } = await import("./directory-live-BmGTRXVs.js");
...
const matrixOnboardingAdapter = {
	...
	afterConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-DS1z_cSe.js");
