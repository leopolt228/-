...
import { f as readProviderJsonArrayFieldResponse } from "./provider-http-errors-DrOMjuGn.js";
import { u as supportsClaudeAdaptiveThinking } from "./src-BnQDOjpw.js";
...
import { i as resolveStaticCopilotModelOverride, n as resolveCopilotModelCompat, r as resolveCopilotTransportApi } from "./model-metadata-POWMXPrL.js";
//#region extensions/github-copilot/models.ts
const PROVIDER_ID = "github-copilot";
const CODEX_FORWARD_COMPAT_TARGET_IDS = /* @__PURE__ */ new Set(["gpt-5.4", "gpt-5.3-codex"]);
...
function resolveCopilotForwardCompatModel(ctx) {
	...
	if (staticOverride) {
		...
		return normalizeModelCompat({
			...
			...staticOverride.contextTokens !== void 0 ? { contextTokens: staticOverride.contextTokens } : {},
