...
var ArtifactQueryParamsProperties = {
  ...
  taskId: Type3.Optional(NonEmptyString),
...
var ArtifactSummarySchema = closedObject({
  ...
  mimeType: Type3.Optional(NonEmptyString),
  sizeBytes: Type3.Optional(Type3.Integer({ minimum: 0 })),
  sessionKey: Type3.Optional(NonEmptyString),
  runId: Type3.Optional(NonEmptyString),
  taskId: Type3.Optional(NonEmptyString),
  messageSeq: Type3.Optional(Type3.Integer({ minimum: 1 })),
  source: Type3.Optional(NonEmptyString),
  download: closedObject({
    mode: Type3.Union([Type3.Literal("bytes"), Type3.Literal("url"), Type3.Literal("unsupported")])
  })
});
var ArtifactsListParamsSchema = ArtifactQueryParamsSchema;
var ArtifactsListResultSchema = closedObject({
  artifacts: Type3.Array(ArtifactSummarySchema)
});
...
var ArtifactsDownloadResultSchema = closedObject({
  artifact: ArtifactSummarySchema,
  encoding: Type3.Optional(Type3.Literal("base64")),
  data: Type3.Optional(Type3.String()),
  url: Type3.Optional(NonEmptyString)
});
export {
