...
var UiSplitCommandSchema = closedObject({
  kind: Type3.Literal("split"),
  direction: Type3.Union([Type3.Literal("right"), Type3.Literal("down")]),
  sessionKey: NonEmptyString
});
var UiClosePaneCommandSchema = closedObject({
  kind: Type3.Literal("close-pane"),
  sessionKey: NonEmptyString
});
var UiFocusCommandSchema = closedObject({
  kind: Type3.Literal("focus"),
  sessionKey: NonEmptyString
});
var UiSidebarCommandSchema = closedObject({
  kind: Type3.Literal("sidebar"),
  visible: Type3.Boolean()
});
var UiPanelCommandSchema = closedObject({
  kind: Type3.Literal("panel"),
  panel: Type3.Union([Type3.Literal("terminal"), Type3.Literal("browser")]),
  open: Type3.Boolean(),
  dock: Type3.Optional(Type3.Union([Type3.Literal("bottom"), Type3.Literal("right")])),
  terminalSessionId: Type3.Optional(NonEmptyString)
});
var UiNavigateCommandSchema = closedObject({
  kind: Type3.Literal("navigate"),
  sessionKey: NonEmptyString
});
var UiCommandSchema = Type3.Union([
...
var UiCommandResultSchema = closedObject({ ok: Type3.Boolean() });
export {
  UiClosePaneCommandSchema,
