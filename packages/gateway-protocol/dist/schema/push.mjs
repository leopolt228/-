...
// packages/gateway-protocol/src/schema/push.ts
var ApnsEnvironmentSchema = Type3.String({ enum: ["sandbox", "production"] });
var PushTestParamsSchema = closedObject({
  nodeId: NonEmptyString,
  title: Type3.Optional(Type3.String()),
  body: Type3.Optional(Type3.String()),
  environment: Type3.Optional(ApnsEnvironmentSchema)
});
var PushTestResultSchema = closedObject({
  ok: Type3.Boolean(),
  status: Type3.Integer(),
  apnsId: Type3.Optional(Type3.String()),
  reason: Type3.Optional(Type3.String()),
  tokenSuffix: Type3.String(),
  topic: Type3.String(),
  environment: ApnsEnvironmentSchema,
  transport: Type3.String({ enum: ["direct", "relay"] })
});
var WebPushKeysSchema = closedObject({
  p256dh: Type3.String({ minLength: 1, maxLength: 512 }),
  auth: Type3.String({ minLength: 1, maxLength: 512 })
});
var WebPushVapidPublicKeyParamsSchema = closedObject({});
var WebPushSubscribeParamsSchema = closedObject({
  endpoint: Type3.String({ minLength: 1, maxLength: 2048, pattern: "^https://" }),
