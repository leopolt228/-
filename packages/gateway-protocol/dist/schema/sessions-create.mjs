...
var SessionsCreateParamsSchema = closedObject({
  key: Type4.Optional(NonEmptyString),
  agentId: Type4.Optional(NonEmptyString),
  label: Type4.Optional(SessionLabelString),
  model: Type4.Optional(NonEmptyString),
  thinkingLevel: Type4.Optional(NonEmptyString),
  catalogId: Type4.Optional(NonEmptyString),
  parentSessionKey: Type4.Optional(NonEmptyString),
  fork: Type4.Optional(
    Type4.Boolean({ description: "Fork the parent transcript; requires parentSessionKey." })
  ),
  emitCommandHooks: Type4.Optional(Type4.Boolean()),
  succeedsParent: Type4.Optional(
    Type4.Boolean({
