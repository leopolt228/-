...
var MemoryMigrationPlanFingerprintSchema = Type4.String({
  minLength: 64,
  maxLength: 64,
  pattern: "^[a-f0-9]{64}$"
});
var MemoryMigrationItemStatusSchema = Type4.Union([
  Type4.Literal("planned"),
  Type4.Literal("migrated"),
  Type4.Literal("skipped"),
  Type4.Literal("warning"),
  Type4.Literal("conflict"),
  Type4.Literal("error")
]);
var MemoryMigrationItemSchema = Type4.Object(
  {
    id: NonEmptyString,
    status: MemoryMigrationItemStatusSchema,
    source: Type4.Optional(NonEmptyString),
    target: Type4.Optional(NonEmptyString),
    message: Type4.Optional(Type4.String()),
    reason: Type4.Optional(Type4.String()),
    details: Type4.Optional(Type4.Record(Type4.String(), Type4.Unknown()))
  },
  { additionalProperties: false }
);
var MemoryMigrationSummarySchema = Type4.Object(
  {
    total: Type4.Integer({ minimum: 0 }),
    planned: Type4.Integer({ minimum: 0 }),
    migrated: Type4.Integer({ minimum: 0 }),
    skipped: Type4.Integer({ minimum: 0 }),
    conflicts: Type4.Integer({ minimum: 0 }),
    errors: Type4.Integer({ minimum: 0 }),
    sensitive: Type4.Integer({ minimum: 0 })
  },
  { additionalProperties: false }
);
var MemoryMigrationProviderPlanSchema = Type4.Object(
  {
    providerId: NonEmptyString,
    label: NonEmptyString,
    description: Type4.Optional(Type4.String()),
    planFingerprint: Type4.Optional(MemoryMigrationPlanFingerprintSchema),
    found: Type4.Boolean(),
    source: Type4.Optional(NonEmptyString),
    target: Type4.Optional(NonEmptyString),
    confidence: Type4.Optional(
    ...
    items: Type4.Array(MemoryMigrationItemSchema, { maxItems: MAX_MEMORY_MIGRATION_ITEMS }),
    warnings: Type4.Optional(Type4.Array(Type4.String()))
  },
  { additionalProperties: false }
);
var MigrationsMemoryPlanParamsSchema = Type4.Object(
  {
    agentId: NonEmptyString,
    overwrite: Type4.Optional(Type4.Boolean())
  },
  { additionalProperties: false }
);
var MigrationsMemoryPlanResultSchema = Type4.Object(
  {
    agentId: NonEmptyString,
    workspace: NonEmptyString,
    providers: Type4.Array(MemoryMigrationProviderPlanSchema)
  },
  { additionalProperties: false }
);
var MigrationsMemoryApplyParamsSchema = Type4.Object(
  {
    idempotencyKey: NonEmptyString,
    agentId: NonEmptyString,
    providerId: NonEmptyString,
    planFingerprint: MemoryMigrationPlanFingerprintSchema,
    itemIds: Type4.Array(NonEmptyString, {
      minItems: 1,
      uniqueItems: true,
...
var MigrationsMemoryApplyResultSchema = Type4.Object(
  {
    providerId: NonEmptyString,
    ...
    items: Type4.Array(MemoryMigrationItemSchema, { maxItems: MAX_MEMORY_MIGRATION_ITEMS }),
    warnings: Type4.Optional(Type4.Array(Type4.String())),
    backupPath: Type4.Optional(NonEmptyString),
    reportDir: Type4.Optional(NonEmptyString)
  },
  { additionalProperties: false }
);
