...
// packages/gateway-protocol/src/schema/skill-history.ts
var SkillsProposalHistoryStatusParamsSchema = Type3.Object(
  { agentId: Type3.Optional(NonEmptyString) },
  { additionalProperties: false }
);
var SkillsProposalHistoryScanParamsSchema = Type3.Object(
  {
    agentId: Type3.Optional(NonEmptyString),
    direction: Type3.Optional(Type3.Union([Type3.Literal("older"), Type3.Literal("newer")]))
  },
  { additionalProperties: false }
);
var SkillsProposalHistoryScanResultSchema = Type3.Object(
  {
    schema: Type3.Literal("openclaw.skill-workshop.history-scan.v1"),
    hasScanned: Type3.Boolean(),
    reviewedSessions: Type3.Integer({ minimum: 0 }),
    ideasFound: Type3.Integer({ minimum: 0 }),
    hasMore: Type3.Boolean(),
    lastScanReviewed: Type3.Integer({ minimum: 0 }),
    lastScanIdeas: Type3.Integer({ minimum: 0 }),
    lastScanAt: Type3.Optional(NonEmptyString),
    oldestReviewedAt: Type3.Optional(NonEmptyString),
    newestReviewedAt: Type3.Optional(NonEmptyString)
  },
  { additionalProperties: false }
);
