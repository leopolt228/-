...
var SecretsResolveParamsSchema = closedObject({
  ...
  targetIds: Type3.Array(NonEmptyString),
  allowedPaths: Type3.Optional(Type3.Array(NonEmptyString)),
  forcedActivePaths: Type3.Optional(Type3.Array(NonEmptyString)),
  optionalActivePaths: Type3.Optional(Type3.Array(NonEmptyString)),
  providerOverrides: Type3.Optional(
    closedObject({
      webSearch: Type3.Optional(NonEmptyString),
      webFetch: Type3.Optional(NonEmptyString)
    })
  )
});
var SecretsResolveAssignmentSchema = closedObject({
  path: Type3.Optional(NonEmptyString),
  pathSegments: Type3.Array(NonEmptyString),
  value: Type3.Unknown()
});
var SecretsResolveResultSchema = closedObject({
  ok: Type3.Optional(Type3.Boolean()),
  assignments: Type3.Optional(Type3.Array(SecretsResolveAssignmentSchema)),
  diagnostics: Type3.Optional(Type3.Array(NonEmptyString)),
  inactiveRefPaths: Type3.Optional(Type3.Array(NonEmptyString))
});
export {
