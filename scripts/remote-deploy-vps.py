...
try:
    ...
    # 1. Update system and install curl, git, nodejs 22
    run_cmd("apt-get update -y && apt-get install -y curl git build-essential")
    ...
    # 3. Test running gateway
    run_cmd("cd /root/openclaw && bash run.sh & sleep 3")

    # 4. Set up PM2 auto-start 24/7
    ...
    print("\n==========================================")
    print("OPENCLAW DEPLOYED AND RUNNING 24/7 ON VPS!")
    print("==========================================")
